...
from blendedUx.blendedcli.settings import PACKAGE_LIST_RC as package_list_rc_file
from blendedUx.blendedcli.settings import BLENDED_RC as blended_rc_file, BLENDED_DATA_DIR
