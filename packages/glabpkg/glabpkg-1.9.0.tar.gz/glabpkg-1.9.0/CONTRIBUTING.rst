...
**glabpkg** could always use more documentation, whether as
part of the official **glabpkg** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `glabpkg` for local
development.

1. Fork the `glabpkg` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/glabpkg.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd glabpkg
    (dvlpt) glabpkg$ flake8
    (dvlpt) glabpkg$ pytest
...
.. _issues: https://gitlab.com/revesansparole/glabpkg/issues
