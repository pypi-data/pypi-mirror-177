...
from pulse_ssz.sedes.serializable import MetaSerializable
...
def parse(value, sedes, codec=DefaultCodec):
    ...
    elif isinstance(sedes, String):
        return parse_string(value, sedes, codec)
...
def parse_string(value, sedes, codec):
