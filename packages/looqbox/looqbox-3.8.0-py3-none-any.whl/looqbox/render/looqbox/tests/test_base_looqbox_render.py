...
class TestLooqboxRender(unittest.TestCase):
    ...
    def test_message_render(self):
        ...
        "style": {
         ...
         """)
        test_json = json.loads(self.render.message_render(self.message))
    ...
    def test_html_render(self):
        ...
        test_json = json.loads(self.render.html_render(self.html))
        self.assertEqual(model_json, test_json)
    ...
    def test_simple_render(self):
        ...
        test_json = json.loads(self.render.simple_render(self.simple))
    ...
    "class": []
        ...
        test_json = json.loads(self.render.table_render(self.table))
