...
release = natlinkcore.__version__
# The short X.Y version
version = '.'.join(release.split('.')[:2])
print(f'natlinkcore, version: "{version}", release: "{release}"')
...
htmlhelp_basename = 'natlinkcoredoc'
...
latex_documents = [
    (master_doc, 'natlink.tex', 'Natlinkcore Documentation',
...
man_pages = [
    (master_doc, 'natlinkcore', 'natlinkcore Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'natlinkcore', 'Natlinkcore Documentation',
     author, 'natlinkcore',
     'The Natlinkcore project, the python modules needed for Natlink, which connects Dragon with python.',
     'Miscellaneous'),
]
