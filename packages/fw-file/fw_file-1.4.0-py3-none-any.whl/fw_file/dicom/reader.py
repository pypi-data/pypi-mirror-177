...
class ReadContext:
    ...
    def add_nonconforming_elem(
        ...
        Args:
            ...
            val (t.Any): Value of nonconforming element
    ...
    def add_modified_elem(
        self, elem: t.Union[t.Tuple[BaseTag, str, t.Any], RawDataElement]
    ):
        ...
        try:
            ...
            log.debug(
                f"value `{orig.value!r}` for tag `{orig.tag}` invalid, writing to "
            ...
            self.add_nonconforming_elem(orig.tag, orig.value, 0)
    ...
    def process_tracker(self, required_tags: t.Set[int], dataset: Dataset):
        ...
        for elem in self.data_elements:
            ...
            if safe_to_remove:
                self.add_nonconforming_elem(elem.tag, elem.original.value, 0)
                continue
