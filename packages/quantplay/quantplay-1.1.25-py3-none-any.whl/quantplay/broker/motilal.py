...
class Motilal(Broker):
    ...
    def load_instrument(self):
        instrument_file_FO = pd.read_csv("https://uatopenapi.motilaloswal.com/getscripmastercsv?name=NSEFO")
        instrument_file_EQ = pd.read_csv("https://uatopenapi.motilaloswal.com/getscripmastercsv?name=NSE")
