...
async function setNode(component_json) {
    ...
    editor.nodes[0].meta.catalog = component_json['meta']['catalog'];
    editor.nodes[0].meta.args = component_json['meta']['args'];
    editor.nodes[0].meta.kwargs = component_json['meta']['kwargs'];
...
function getUI() {
    component_json = {"meta": {}, "controls": [], "inputs": [], "outputs": [], "executor": {}};
    ...
    component_json['meta']['catalog'] = document.getElementById('componentCatalog').value;
    ...
    if (args=='') {
        component_json['meta']['args'] = [];
    }
    else {
        component_json['meta']['args'] = args.split(",");
    }
    if (kwargs=='') {
        component_json['meta']['kwargs'] = [];
    }
    else {
        component_json['meta']['kwargs'] = kwargs.split(",");
    }
