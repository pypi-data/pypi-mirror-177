    ...
    def __init__(self, api_client=None):
        ...
        def __create_host(
            ...
            **kwargs
            ...
            >>> thread = api.create_host(environment_id, create_host_parameters, async_req=True)
            >>> result = thread.get()

            Args:
                environment_id (str): The ID of the environment.
                create_host_parameters (CreateHostParameters):
