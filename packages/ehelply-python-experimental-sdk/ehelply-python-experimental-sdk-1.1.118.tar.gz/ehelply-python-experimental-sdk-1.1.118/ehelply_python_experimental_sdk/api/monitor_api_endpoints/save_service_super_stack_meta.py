...
# body param
SchemaForRequestBodyApplicationJson = ServiceSuperStackMeta


request_body_service_super_stack_meta = api_client.RequestBody(
    content={
...
_path = '/sam/monitor/services/{service}/superstack'
_method = 'POST'
...
class SaveServiceSuperStackMeta(api_client.Api):

    def save_service_super_stack_meta(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_service_super_stack_meta.serialize(body, content_type)
