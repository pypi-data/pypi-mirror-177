...
_path = '/sam/monitor/superstack-services'
_method = 'GET'
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @classmethod
    @property
    def _items(cls) -> typing.Type['ServiceSuperStackMeta']:
...
class GetSupertackServices(api_client.Api):

    def get_supertack_services(
        self: api_client.Api,
