...
# body param
SchemaForRequestBodyApplicationJson = FactCreate


request_body_fact_create = api_client.RequestBody(
    content={
...
class SaveFact0(api_client.Api):
    ...
    def save_fact_0(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_fact_create.serialize(body, content_type)
