...
request_path_fact_name = api_client.PathParameter(
    name="fact_name",
    style=api_client.ParameterStyle.SIMPLE,
    schema=FactNameSchema,
    required=True,
)
_path = '/sam/facts/facts/{fact_name}'
_method = 'GET'
SchemaFor200ResponseBodyApplicationJson = Fact
