...
class OrquestadorAPI:
    ...
    def __init__(self, transition_id=None):
    ...
    def make_request(self, request_type, url, payload=None, headers=None):
    ...
    def make_authenticated_request(self, request_type, url, payload=None):
        ...
        response = self.make_request(request_type, url, payload=payload, headers=headers)
        return response
    ...
    def send_log_reports(self, log_url, report_url):
        data = {"log": log_url, "report": report_url}
        return self._transition_v1(data)
...
def send_result(result, id_pi):
    ...
    result = OrquestadorAPI().output_process_instance(data)
    print(result)
