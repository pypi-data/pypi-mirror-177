...
def validate_filter_function_input(
    ...
    check_argument_numeric(frequencies, "frequencies")
    check_argument(
        len(validate_shape(frequencies, "frequencies")) == 1,
        "The frequencies must be a 1D array.",
    ...
    if projection_operator is not None:
        check_argument_numeric(projection_operator, "projection_operator")
        check_argument_orthogonal_projection_operator(
