...
class GlobalVariable2(Artifact):  
    ...
    def __init__(self, project, account):
        ...
        if not hasattr(cls, "_init"):
            ...
            self.CONTAINER_URI = f"{self.CONTAINER_URI_PREFIX}/{self.PROJECT_ID}/{self.CONTAINER_URI_POSTFIX}"
    ...
    #############
    DATASET_BUCKET = 'oxford_iiit_pet_3_2_0_rgb'
    #DATASET_BUCKET = 'oxford_iiit_pet_lsm'

    DATASET_BUCKET2 = 'oxford_iiit_pet_3_2_0_rgb'
    ...
    CONTAINER_URI_POSTFIX = f"{DOCKER_REPOSITORY_NAME}/{TRAIN_CONTAINER_IMAGE_NAME}"
