...
class LibraryReader(object):
    def __init__(self, settings, send_sr_message_func, send_ts_message_func):
        self.settings = settings
        # TODO: PYT-2140 remove send sr msg func once we deprecate SR
        self.send_sr_message_func = send_sr_message_func
    ...
    def _send_analysis_results_files_loaded(self, reportable_dists):
        ...
        if self.settings.config.is_service_bypassed:
            ...
            if send_msg:
                self.send_sr_message_func([activity_dtm])
