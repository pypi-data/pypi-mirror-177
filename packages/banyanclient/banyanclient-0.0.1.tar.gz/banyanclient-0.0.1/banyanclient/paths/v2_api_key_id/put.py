...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "description", "scope", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "description", "scope", ], str]):
...
class V2ApiKeyIdPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_api_key_id_put(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        path_params: RequestPathParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_api_key_id_put_oapg(
            body=body,
