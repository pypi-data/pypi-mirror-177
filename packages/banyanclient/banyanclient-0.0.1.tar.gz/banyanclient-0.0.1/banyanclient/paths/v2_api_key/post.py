...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["csr", "description", "scope", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["csr", "description", "scope", ], str]):
...
class V2ApiKeyPost(BaseApi):
    ...
    def v2_api_key_post(
        ...
        return self._v2_api_key_post_oapg(
            body=body,
