    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class data(
                        ...
                        class connectors(
                            ...
                            class MetaOapg:
                                ...
                                class items(
                                            ...
                                            class access_tiers(
                                                ...
                                                class MetaOapg:
                                                    ...
                                                    class items(
                                                        ...
                                                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["satellite_tunnel_peer_id", "access_tier_id", "healthy", "access_tier_name", ], str]):
                                                            # dict_instance[name] accessor
                                                            return super().__getitem__(name)
                                                        ...
                                                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["satellite_tunnel_peer_id", "access_tier_id", "healthy", "access_tier_name", ], str]):
                                                            return super().get_item_oapg(name)
                                    ...
                                    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "name", "display_name", "tunnel_ip_address", "keepalive", "status", "wireguard_public_key", "cidrs", "access_tiers", "created_at", "updated_at", "api_key_id", "created_by", "updated_by", "spec", ], str]):
                                        # dict_instance[name] accessor
                                        return super().__getitem__(name)
                                    ...
                                    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "name", "display_name", "tunnel_ip_address", "keepalive", "status", "wireguard_public_key", "cidrs", "access_tiers", "created_at", "updated_at", "api_key_id", "created_by", "updated_by", "spec", ], str]):
                                        return super().get_item_oapg(name)
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "name", "friendly_name", "description", "enabled", "spec", "created_at", "created_by", "updated_at", "updated_by", "peer_access_tiers", "connectors", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "name", "friendly_name", "description", "enabled", "spec", "created_at", "created_by", "updated_at", "updated_by", "peer_access_tiers", "connectors", ], str]):
                    return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    ...
    def _v2_service_tunnel_id_get_oapg(
        self: api_client.Api,
...
class V2ServiceTunnelIdGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_service_tunnel_id_get(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v2_service_tunnel_id_get_oapg(
