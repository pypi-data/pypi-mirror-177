...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["service_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["service_id", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _v2_bundle_bundle_id_service_post_oapg(
        self: api_client.Api,
...
class V2BundleBundleIdServicePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_bundle_bundle_id_service_post(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        path_params: RequestPathParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_bundle_bundle_id_service_post_oapg(
            body=body,
