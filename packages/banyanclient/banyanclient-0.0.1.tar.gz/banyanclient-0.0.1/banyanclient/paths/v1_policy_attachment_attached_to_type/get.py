...
class BaseApi(api_client.Api):
    ...
    def _v1_policy_attachment_attached_to_type_get_oapg(
        self: api_client.Api,
        ...
        """
         Gets all attachments for an org by type
...
class V1PolicyAttachmentAttachedToTypeGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_policy_attachment_attached_to_type_get(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v1_policy_attachment_attached_to_type_get_oapg(
