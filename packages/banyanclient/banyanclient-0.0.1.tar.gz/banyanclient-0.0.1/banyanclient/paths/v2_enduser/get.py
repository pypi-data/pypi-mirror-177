...
LimitDefault100Schema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'limit (default&#x3D;100)': typing.Union[LimitDefault100Schema, decimal.Decimal, int, ],
...
request_query_limit__default100 = api_client.QueryParameter(
    name="limit (default&#x3D;100)",
    style=api_client.ParameterStyle.FORM,
    schema=LimitDefault100Schema,
    explode=True,
)
                        ...
                        class endusers(
                            ...
                            class MetaOapg:
                                ...
                                class items(
                                    ...
                                    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "email", "name", "created_at", "invited_at", "status", "last_login", "security_roles", ], str]):
                                    ...
                                    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "email", "name", "created_at", "invited_at", "status", "last_login", "security_roles", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _v2_enduser_get_oapg(
        ...
        for parameter in (
            ...
            request_query_limit__default100,
...
class V2EnduserGet(BaseApi):
    ...
    def v2_enduser_get(
        ...
        return self._v2_enduser_get_oapg(
