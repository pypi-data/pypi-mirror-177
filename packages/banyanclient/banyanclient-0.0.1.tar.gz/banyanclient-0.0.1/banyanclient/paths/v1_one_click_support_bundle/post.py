...
request_query_site_name = api_client.QueryParameter(
    name="SiteName",
    style=api_client.ParameterStyle.FORM,
    schema=SiteNameSchema,
    explode=True,
)
request_query_host_name = api_client.QueryParameter(
    name="HostName",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    ...
    def _v1_one_click_support_bundle_post_oapg(
        self: api_client.Api,
        ...
        for parameter in (
            ...
            request_query_site_name,
            request_query_host_name,
        ):
...
class V1OneClickSupportBundlePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_one_click_support_bundle_post(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v1_one_click_support_bundle_post_oapg(
