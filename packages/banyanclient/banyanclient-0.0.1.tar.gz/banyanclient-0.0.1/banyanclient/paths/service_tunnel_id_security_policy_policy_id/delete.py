...
class BaseApi(api_client.Api):
    ...
    def _service_tunnel_id_security_policy_policy_id_delete_oapg(
        self: api_client.Api,
...
class ServiceTunnelIdSecurityPolicyPolicyIdDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def service_tunnel_id_security_policy_policy_id_delete(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._service_tunnel_id_security_policy_policy_id_delete_oapg(
