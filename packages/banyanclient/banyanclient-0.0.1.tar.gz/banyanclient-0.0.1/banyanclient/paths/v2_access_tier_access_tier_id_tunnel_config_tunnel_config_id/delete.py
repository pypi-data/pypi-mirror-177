...
TunnelConfigIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'access_tier_id': typing.Union[AccessTierIdSchema, str, ],
        'tunnel_config_id': typing.Union[TunnelConfigIdSchema, str, ],
    }
)
...
request_path_tunnel_config_id = api_client.PathParameter(
    name="tunnel_config_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TunnelConfigIdSchema,
    required=True,
)
_auth = [
    'bearerAuthToken',
...
class BaseApi(api_client.Api):
    ...
    def _v2_access_tier_access_tier_id_tunnel_config_tunnel_config_id_delete_oapg(
        self: api_client.Api,
...
class V2AccessTierAccessTierIdTunnelConfigTunnelConfigIdDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_access_tier_access_tier_id_tunnel_config_tunnel_config_id_delete(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v2_access_tier_access_tier_id_tunnel_config_tunnel_config_id_delete_oapg(
