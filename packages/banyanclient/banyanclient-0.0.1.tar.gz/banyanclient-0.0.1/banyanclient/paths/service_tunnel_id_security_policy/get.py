            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    class properties:
                        ...
                        attached_to_id = schemas.StrSchema
                        attached_to_type = schemas.StrSchema
                        enabled = schemas.StrSchema
                        attached_at = schemas.IntSchema
                        attached_by = schemas.StrSchema
                        __annotations__ = {
                            "policy_id": policy_id,
                ...
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["attached_to_id"]) -> MetaOapg.properties.attached_to_id: ...
                
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["attached_to_type"]) -> MetaOapg.properties.attached_to_type: ...
                
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["enabled"]) -> MetaOapg.properties.enabled: ...
                
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["attached_at"]) -> MetaOapg.properties.attached_at: ...
                
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["attached_by"]) -> MetaOapg.properties.attached_by: ...
                
                @typing.overload
                def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["policy_id", "policy_name", "attached_to_id", "attached_to_type", "enabled", "attached_at", "attached_by", ], str]):
                ...
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["attached_to_id"]) -> typing.Union[MetaOapg.properties.attached_to_id, schemas.Unset]: ...
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["attached_to_type"]) -> typing.Union[MetaOapg.properties.attached_to_type, schemas.Unset]: ...
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["enabled"]) -> typing.Union[MetaOapg.properties.enabled, schemas.Unset]: ...
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["attached_at"]) -> typing.Union[MetaOapg.properties.attached_at, schemas.Unset]: ...
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["attached_by"]) -> typing.Union[MetaOapg.properties.attached_by, schemas.Unset]: ...
                
                @typing.overload
                def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["policy_id", "policy_name", "attached_to_id", "attached_to_type", "enabled", "attached_at", "attached_by", ], str]):
                ...
                def __new__(
                    ...
                    *args: typing.Union[dict, frozendict.frozendict, ],
                    ...
                    attached_to_id: typing.Union[MetaOapg.properties.attached_to_id, str, schemas.Unset] = schemas.unset,
                    attached_to_type: typing.Union[MetaOapg.properties.attached_to_type, str, schemas.Unset] = schemas.unset,
                    enabled: typing.Union[MetaOapg.properties.enabled, str, schemas.Unset] = schemas.unset,
                    attached_at: typing.Union[MetaOapg.properties.attached_at, decimal.Decimal, int, schemas.Unset] = schemas.unset,
                    attached_by: typing.Union[MetaOapg.properties.attached_by, str, schemas.Unset] = schemas.unset,
...
class BaseApi(api_client.Api):
    ...
    def _service_tunnel_id_security_policy_get_oapg(
        self: api_client.Api,
...
class ServiceTunnelIdSecurityPolicyGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def service_tunnel_id_security_policy_get(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._service_tunnel_id_security_policy_get_oapg(
