...
class BaseApi(api_client.Api):
    ...
    def _v1_policy_policy_id_attachment_get_oapg(
        self: api_client.Api,
        ...
        """
         Gets all attachments for policy of an org
...
class V1PolicyPolicyIdAttachmentGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_policy_policy_id_attachment_get(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v1_policy_policy_id_attachment_get_oapg(
