...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'nonce': typing.Union[NonceSchema, str, ],
        'response type': typing.Union[ResponseTypeSchema, str, ],
        'scope': typing.Union[ScopeSchema, str, ],
        'redirect uri': typing.Union[RedirectUriSchema, str, ],
        'client id': typing.Union[ClientIdSchema, str, ],
    },
    total=False
)
...
request_query_nonce = api_client.QueryParameter(
    name="nonce",
    style=api_client.ParameterStyle.FORM,
    schema=NonceSchema,
    explode=True,
