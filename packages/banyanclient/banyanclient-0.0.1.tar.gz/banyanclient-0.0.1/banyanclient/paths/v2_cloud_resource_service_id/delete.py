...
class BaseApi(api_client.Api):
    ...
    def _v2_cloud_resource_service_id_delete_oapg(
        self: api_client.Api,
...
class V2CloudResourceServiceIdDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_cloud_resource_service_id_delete(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v2_cloud_resource_service_id_delete_oapg(
