                        ...
                        class access_tiers(
                            ...
                            class MetaOapg:
                                ...
                                class items(
                                    ...
                                    def __getitem__(self, name: typing.Union[typing_extensions.Literal["satellite_tunnel_peer_id", "access_tier_id", "healthy", ], str]):
                                    ...
                                    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["satellite_tunnel_peer_id", "access_tier_id", "healthy", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _v2_satellite_post_oapg(
        ...
        """
         To create satellite tunnel config for an org 
...
class V2SatellitePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_satellite_post(
        self: BaseApi,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
        ...
        return self._v2_satellite_post_oapg(
