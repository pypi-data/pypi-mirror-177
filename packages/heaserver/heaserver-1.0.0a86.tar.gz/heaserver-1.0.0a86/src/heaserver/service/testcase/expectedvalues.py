...
def body_post(fixtures: Mapping[str, List[DesktopObjectDict]] | Mapping[CollectionKey, List[DesktopObjectDict]], coll: str | CollectionKey,
...
def body_put(fixtures: Mapping[str, List[DesktopObjectDict]] | Mapping[CollectionKey, List[DesktopObjectDict]], coll: str | CollectionKey,
             default_db_manager_cls: Type[MicroserviceDatabaseManager]) \
             -> Dict[str, Dict[str, List[Dict[str, Any]]]]:
    """
    Create a Collection+JSON template from a data test fixture.
...
def expected_one(fixtures: Mapping[str, List[DesktopObjectDict]] | Mapping[CollectionKey, List[DesktopObjectDict]], coll: str | CollectionKey,
                 wstl_builder: wstl.RuntimeWeSTLDocumentBuilder,
                 default_db_manager_cls: Type[MicroserviceDatabaseManager],
...
def expected_opener_body(fixtures: Mapping[str, List[DesktopObjectDict]] | Mapping[CollectionKey, List[DesktopObjectDict]], coll: str | CollectionKey,
                         wstl_builder: wstl.RuntimeWeSTLDocumentBuilder,
                         default_db_manager_cls: Type[MicroserviceDatabaseManager],
...
def expected_one_duplicate_form(fixtures: Mapping[str, List[DesktopObjectDict]] | Mapping[CollectionKey, List[DesktopObjectDict]],
                                coll: str | CollectionKey,
                                wstl_builder: wstl.RuntimeWeSTLDocumentBuilder,
                                default_db_manager_cls: Type[MicroserviceDatabaseManager],
...
def expected_all(fixtures: Mapping[str, List[DesktopObjectDict]] | Mapping[CollectionKey, List[DesktopObjectDict]], coll: str | CollectionKey,
                 wstl_builder: wstl.RuntimeWeSTLDocumentBuilder,
                 default_db_manager_cls: Type[MicroserviceDatabaseManager],
...
def expected_values(fixtures: Mapping[str, List[DesktopObjectDict]] | Mapping[CollectionKey, List[DesktopObjectDict]],
                    ...
                    default_db_manager_cls: Type[MicroserviceDatabaseManager] = MicroserviceDatabaseManager) -> Dict[str, Any]:
    """
...
def _expected_one_form(fixtures: Mapping[str, List[DesktopObjectDict]] | Mapping[CollectionKey, List[DesktopObjectDict]],
                       coll: str | CollectionKey,
                       wstl_builder: wstl.RuntimeWeSTLDocumentBuilder,
                       default_db_manager_cls: Type[MicroserviceDatabaseManager],
                       action_name: str,
