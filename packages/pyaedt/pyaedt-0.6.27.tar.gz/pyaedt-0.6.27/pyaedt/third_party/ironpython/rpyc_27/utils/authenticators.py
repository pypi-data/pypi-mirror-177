...
:data:`configuration dict <pyaedt.third_party.ironpython.rpyc_27.core.protocol.DEFAULT_CONFIG>` under the key "credentials".
...
Authenticators are used by :class:`~pyaedt.third_party.ironpython.rpyc_27.utils.server.Server` to
...
class SSLAuthenticator(object):
    ...
    :func:`pyaedt.third_party.ironpython.rpyc_27.utils.factory.ssl_connect`. Classic clients can use directly
    :func:`pyaedt.third_party.ironpython.rpyc_27.utils.classic.ssl_connect` which sets the correct
    service parameters.
    """
