...
DEPLOYMENT_METADATA_OPTIONS = {
    ...
    "upload_python_executable": (
        str,
        Option(
            None,
            "--upload-python-executable",
            help=(
                "Optional path to the Python source project to build and upload as a Python executable."
            ),
            hidden=True,
        ),
    ),
    "python_version": (
        ...
        Option(
            "3.8",
            "--python-version",
            help=("Target Python version for --upload-python-executable, as 'major.minor'."),
            hidden=True,
        ),
    ),
    "deps_cache_from": (
        ...
        Option(
            None,
            "--deps-cache-from",
            help=("Reuse dependencies for --upload-python-executable, using this tag."),
            hidden=True,
        ),
    ),
    "deps_cache_to": (
        ...
        Option(
            None,
            "--deps-cache-to",
            help=("Cache dependencies for --upload-python-executable, using this tag."),
            hidden=True,
        ),
    ),
}
