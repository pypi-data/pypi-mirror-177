...
class Variable:
    ...
    def __init__(self, 
        ...
        if variables is not None: assert coefficients is not None and len(coefficients) == len(variables), "Provide both variables and coefficients if creating a variable from other variables, of the same length"
