 ...
 * + doubleConv1dMultiplyByDiagonalMat
 ...
 * # doubleMultiplyByDiagonalRademacherMat2D
 *
 * Multiplies an input 2d array X by a 1d array rademArray assumed
 ...
 */
void doubleMultiplyByDiagonalRademacherMat2D(double *X,
                    int8_t *rademArray,
                    int dim1,
 ...
 * # doubleMultiplyByDiagonalRademacherMat
 *
 * Multiplies an input 3d array X by a 3d array rademArray assumed
 ...
 * Operations are in place so nothing is returned.
 */
void doubleMultiplyByDiagonalRademacherMat(double *X,
                    int8_t *rademArray,
                    int dim1, int dim2,
                    int startRow, int endRow){
...
void doubleConv1dMultiplyByDiagonalMat(double *reshapedX,
    ...
    for (int i = startRow; i < endRow; i++){
        xElement = reshapedX + i * rowStride;
