...
def NM_CV_Optimizer(model, train_dset,
                    bounds, maxiter = 25,
                    ...
                    mode = "cg"):
    """Conducts a Nelder-Mead hyperparameter optimization using cross-validations
    to score.
    ...
    """
    _check_inputs(maxiter, model, preset_hparams, score_type)
