 ...
 * for convolution. The activation functions and other steps are
 * applied by the Cython wrapper.
 * + floatConv1dPrep_
 * Performs the core fast hadamard transform based operations needed
 * for convolution, but for single-precision arrays. The activation
 ...
 * with multithreading. It is assumed that caller
