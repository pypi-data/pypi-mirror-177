...
class TestTdBacktest(TQBaseTestcase):
    ...
    def test_various_combinations_of_order_1(self):
        ...
        set_test_script(os.path.join(dir_path, "log_file", "test_various_combinations_of_order_1.script.lzma"))
    ...
    def test_various_combinations_of_order_2(self):
        ...
        dir_path = os.path.dirname(os.path.realpath(__file__))
        md_url = "wss://backtest.shinnytech.com/t/nfmd/front/mobile"
        set_test_script(os.path.join(dir_path, "log_file", "test_various_combinations_of_order_2.script.lzma"))
        # 测试2：多次开,一次全平完
        utils.RD = random.Random(4)
        api = TqApi(
            backtest=TqBacktest(start_dt=datetime.datetime(2020, 6, 2, 9), end_dt=datetime.datetime(2020, 6, 3)),
    ...
    def test_various_combinations_of_order_3(self):
        ...
        dir_path = os.path.dirname(os.path.realpath(__file__))
        md_url = "wss://backtest.shinnytech.com/t/nfmd/front/mobile"
        set_test_script(os.path.join(dir_path, "log_file", "test_various_combinations_of_order_3.script.lzma"))
    ...
    def test_various_combinations_of_order_4(self):
        ...
        dir_path = os.path.dirname(os.path.realpath(__file__))
        md_url = "wss://backtest.shinnytech.com/t/nfmd/front/mobile"
        set_test_script(os.path.join(dir_path, "log_file", "test_various_combinations_of_order_4.script.lzma"))
    ...
    def test_sim_insert_order_time_check_1(self):
        ...
        dir_path = os.path.dirname(os.path.realpath(__file__))
        md_url = "wss://backtest.shinnytech.com/t/nfmd/front/mobile"
        set_test_script(os.path.join(dir_path, "log_file", "test_sim_insert_order_time_check_1.script.lzma"))
    ...
    def test_sim_insert_order_time_check_2(self):
        ...
        dir_path = os.path.dirname(os.path.realpath(__file__))
        md_url = "wss://backtest.shinnytech.com/t/nfmd/front/mobile"
        set_test_script(os.path.join(dir_path, "log_file", "test_sim_insert_order_time_check_2.script.lzma"))
    ...
    def test_sim_insert_order_time_check_3(self):
        ...
        dir_path = os.path.dirname(os.path.realpath(__file__))
        md_url = "wss://backtest.shinnytech.com/t/nfmd/front/mobile"
        set_test_script(os.path.join(dir_path, "log_file", "test_sim_insert_order_time_check_3.script.lzma"))
    ...
    def test_sim_insert_order_time_check_4(self):
        ...
        dir_path = os.path.dirname(os.path.realpath(__file__))
        md_url = "wss://backtest.shinnytech.com/t/nfmd/front/mobile"
        set_test_script(os.path.join(dir_path, "log_file", "test_sim_insert_order_time_check_4.script.lzma"))
    ...
    def test_sim_insert_order_time_check_5(self):
        ...
        dir_path = os.path.dirname(os.path.realpath(__file__))
        md_url = "wss://backtest.shinnytech.com/t/nfmd/front/mobile"
        set_test_script(os.path.join(dir_path, "log_file", "test_sim_insert_order_time_check_5.script.lzma"))
    ...
    def test_sim_insert_order_time_check_6(self):
        ...
        dir_path = os.path.dirname(os.path.realpath(__file__))
        md_url = "wss://backtest.shinnytech.com/t/nfmd/front/mobile"
        set_test_script(os.path.join(dir_path, "log_file", "test_sim_insert_order_time_check_6.script.lzma"))
    ...
    def test_sim_insert_order_time_check_7(self):
        ...
        dir_path = os.path.dirname(os.path.realpath(__file__))
        md_url = "wss://backtest.shinnytech.com/t/nfmd/front/mobile"
        set_test_script(os.path.join(dir_path, "log_file", "test_sim_insert_order_time_check_7.script.lzma"))
