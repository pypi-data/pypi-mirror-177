...
setup(
    ...
    description=(
        "Type annotations for boto3.ChimeSDKVoice 1.26.13 service generated with mypy-boto3-builder"
        " 7.11.11"
    ),
    classifiers=[
    ...
    package_data={"": ["LICENSE"], "mypy_boto3_chime_sdk_voice": ["py.typed", "*.pyi"]},
    python_requires=">=3.7",
    project_urls={
