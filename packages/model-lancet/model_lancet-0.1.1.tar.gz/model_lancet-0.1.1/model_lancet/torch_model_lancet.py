...
class ModelLancet:
    def __init__(self, model: torch.nn.Module, target_module_class_name: str, target_function_name: str = 'forward', influence_child_class: bool = True):
        '''
        ...
        self.influence_child_class = influence_child_class
