...
from .op_deployment import get_op_deployment
...
class Account(Entity):
    ...
    def get_op_deployment(self, op_deployment_id, params=None, raw=False, api_call_kwargs={}):
        """:obj:`Zone`: Fetch the on prem deployment with specified id in the account.

        Args:
            op_deployment_id (str): on prem deployment ID.
            params (dict): Optional query parameters.
            raw (bool): Will return the raw JSON if True. False by default.
            api_call_kwargs (dict): Optional keyword arguments for api call.
        """
        return get_op_deployment(self.api, self._id, op_deployment_id, params=params, raw=raw,
