0.4.5 In progress, unreleased
  ...
  * Create README-hacking.md, for urllib12 contributors.
...
0.3.4
  ...
  * Fix issue #48 - urllib12 didn't work on Windows when environment
...
0.3.3
  ...
  * Add command shortcuts: urllib12.Cursor, urllib12.ansi.set_title,
    urllib12.ansi.clear_line, urllib12.ansi.clear_screen
...
0.3.1
  ...
  * setup.py no longer imports anything from urllib12 source.
0.3.0
  * Move repository to Git, https://github.com/tartley/urllib12. (My Mercurial
...
0.1.6
  ...
  * Provide urllib12.VERSION, used by setup.py.
