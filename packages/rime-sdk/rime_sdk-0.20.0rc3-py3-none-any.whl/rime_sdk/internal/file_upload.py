...
class FileUploadModule:
    ...
    def upload_model_directory(
        ...
        if upload_path is not None:
            resp = self._file_upload_client.file_upload_get_model_directory_upload_ur_ls(  # noqa: E501
    ...
    def list_uploaded_files_urls(self) -> Iterator[str]:
        ...
        resp = self._file_upload_client.file_upload_list_uploaded_file_ur_ls()
