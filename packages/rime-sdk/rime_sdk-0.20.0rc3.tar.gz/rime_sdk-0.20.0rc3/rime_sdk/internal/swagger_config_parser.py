...
def _formatted_time_to_int_time(timestamp_str: str) -> int:
    ...
    # TODO: change function once we replace swagger start_time/end_time
    # int type with swagger Timestamp type
...
def convert_single_unstructured_params_to_swagger(
    ...
    """Convert unstructured params dictionary to swagger."""
    result: Dict[str, Any] = {}
    ...
    if len(result) == 0:
        ...
        return CliconfigUnstructuredSingleDataInfoParams(**result)
