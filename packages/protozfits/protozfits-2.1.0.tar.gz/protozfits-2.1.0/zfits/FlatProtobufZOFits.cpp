                              ...
                              FlatProtobufZOFits* parent)
{
    ...
    // temporal fix! : change the name of "R1.CameraConfiguration" as "CTAR1.CameraConfiguration"
    if (descriptor->full_name() == "R1.CameraConfiguration")
        SetStr("PBFHEAD", "CTAR1.CameraConfiguration", "Written message name");
