...
void ProtobufZOFits::initColumns(const google::protobuf::Message* message)
{
    ...
    string top_level_name = _descriptor->full_name();

    if (top_level_name == "R1.CameraConfiguration")
        top_level_name = "CTAR1.CameraConfiguration";
    if (top_level_name == "R1.Event")
        top_level_name = "CTAR1.Event";

    SetStr("PBFHEAD", top_level_name, "Written message name");
