...
def get_version():
    return Fore.GREEN+"Version: 0.2.7"
...
example
	...
	parser.add_argument('-arch', required=False, type=str, help='Target arch architecturet', choices=('mips','mipsel','mips64','mipsel64','armelv5','armelv7','armebv5','armebv7','aarch64','x86','x64','aarch64','android','powerpc','powerpcle','powerpc64','powerpc64le','sparc'))
	...
	if(args.arch != None and args.model != None):
		...
		try:
			...
			log.success("{} ---> {}, After that, you only need to specify {}, not the arch".format(model ,args.arch, args.model))
