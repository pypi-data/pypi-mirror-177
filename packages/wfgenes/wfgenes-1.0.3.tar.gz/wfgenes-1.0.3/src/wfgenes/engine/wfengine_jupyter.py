...
def manage_workflows_button_clicked(bvar):
    ...
    with output_manage_workflows_button:
        ...
        display(HBox([status_button, new_workflow_button,
                      remove_workflow_button, modify_button ]), output_status_button,
                output_new_workflow_button, output_remove_workflow_button, output_modify_button)         
...
class WFEnginejupyter():
    ...
    def update_button_clicked(self, bvar):
        ...
        with output_modify_button:
            clear_output()
            self.wfe.update_node(firework_id.value, update_string.value)   
