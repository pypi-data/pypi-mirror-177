...
# DO NOT CHANGE ORDER.
# Used in
# - from_file() classmethod of Experiment in ac.py
# - ac_mode_func() in cli.py
...
def parse_headers(file: str,
    ...
    return header_indices, header_names, HEADERS_SUPPORTED
...
class Measurement():
    ...
    def from_file(cls, file: str, header_indices: dict,
        ...
        cols = list(header_indices.values())
        ...
        # sus_real and sus_imaginary, defined in HEADERS_GENERIC
        real_sus = list(header_indices.keys())[2]
        imaginary_sus = list(header_indices.keys())[3]
        converters[header_indices[real_sus]] = cls.check_pos_sus
        converters[header_indices[imaginary_sus]] = cls.check_pos_sus
