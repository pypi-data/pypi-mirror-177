...
#     SW_getData(company, channel, start_date, end_date, site_code, dbTableName, item)
    ...
    # start_date = '2022-07'
    # end_date = '2022-10'
    # site_code = ['world', 'uk', 'us', 'au']
    # dbTableName = 'tb_sw_test4'
