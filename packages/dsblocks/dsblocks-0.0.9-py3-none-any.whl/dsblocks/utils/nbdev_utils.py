...
# %% ../../nbs/utils/nbdev_utils.ipynb 12
class TestRunner ():
...
# %% ../../nbs/utils/nbdev_utils.ipynb 24
def md (txt, nl=''):
    if 'b' in nl: print ('\n')
    display(Markdown(txt))
    if 'e' in nl: print ('\n')

# %% ../../nbs/utils/nbdev_utils.ipynb 27
...
# %% ../../nbs/utils/nbdev_utils.ipynb 36
def nbdev_build_all ():
...
# %% ../../nbs/utils/nbdev_utils.ipynb 43
def nbdev_sync ():
