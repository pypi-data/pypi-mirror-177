...
class SetHyperparameterPopUp(object):
    ...
    def global_unit_tests(self):
        ...
        check_str(name='Under sample setting', value=self.undersample_setting_entrybox.entry_get.lower(), options=('random undersample', '', 'none'))
        ...
        check_str(name='Over sample setting', value=self.oversample_setting_entrybox.entry_get.lower(), options=('smote', 'smoteen', '', 'none'))
    ...
    def populate_table(self):
        ...
        self.create_feature_importance_bar_graph_var.set(value=self.meta_dict['generate_features_importance_log'])
