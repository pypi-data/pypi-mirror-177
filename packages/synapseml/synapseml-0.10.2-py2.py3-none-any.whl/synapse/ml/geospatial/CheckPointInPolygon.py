...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_4ad847e2063a_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_4ad847e2063a_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_4ad847e2063a_error")
        self._setDefault(outputCol="CheckPointInPolygon_4ad847e2063a_output")
