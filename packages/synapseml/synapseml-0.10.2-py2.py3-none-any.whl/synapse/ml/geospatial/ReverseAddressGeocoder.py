...
class ReverseAddressGeocoder(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ReverseAddressGeocoder_05d7dcb07f8e_error",
        ...
        outputCol="ReverseAddressGeocoder_05d7dcb07f8e_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="ReverseAddressGeocoder_05d7dcb07f8e_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="ReverseAddressGeocoder_05d7dcb07f8e_output")
