...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TagImage_a58aabfbaa85_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_a58aabfbaa85_output",
        ...
        self._setDefault(errorCol="TagImage_a58aabfbaa85_error")
        self._setDefault(outputCol="TagImage_a58aabfbaa85_output")
