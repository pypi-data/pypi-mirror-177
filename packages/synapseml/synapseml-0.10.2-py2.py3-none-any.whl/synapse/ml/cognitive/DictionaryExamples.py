...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryExamples_efca929d0685_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_efca929d0685_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_efca929d0685_error")
        self._setDefault(outputCol="DictionaryExamples_efca929d0685_output")
