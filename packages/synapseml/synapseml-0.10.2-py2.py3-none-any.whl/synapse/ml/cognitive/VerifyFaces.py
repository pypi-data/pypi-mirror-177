...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="VerifyFaces_7c3060c31d9b_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_7c3060c31d9b_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_7c3060c31d9b_error")
        self._setDefault(outputCol="VerifyFaces_7c3060c31d9b_output")
