...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="FindSimilarFace_44256dd1ac21_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_44256dd1ac21_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_44256dd1ac21_error")
        self._setDefault(outputCol="FindSimilarFace_44256dd1ac21_output")
