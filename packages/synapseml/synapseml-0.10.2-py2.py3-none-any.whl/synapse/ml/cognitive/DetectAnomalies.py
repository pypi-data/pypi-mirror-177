...
class DetectAnomalies(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectAnomalies_7f29a9eb68b5_error",
        granularity=None,
        granularityCol=None,
        handler=None,
        ...
        outputCol="DetectAnomalies_7f29a9eb68b5_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="DetectAnomalies_7f29a9eb68b5_error")
        self._setDefault(outputCol="DetectAnomalies_7f29a9eb68b5_output")
