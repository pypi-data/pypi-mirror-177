...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Detect_7dd8a9e72284_error",
        handler=None,
        outputCol="Detect_7dd8a9e72284_output",
        ...
        self._setDefault(errorCol="Detect_7dd8a9e72284_error")
        self._setDefault(outputCol="Detect_7dd8a9e72284_output")
