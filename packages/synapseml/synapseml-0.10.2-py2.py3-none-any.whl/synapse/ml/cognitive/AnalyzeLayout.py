...
class AnalyzeLayout(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AnalyzeLayout_0f48aa9c4e65_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        outputCol="AnalyzeLayout_0f48aa9c4e65_output",
        pages=None,
        pagesCol=None,
        pollingDelay=300,
        readingOrder=None,
        ...
        self._setDefault(errorCol="AnalyzeLayout_0f48aa9c4e65_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeLayout_0f48aa9c4e65_output")
