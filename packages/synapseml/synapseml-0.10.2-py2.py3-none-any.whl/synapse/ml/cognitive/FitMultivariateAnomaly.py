...
class FitMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    def __init__(
        ...
        displayName=None,
        endTime=None,
        errorCol="FitMultivariateAnomaly_64f46613862b_error",
        fillNAMethod=None,
        initialPollingDelay=300,
        inputCols=None,
        intermediateSaveDir=None,
        maxPollingRetries=1000,
        outputCol="FitMultivariateAnomaly_64f46613862b_output",
        paddingValue=None,
        pollingDelay=300,
        slidingWindow=None,
        startTime=None,
        ...
        self._setDefault(errorCol="FitMultivariateAnomaly_64f46613862b_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="FitMultivariateAnomaly_64f46613862b_output")
