...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Translate_a1dd7b280dc2_error",
        fromLanguage=None,
        ...
        outputCol="Translate_a1dd7b280dc2_output",
        ...
        self._setDefault(errorCol="Translate_a1dd7b280dc2_error")
        self._setDefault(outputCol="Translate_a1dd7b280dc2_output")
