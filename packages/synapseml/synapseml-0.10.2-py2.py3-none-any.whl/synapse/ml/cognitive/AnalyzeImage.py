...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_0d47f31b0996_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_0d47f31b0996_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_0d47f31b0996_error")
        self._setDefault(outputCol="AnalyzeImage_0d47f31b0996_output")
