...
class _BingImageSearch(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        count=None,
        countCol=None,
        errorCol="BingImageSearch_43f4a06cec5c_error",
        freshness=None,
        freshnessCol=None,
        handler=None,
        height=None,
        ...
        offset=None,
        offsetCol=None,
        outputCol="BingImageSearch_43f4a06cec5c_output",
        q=None,
        qCol=None,
        size=None,
        sizeCol=None,
        ...
        self._setDefault(errorCol="BingImageSearch_43f4a06cec5c_error")
        self._setDefault(outputCol="BingImageSearch_43f4a06cec5c_output")
