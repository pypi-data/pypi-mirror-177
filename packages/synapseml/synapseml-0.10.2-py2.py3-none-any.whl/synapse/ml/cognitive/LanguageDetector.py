...
class LanguageDetector(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="LanguageDetector_1d08f407c160_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="LanguageDetector_1d08f407c160_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="LanguageDetector_1d08f407c160_error")
        self._setDefault(outputCol="LanguageDetector_1d08f407c160_output")
