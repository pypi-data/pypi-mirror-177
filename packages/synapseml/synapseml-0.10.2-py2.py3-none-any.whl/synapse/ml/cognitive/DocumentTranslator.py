...
class DocumentTranslator(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DocumentTranslator_d4b9e9a6120b_error",
        filterPrefix=None,
        ...
        outputCol="DocumentTranslator_d4b9e9a6120b_output",
        pollingDelay=300,
        serviceName=None,
        sourceLanguage=None,
        ...
        self._setDefault(errorCol="DocumentTranslator_d4b9e9a6120b_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="DocumentTranslator_d4b9e9a6120b_output")
