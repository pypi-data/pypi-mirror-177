...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Transliterate_b0b51f1b8e66_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_b0b51f1b8e66_output",
        ...
        self._setDefault(errorCol="Transliterate_b0b51f1b8e66_error")
        self._setDefault(outputCol="Transliterate_b0b51f1b8e66_output")
