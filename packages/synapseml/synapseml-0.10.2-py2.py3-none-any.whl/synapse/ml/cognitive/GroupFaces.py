...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GroupFaces_037ebf830659_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_037ebf830659_output",
        ...
        self._setDefault(errorCol="GroupFaces_037ebf830659_error")
        self._setDefault(outputCol="GroupFaces_037ebf830659_output")
