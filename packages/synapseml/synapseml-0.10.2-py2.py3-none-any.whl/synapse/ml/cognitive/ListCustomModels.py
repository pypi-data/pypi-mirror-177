...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ListCustomModels_af9d2f9fad64_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_af9d2f9fad64_output",
        ...
        self._setDefault(errorCol="ListCustomModels_af9d2f9fad64_error")
        self._setDefault(outputCol="ListCustomModels_af9d2f9fad64_output")
