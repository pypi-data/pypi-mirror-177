...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DescribeImage_eb2c910124b7_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_eb2c910124b7_output",
        ...
        self._setDefault(errorCol="DescribeImage_eb2c910124b7_error")
        self._setDefault(outputCol="DescribeImage_eb2c910124b7_output")
