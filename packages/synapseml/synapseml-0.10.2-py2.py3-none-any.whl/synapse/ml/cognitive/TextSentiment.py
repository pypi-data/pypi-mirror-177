...
class TextSentiment(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextSentiment_c9c4bbcd43b2_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        ...
        outputCol="TextSentiment_c9c4bbcd43b2_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="TextSentiment_c9c4bbcd43b2_error")
        self._setDefault(outputCol="TextSentiment_c9c4bbcd43b2_output")
