...
class DetectMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    ...
    def __init__(
        ...
        endTime=None,
        errorCol="DetectMultivariateAnomaly_72a7c78ef83e_error",
        initialPollingDelay=300,
        inputCols=None,
        intermediateSaveDir=None,
        maxPollingRetries=1000,
        modelId=None,
        outputCol="DetectMultivariateAnomaly_72a7c78ef83e_output",
        pollingDelay=300,
        startTime=None,
        ...
        self._setDefault(errorCol="DetectMultivariateAnomaly_72a7c78ef83e_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="DetectMultivariateAnomaly_72a7c78ef83e_output")
