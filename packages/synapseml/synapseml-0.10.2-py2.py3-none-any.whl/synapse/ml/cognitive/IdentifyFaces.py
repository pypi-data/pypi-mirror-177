...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="IdentifyFaces_b5ccc3740015_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_b5ccc3740015_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_b5ccc3740015_error")
        self._setDefault(outputCol="IdentifyFaces_b5ccc3740015_output")
