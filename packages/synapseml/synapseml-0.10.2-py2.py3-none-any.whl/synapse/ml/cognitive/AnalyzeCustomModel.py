...
class AnalyzeCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AnalyzeCustomModel_991beb7165be_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        outputCol="AnalyzeCustomModel_991beb7165be_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AnalyzeCustomModel_991beb7165be_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeCustomModel_991beb7165be_output")
