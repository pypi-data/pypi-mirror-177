...
class DetectLastAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectLastAnomaly_dceec3e33bf3_error",
        granularity=None,
        granularityCol=None,
        handler=None,
        ...
        outputCol="DetectLastAnomaly_dceec3e33bf3_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="DetectLastAnomaly_dceec3e33bf3_error")
        self._setDefault(outputCol="DetectLastAnomaly_dceec3e33bf3_output")
