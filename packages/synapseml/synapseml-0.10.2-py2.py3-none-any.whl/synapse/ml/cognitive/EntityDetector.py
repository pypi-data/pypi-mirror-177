...
class EntityDetector(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="EntityDetector_34d4c3a47075_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="EntityDetector_34d4c3a47075_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="EntityDetector_34d4c3a47075_error")
        self._setDefault(outputCol="EntityDetector_34d4c3a47075_output")
