...
class TextAnalyze(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextAnalyze_738aa1a6b5fd_error",
        ...
        outputCol="TextAnalyze_738aa1a6b5fd_output",
        ...
        self._setDefault(errorCol="TextAnalyze_738aa1a6b5fd_error")
        ...
        self._setDefault(outputCol="TextAnalyze_738aa1a6b5fd_output")
