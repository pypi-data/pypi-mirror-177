...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectFace_4e3138c465aa_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_4e3138c465aa_output",
        ...
        self._setDefault(errorCol="DetectFace_4e3138c465aa_error")
        self._setDefault(outputCol="DetectFace_4e3138c465aa_output")
