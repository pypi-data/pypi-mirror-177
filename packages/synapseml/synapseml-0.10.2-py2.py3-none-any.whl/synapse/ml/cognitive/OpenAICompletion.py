...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAPICompletion_1ec19c0ac86e_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAPICompletion_1ec19c0ac86e_output",
        ...
        self._setDefault(errorCol="OpenAPICompletion_1ec19c0ac86e_error")
        self._setDefault(outputCol="OpenAPICompletion_1ec19c0ac86e_output")
