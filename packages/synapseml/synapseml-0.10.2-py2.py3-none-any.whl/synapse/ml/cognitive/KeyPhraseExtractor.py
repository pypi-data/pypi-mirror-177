...
class KeyPhraseExtractor(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="KeyPhraseExtractor_db69ac3b95ff_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="KeyPhraseExtractor_db69ac3b95ff_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="KeyPhraseExtractor_db69ac3b95ff_error")
        self._setDefault(outputCol="KeyPhraseExtractor_db69ac3b95ff_output")
