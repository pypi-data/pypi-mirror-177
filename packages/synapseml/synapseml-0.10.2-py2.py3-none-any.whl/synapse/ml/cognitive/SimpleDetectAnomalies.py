...
class SimpleDetectAnomalies(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="SimpleDetectAnomalies_029158321fe1_error",
        granularity=None,
        granularityCol=None,
        groupbyCol=None,
        handler=None,
        ...
        outputCol="SimpleDetectAnomalies_029158321fe1_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="SimpleDetectAnomalies_029158321fe1_error")
        self._setDefault(outputCol="SimpleDetectAnomalies_029158321fe1_output")
