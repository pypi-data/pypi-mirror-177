    ...
    def install(self, java_install_path: str = '') -> None:
        """
            ...
            Parameters:
                ...
                java_install_path: java install path string, you can provide java install path like "C:\\Program Files\\Java\\jdk-17.0.2\\bin". If you don't give that path, it will scan java install path under "Program Files && Program Files (x86)"
