...
class TerraScopeSDK:
    """
    TerraScope API PRD: https://docs.google.com/spreadsheets/d/11622e1DL-IHAOTElYXPLAL_T1nzl0IDYrF08rj6puvk/edit#gid=0
    """
    ...
    @staticmethod
    def create_client(oi_papi_host: str, user_token: str):
        """
        ...
        """
        return TerrascopeAsyncClient(oi_papi_host, 443, api_token=user_token, secure=True)
