...
class TestAlgorithmComputation:
    ...
    async def test_create(self):
        ...
        config.add_data_source(data_type=DataType.OPTICAL_IMAGERY, data_source=DataSource.PLANET_SKYSATCOLLECT)
        config.add_data_source(data_type=DataType.OPTICAL_IMAGERY, data_source=DataSource.AIRBUS_PHR1A)
