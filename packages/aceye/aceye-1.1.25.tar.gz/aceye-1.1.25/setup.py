...
{'': ['*'],
 'aceye': ['Application Profiles/CSV/*',
           ...
           'Events/Mindmap/*',
           'Events/YAML/*',
           'Fabric Node SSL Certificate/CSV/*',
           'Fabric Node SSL Certificate/HTML/*',
           'Fabric Node SSL Certificate/JSON/*',
           'Fabric Node SSL Certificate/Markdown/*',
           'Fabric Node SSL Certificate/Mindmap/*',
           'Fabric Node SSL Certificate/YAML/*',
           'Fabric Nodes/CSV/*',
           'Fabric Nodes/HTML/*',
           'Fabric Nodes/JSON/*',
