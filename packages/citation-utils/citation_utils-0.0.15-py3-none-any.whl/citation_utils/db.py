...
from .__main__ import extract_citation_from_data
...
def set_row(detail: Path) -> dict:
    ...
    obj = extract_citation_from_data(data)
...
def setup_db():
    """Create a helper database to examine contents of local folder when parsed as a Citation object."""
    ...
    db["valid"].create_index(["docket_category", "docket_serial", "docket_date"])  # type: ignore
