...
class BuildCheckStage(PipelineStage):
    ...
    def __init__(
        self, build_outcome: BuildOutcome, tests_out_dir: TestsOutputDirectory
    ):
        self.build_outcome = build_outcome
        self.tests_out_dir = tests_out_dir
...
class RunStage(PipelineStage):
    ...
    def __init__(
        self, tests_out_dir: TestsOutputDirectory, reuse_if_ready: bool, verbose: bool
    ):
        self.tests_out_dir = tests_out_dir
        self.reuse_if_ready = reuse_if_ready
...
class SelfCheckStage(PipelineStage):
    ...
    def __init__(self, tests_out_dir: TestsOutputDirectory):
        self.tests_out_dir = tests_out_dir
