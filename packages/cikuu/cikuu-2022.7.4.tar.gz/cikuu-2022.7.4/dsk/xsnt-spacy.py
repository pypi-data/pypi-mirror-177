...
if not hasattr(spacy, 'nlp'): spacy.nlp	= spacy.load('en_core_web_sm') # 3.4.1, lg

def consume(name:str, func:str='spacy341',  db=0, waitms=3600000, ttl=47200, precount=1,debug=False): 
