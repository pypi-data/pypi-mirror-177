...
class LocationCodePatchDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["locationcode", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["locationcode", ], str]):
