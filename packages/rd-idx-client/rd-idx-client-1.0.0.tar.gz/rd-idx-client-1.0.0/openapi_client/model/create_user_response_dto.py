...
class CreateUserResponseDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["userId", "memberId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["userId", "memberId", ], str]):
