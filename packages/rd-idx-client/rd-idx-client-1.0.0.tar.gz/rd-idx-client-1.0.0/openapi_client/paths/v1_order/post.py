...
# body param
SchemaForRequestBodyApplicationJson = OrderPostDto


request_body_order_post_dto = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = OrderGetDto
...
class BaseApi(api_client.Api):
    ...
    def _create_order_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_order_post_dto.serialize(body, content_type)
