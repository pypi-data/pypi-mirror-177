...
from pyroxd.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~pyroxd.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <pyroxd.api.types.messages.BotResults>`: On Success.
        ...
        Example:
            .. code-block:: python
                ...
                results = await app.get_inline_bot_results("pyroxdbot")
                print(results)
        """
