...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyroxd.types.InputMediaPhoto`, :obj:`~pyroxd.types.InputMediaVideo`, :obj:`~pyroxd.types.InputMediaAudio` and :obj:`~pyroxd.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyroxd.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyroxd.types import InputMediaPhoto, InputMediaVideo
