...
async def compose(
    ...
    If you want to run a single client, you can use Client's bound method :meth:`~pyroxd.Client.run`.

    Parameters:
        clients (List of :obj:`~pyroxd.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from pyroxd import Client, compose
