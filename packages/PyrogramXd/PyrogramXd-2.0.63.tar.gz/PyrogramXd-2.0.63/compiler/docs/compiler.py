...
FUNCTIONS_PATH = "pyroxd/raw/functions"
TYPES_PATH = "pyroxd/raw/types"
BASE_PATH = "pyroxd/raw/base"
...
def generate(source_path, base):
                ...
                with open(DESTINATION + "/" + full_path, "w", encoding="utf-8") as f:
                    f.write(
                        page_template.format(
                            ...
                            full_class_path="pyroxd.raw.{}".format(
    ...
    for k, v in sorted(all_entities.items()):
        ...
        if k != base:
            ...
            module = "pyroxd.raw.{}.{}".format(base, k)
        else:
        ...
        for k, v in categories.items():
            ...
            for method in methods:
                with open(root + "/{}.rst".format(method), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. automethod:: pyroxd.Client.{}()".format(method))
            ...
            for func in functions:
                with open(root + "/{}.rst".format(func), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. autofunction:: pyroxd.{}()".format(func))
        ...
        for k, v in categories.items():
            ...
            for type in types:
                with open(root + "/{}.rst".format(type), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. autoclass:: pyroxd.types.{}()\n".format(type))
        ...
        for k, v in categories.items():
            ...
            for bm in bound_methods:
                with open(root + "/{}.rst".format(bm), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. automethod:: pyroxd.types.{}()".format(bm))
