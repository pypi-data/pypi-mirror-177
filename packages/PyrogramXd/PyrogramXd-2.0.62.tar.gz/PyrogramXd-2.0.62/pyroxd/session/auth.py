...
from pyroxd.crypto import aes, rsa, prime
from pyroxd.errors import SecurityCheckMismatch
from pyroxd.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pyroxd.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
