...
class ChatJoinRequest(Object, Update):
    ...
    Parameters:
        ...
        invite_link (:obj:`~pyroxd.types.ChatInviteLink`, *optional*):
    ...
    async def approve(self) -> bool:
        """Bound method *approve* of :obj:`~pyroxd.types.ChatJoinRequest`.
    ...
    async def decline(self) -> bool:
        """Bound method *decline* of :obj:`~pyroxd.types.ChatJoinRequest`.
