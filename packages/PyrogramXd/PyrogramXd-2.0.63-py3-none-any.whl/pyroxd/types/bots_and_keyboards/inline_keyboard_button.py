...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~pyroxd.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~pyroxd.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~pyroxd.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~pyroxd.types.CallbackGame`, *optional*):
