...
import pyroxd
from pyroxd.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~pyroxd.Client.start`, :meth:`~pyrogram.idle` and :meth:`~pyroxd.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`pyroxd.Compose`.
