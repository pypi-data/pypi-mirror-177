...
class SendAnimation:
    async def send_animation(
        ...
        Returns:
            :obj:`~pyroxd.types.Message` | ``None``: On success, the sent animation message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~pyroxd.Client.stop_transmission`, None is
            returned.
