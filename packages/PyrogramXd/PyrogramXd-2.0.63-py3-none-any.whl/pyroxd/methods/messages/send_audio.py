...
import pyroxd
from pyroxd import StopTransmission, enums
from pyroxd import raw
from pyroxd import types
from pyroxd import utils
from pyroxd.errors import FilePartMissing
from pyroxd.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~pyroxd.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyroxd.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyroxd.Client.stop_transmission`, None is returned.
