...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~pyroxd.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~pyroxd.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyroxd.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "pyroxd". Get the first 50 results
                async for message in app.search_global("pyroxd", limit=50):
                    print(message.text)
