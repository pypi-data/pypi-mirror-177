...
class CreateChatInviteLink:
    async def create_chat_invite_link(
        ...
        The link can be revoked using the method :meth:`~pyroxd.Client.revoke_chat_invite_link`.
        ...
        Returns:
            :obj:`~pyroxd.types.ChatInviteLink`: On success, the new invite link is returned.
