...
from pyroxd.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "pyroxd.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pyroxd.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~pyroxd.handlers.MessageHandler` the *update* argument will be a :obj:`~pyroxd.types.Message`; in a :obj:`~pyroxd.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pyroxd.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pyroxd.filters.command` or :meth:`~pyroxd.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pyroxd.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pyroxd.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pyroxd.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pyroxd.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pyroxd.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pyroxd.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pyroxd.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pyroxd.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pyroxd.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pyroxd.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pyroxd.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pyroxd.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pyroxd.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pyroxd.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pyroxd.types.Message`.
    ...
    async def func(flt, client: pyroxd.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyroxd.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyroxd.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyroxd.types.InlineQuery`: The filter will match ``query``.
