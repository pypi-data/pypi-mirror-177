...
import pyroxd
from pyroxd import __version__, __license__
from pyroxd import enums
from pyroxd import raw
from pyroxd import utils
from pyroxd.crypto import aes
from pyroxd.errors import CDNFileHashMismatch
from pyroxd.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    AuthBytesInvalid, BadRequest, ListenerCanceled
)
from pyroxd.handlers.handler import Handler
from pyroxd.methods import Methods
from pyroxd.session import Auth, Session
from pyroxd.storage import FileStorage, MemoryStorage
from pyroxd.types import User, TermsOfService
from pyroxd.utils import ainput
...
class Client(Methods):
    """pyroxd Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~pyroxd.Client.export_session_string` before stopping the client to get a session string you can
    ...
    APP_VERSION = f"Pyrogram-Xd {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"pyroxd is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~pyroxd.enums.ParseMode`):
