...
from pyroxd.errors import AuthBytesInvalid
from pyroxd.session import Session
from pyroxd.session.auth import Auth


async def get_session(client: "pyroxd.Client", dc_id: int):
