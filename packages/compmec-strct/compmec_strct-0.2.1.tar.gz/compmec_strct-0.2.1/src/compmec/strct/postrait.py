...
def splinecurve_element(p: int, ts: Iterable[float], points: np.ndarray, solution: Optional[np.ndarray]=None):
    """
...
def elementsolution(system: StaticSystem, element: Structural1D):
