...
Fortran = TokenizableLanguage(
    identifiers = [
        TokenIdentifier("keyword", r"(assign|backspace|block|call|close|common|continue|data|dimension|do|else|if|end|endfile|endif|entry|equivalence|external|format|function|goto|if|implicit|inquire|intrinsic|open|parameter|pause|print|program|read|return|rewind|rewrite|save|stop|subroutine|then|write)\b"),
        TokenIdentifier("comment", r"![^\n]*"),
        TokenIdentifier("function", r"(\w+)\s*\*\s*,", 1)
    ]
)
