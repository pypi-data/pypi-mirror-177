...
:LastEditTime: 2022-11-22 16:57:26
...
class GoodsManageHandler(StudioBaseHandler):
    ...
    def get_async(self, *args, **kwargs):
        ...
        # TODO 执行业务
        goods_model = GoodsModel().get_dict_by_id(goods_id,field="id,goods_name,goods_code,goods_icon,goods_integral,goods_inventory,goods_detail,status,price")
        if not goods_model:
...
class ExchangeListHandler(StudioBaseHandler):
    ...
    def get_async(self, *args, **kwargs):
        ...
        # 获取兑换列表
        exchange_list,exchange_count = ExchangeModelEx().get_exchange_page_list(condition,"a.order_id,a.goods_id,b.goods_name,b.goods_icon,a.user_id,a.nick_name,a.goods_integral,a.goods_code,a.goods_count,a.add_time",
                            limit = f"{(page_index-1)*page_size},{page_size}",params=param_list,order_by="a.id desc")
...
class GoodsListHandler(StudioBaseHandler):
