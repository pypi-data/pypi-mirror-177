...
class Ui_package_download(object):
    def setupUi(self, package_download):
        ...
        self.pte_package_names = QtWidgets.QPlainTextEdit(self.centralwidget)
        ...
        self.pb_clear_package_names = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.cmb_derived_from = QtWidgets.QComboBox(self.centralwidget)
        ...
        self.pb_show_dl_list = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.pb_start_download = QtWidgets.QPushButton(self.centralwidget)
    ...
    def retranslateUi(self, package_download):
        ...
        self.pte_package_names.setToolTip(_translate("package_download", "需要下载的模块名称，每行一个名称。"))
        self.pb_clear_package_names.setToolTip(_translate("package_download", "清空名称编辑区文字。"))
        self.pb_clear_package_names.setText(_translate("package_download", "清空"))
        self.pb_load_from_text.setToolTip(_translate("package_download", "从文本文件加载名称到名称编辑区。"))
        self.pb_load_from_text.setText(_translate("package_download", "从文件加载名称"))
        self.pb_save_as_text.setToolTip(_translate("package_download", "将名称编辑区的文字保存到文本文件。"))
        self.pb_save_as_text.setText(_translate("package_download", "名称保存到文件"))
...
"右侧留空的下载条件，下载时会使用从此环境派生的条件。"))
        ...
        self.cmb_derived_from.setToolTip(_translate("package_download", "下载安装包时需调用的 Python 环境。\n"
"右侧留空的下载条件，下载时会使用从此环境派生的条件。"))
...
"如果限制条件留空，则下载兼容所选环境的安装包。"))
        ...
        self.cb_download_deps.setToolTip(_translate("package_download", "对于名称编辑区中的每一个需要下载的模块，是否同时下载模块的依赖库。"))
        self.cb_download_deps.setText(_translate("package_download", "下载需要下载的包的依赖"))
        self.rb_unlimited.setToolTip(_translate("package_download", "不限制下载二进制包或者源代码包。"))
        self.rb_unlimited.setText(_translate("package_download", "不限制下载的包类型"))
        self.rb_no_binary.setToolTip(_translate("package_download", "仅下载包的源代码安装包。"))
        self.rb_no_binary.setText(_translate("package_download", "仅选择源代码包"))
        self.rb_only_binary.setToolTip(_translate("package_download", "仅下载包的二进制安装包。"))
        self.rb_only_binary.setText(_translate("package_download", "仅选择二进制包"))
        self.rb_prefer_binary.setToolTip(_translate("package_download", "对于既有二进制安装包又有源代码安装包的模块，\n"
"如果较新版本没有发布二进制安装包，则宁愿下载较旧版本的二进制安装包。"))
        self.rb_prefer_binary.setText(_translate("package_download", "宁选择旧二进制包而非新源代码包"))
        self.cb_include_pre.setToolTip(_translate("package_download", "如果模块的最新版本是预发行版或者是开发版，\n"
"也下载这些版本，否则只下载模块的最新稳定版本。"))
        self.cb_include_pre.setText(_translate("package_download", "包括预发行版和开发版"))
        self.cb_ignore_requires_python.setToolTip(_translate("package_download", "对于那些对 Python 版本有限制要求的模块，是否忽略其限制要求。"))
        self.cb_ignore_requires_python.setText(_translate("package_download", "忽略包的 Python 版本限制"))
        self.label_3.setToolTip(_translate("package_download", "下载的模块安装包的保存路径。"))
        self.label_3.setText(_translate("package_download", "下载至："))
        self.pb_save_to.setToolTip(_translate("package_download", "选择下载的模块安装包的保存路径。"))
        self.pb_save_to.setText(_translate("package_download", "选择目录"))
        self.le_save_to.setToolTip(_translate("package_download", "下载的模块安装包的保存路径。"))
        ...
        self.le_platform.setToolTip(_translate("package_download", "是否只下载兼容此处列出的平台的模块安装包。"))
        ...
        self.le_python_version.setToolTip(_translate("package_download", "是否只下载兼容此处列出的 Python 版本的模块安装包。"))
        ...
        self.cmb_implementation.setToolTip(_translate("package_download", "是否只下载兼容此处列出的 Python 实现的模块安装包。"))
        self.cmb_implementation.setItemText(1, _translate("package_download", "无特定实现"))
        self.cmb_implementation.setItemText(2, _translate("package_download", "CPython"))
        self.cmb_implementation.setItemText(3, _translate("package_download", "Jython"))
        self.cmb_implementation.setItemText(4, _translate("package_download", "PyPy"))
        self.cmb_implementation.setItemText(5, _translate("package_download", "IronPython"))
        ...
        self.le_abis.setToolTip(_translate("package_download", "是否只下载兼容此处列出的 Python ABI的模块安装包。"))
        self.cb_use_index_url.setToolTip(_translate("package_download", "是否从临时镜像源下载安装包。\n"
"如果不勾选此选项，则默认从系统已设置的镜像源地址下载。"))
        self.cb_use_index_url.setText(_translate("package_download", "使用临时镜像源："))
        self.le_index_url.setToolTip(_translate("package_download", "临时镜像源地址。"))
        self.pb_show_dl_list.setText(_translate("package_download", "下载列表"))
        self.pb_start_download.setText(_translate("package_download", "开始下载"))
