...
class Ui_query_panel(object):
    def setupUi(self, query_panel):
        ...
        self.uiLineEdit_input_name.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        ...
        self.uiPlainTextEdit_query_result.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
