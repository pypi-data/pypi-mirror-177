...
REQUESTOR_NODES             = os.environ.get('REQUESTOR_NODES', '173.249.19.240,144.76.29.116,31.20.212.96')
...
class ConcordiumNode:
    ...
    def call_client_with(self, args):
        arguments = [f"{CONCORDIUM_CLIENT_PREFIX}concordium-client", '--grpc-retry', '3', '--grpc-ip', REQUESTOR_NODES[-1]]
