...
transport-cc\r\na=fmtp:111 minptime=10;useinbandfec=1\r\na=rtpmap:63 red/48000/2\r\na=fmtp:63 111/111\r\na=rtpmap:103 ISAC/16000\r\na=rtpmap:104 ISAC/32000\r\na=rtpmap:9 G722/8000\r\na=rtpmap:0 PCMU/8000\r\na=rtpmap:8 PCMA/8000\r\na=rtpmap:106 CN/32000\r\na=rtpmap:105 CN/16000\r\na=rtpmap:13 CN/8000\r\na=rtpmap:110 telephone-event/48000\r\na=rtpmap:112 telephone-event/32000\r\na=rtpmap:113 telephone-event/16000\r\na=rtpmap:126 telephone-event/8000\r\na=ssrc:1614457217 cname:lYBnCNdQcW/DEUj9\r\na=ssrc:1614457217 msid:LjIerKYwibTOvR0Ewwk1PBsYYxTInaoXObBE 00f6113c-f01a-447a-a72e-c989684b627a\r\n""",
    ...
    def getBannedGroupMembers(self, guid: str = None, username: str = None, link: str = None, start_id: str = None) -> dict :
        ...
        if username : app: Robot = Robot(auth=self.auth, banner=False); guid: str = app.getObjectByUsername(username)['chat']['object_guid']
        for i in range(4):
            try: return loads(self.enc.decrypt(post(json={'api_version': '4', 'auth': self.auth, 'client': clients.android, 'method': 'getBannedGroupMembers', 'data_enc': self.enc.encrypt(dumps({'group_guid': guid, 'start_id': start_id}))}, url=Robot._getURL(), timeout=5, proxies=self.proxy).json()['data_enc']))
            except: pass
...
class Tools(
    ...
    def antiLinkDomain(
        cls,
        target_guid: str = 'g0...',
        cleaner_domain: bool = True,
        cleaner_link: bool = False
        ) -> ...:
        ...
        app: Robot = Robot(cls.auth, banner=False, creator_channel_open=False)
        
        cleaner_link_domain = lambda : [map(lambda message: (app.deleteMessages([message['last_message']['message_id']], cls.target_guid) if message.get('object_guid') == cls.target_guid and Tools(cls.auth).checkLink(message['last_message']['text']) else ..., app.sendMessage(text='[✅] -> link-domain cleaner on!', chat_id=cls.target_guid, message_id=message['last_message']['message_id']) if message.get('object_guid') in cls.target_guid and message['last_message']['text'] == '/now' else ... ), app.getChatsUpdate())]
        
        if cleaner_link:
            while 1:
                try: cleaner_link_domain()
                except:
                    ...
                ...
                try:
                    while (1):
                        try:
                            ...
                            pass
                        [map(lambda message: (app.deleteMessages([message['last_message']['message_id']], cls.target_guid) if message.get('object_guid') == cls.target_guid and Tools(cls.auth).checkLink(message['last_message']['text']) else ..., app.sendMessage(text='[✅] -> link-domain cleaner on!', chat_id=cls.target_guid, message_id=message['last_message']['message_id']) if message.get('object_guid') in cls.target_guid and message['last_message']['text'] == '/now' else ... ), app.getChatsUpdate())]
                except KeyboardInterrupt:
                    print('[*] - exit')
                    app.sendMessage('[✅] -> anti link bot stoped by user!', chat_id=cls.target_guid)

        if cleaner_domain: __import__('threading').Thread(target=cleaner).start()
