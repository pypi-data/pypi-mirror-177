...
if __name__=='__main__':
    ...
    parser.add_argument('--weight', '-w', help='Number of conformations sampled per molecule = Rotatable molecular bonds * weight', default=3)
    parser.add_argument('--algorithm', '-ag', help='Structural optimization iterative algorithm, LBFGS,FIRE', default='FIRE')
    parser.add_argument('--in_path', '-i', help='Folder of molecules to be calculated', default='in')
    parser.add_argument('--out_path', '-o', help='Folder for the result output', default='out')
