...
class CreateDataPrivacyDeletionJob4XXResponseErrorsInnerSource(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CreateDataPrivacyDeletionJob4XXResponseErrorsInnerSource - a model defined in OpenAPI
