...
class CampaignCreateQueryAsSubResourceAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, channel, audiences, send_options, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, channel, audiences, send_options, *args, **kwargs):  # noqa: E501
        """CampaignCreateQueryAsSubResourceAttributes - a model defined in OpenAPI
