...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'klaviyo-api-python-beta/1.0.0'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DataPrivacyApi()
        api_instance.create_data_privacy_deletion_job  # this is an instance of the class Endpoint
        api_instance.create_data_privacy_deletion_job()  # this invokes api_instance.create_data_privacy_deletion_job.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_data_privacy_deletion_job.callable or self.callable in this class
