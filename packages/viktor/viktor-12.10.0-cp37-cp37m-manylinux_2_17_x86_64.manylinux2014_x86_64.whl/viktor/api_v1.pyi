...
class _ResolvedEntity:
    ...
    @classmethod
    def from_json(cls, response_json: dict) -> _ResolvedEntity: ...
    @property
...
class Entity:
    ...
    def create_child(self, entity_type_name: str, name: str, *, params: Union[dict, Munch] = ..., privileged: bool = ...) -> Entity: ...
    def revisions(self) -> List[EntityRevision]: ...
...
class _API:
    ...
    def create_child_entity(self, parent_entity_id: int, entity_type_name: str, name: str, *, params: Union[dict, Munch] = ..., privileged: bool = ...) -> Entity: ...
    def get_entity_revisions(self, entity_id: int, *, privileged: bool = ...) -> List[EntityRevision]: ...
