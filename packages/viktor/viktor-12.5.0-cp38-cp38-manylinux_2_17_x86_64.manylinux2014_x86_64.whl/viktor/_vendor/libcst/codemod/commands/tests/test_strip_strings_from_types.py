...
class TestStripStringsCodemod(CodemodTest):
    ...
    def test_literal(self) -> None:
        before = """
            from viktor._vendor.typing_extensions import Literal
    ...
    def test_literal_alias(self) -> None:
        before = """
            from viktor._vendor.typing_extensions import Literal as Lit
    ...
    def test_literal_object_alias(self) -> None:
        before = """
            import viktor._vendor.typing_extensions as typext
