...
class _EntitySelectField(Field, ABC, metaclass=abc.ABCMeta):
    @abstractmethod
    def __init__(self, type_: str, ui_name: str, name: str=..., visible: VisibleType=..., flex: int=..., *, entity_type_names: List[str]=..., description: str=...) -> Any: ...
...
class _GeoField(Field, metaclass=abc.ABCMeta):
    @abstractmethod
    def __init__(self, type_: str, ui_name: str, *, name: str=..., default: Union[GeoPoint, GeoPolyline, GeoPolygon, List[GeoPoint], List[GeoPolyline], List[GeoPolygon]]=..., visible: VisibleType=..., description: str=...) -> Any: ...
...
class _GeoMultiField(_GeoField, metaclass=abc.ABCMeta):
    @abstractmethod
    def __init__(self, type_: str, ui_name: str, *, name: str=..., default: Union[List[GeoPoint], List[GeoPolyline], List[GeoPolygon]]=..., visible: VisibleType=..., description: str=...) -> Any: ...
