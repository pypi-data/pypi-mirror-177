...
from typing import Any, Callable, Dict, Iterator, List, Sequence, Type, Union
...
def mock_SciaAnalysis(get_engineering_report: Union[Sequence[Union[BytesIO, File]], Union[BytesIO, File]] = ..., get_updated_esa_model: Union[Sequence[Union[BytesIO, File]], Union[BytesIO, File]] = ..., get_xml_output_file: Union[Sequence[Union[BytesIO, File]], Union[BytesIO, File]] = ...) -> Callable: ...
