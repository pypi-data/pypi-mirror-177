...
class IdeaRcsAnalysis(ExternalProgram):
    input_file: Any = ...
    def __init__(self, input_file: BytesIO, *, return_result_xml: bool=..., return_rcs_file: bool=...) -> None: ...
...
class _Model:
    ...
    def generate_xml_input(self) -> BytesIO: ...
...
class OpenModel(_Model):
    ...
    def add_member_data_ec2(self, member: CheckMember, member_type: MemberType, two_way_slab_type: TwoWaySlabType, *, calculation_setup: CalculationSetup=..., coeff_kx_for_wmax: float=..., exposure_class_data: ExposureClassesDataEc2=..., creep_coefficient: float=...) -> None: ...
...
class _GeneralSection(SectionPrototype1D):
...
class _SectionPrototype2D(_SectionPrototype, ABC, metaclass=abc.ABCMeta):
    @abstractmethod
    def __init__(self, thickness: float) -> Any: ...
...
class Model(_Model):
    ...
    def create_beam(self, cs: SectionPrototype1D, material: MatConcrete, *, calculation_control: CalculationSetup=..., name: str=..., rcs_name: str=..., exposure_classes: ExposureClassesDataEc2=..., coeff_kx: float=..., creep_coefficient: float=...) -> Beam: ...
    def create_compression_member(self, cs: SectionPrototype1D, material: MatConcrete, *, calculation_control: CalculationSetup=..., name: str=..., rcs_name: str=..., exposure_classes: ExposureClassesDataEc2=..., coeff_kx: float=..., creep_coefficient: float=...) -> CompressionMember: ...
    def create_one_way_slab(self, cs: SectionPrototype1D, material: MatConcrete, *, calculation_control: CalculationSetup=..., name: str=..., rcs_name: str=..., exposure_classes: ExposureClassesDataEc2=..., coeff_kx: float=..., creep_coefficient: float=...) -> OneWaySlab: ...
...
class RcsOutputFileParser:
    ...
    class SectionResult:
        ...
        @property
        def id_(self) -> int: ...
        def capacity(self) -> List[Optional[Dict[str, Any]]]: ...
        def shear(self) -> List[Optional[Dict[str, Any]]]: ...
        def crack_width(self) -> List[Optional[Dict[str, Optional[Dict[str, Any]]]]]: ...
        def detailing(self) -> List[Optional[Dict[str, Optional[float]]]]: ...
        def stress_limitation(self) -> List[Optional[Dict[str, Optional[float]]]]: ...
