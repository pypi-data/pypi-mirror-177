...
if NEW_TYPING:
    ...
    from viktor._vendor.typing_extensions import Final, Literal
    ...
    try:  # python 3.6
        from viktor._vendor.typing_extensions import _Final
    ...
    try:  # python 3.6
        from viktor._vendor.typing_extensions import _Literal
    except ImportError:  # python 2.7
        try:
