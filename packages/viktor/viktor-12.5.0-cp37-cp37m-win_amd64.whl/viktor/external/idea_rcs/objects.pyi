...
class CheckSectionExtreme(_OpenObject, metaclass=abc.ABCMeta):
    @abstractmethod
    def __init__(self, accidental: LoadingULS=..., fatigue: FatigueLoading=..., frequent: LoadingSLS=..., fundamental: LoadingULS=..., characteristic: LoadingSLS=..., quasi_permanent: LoadingSLS=...) -> Any: ...
