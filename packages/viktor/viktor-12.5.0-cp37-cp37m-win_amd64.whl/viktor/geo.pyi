...
class GEFFile:
    ...
    @classmethod
    def from_file(cls: Any, file_path: Union[str, bytes, os.PathLike], encoding: str=...) -> GEFFile: ...
    def parse(self, additional_columns: List[str]=..., verbose: bool=..., return_gef_data_obj: bool=...) -> Union[dict, GEFData]: ...

def gef_visualization(gef_data: GEFData, soil_layout_original: SoilLayout, soil_layout_user: SoilLayout) -> str: ...
...
class Soil:
    ...
    @classmethod
    def from_dict(cls: Any, d: Union[dict, Munch]) -> Soil: ...
...
class PiezoLine(Polyline):
    ...
    def serialize(self) -> dict: ...
    @classmethod
    def from_dict(cls: Any, piezo_line_dict: Union[dict, Munch]) -> PiezoLine: ...
    @classmethod
    def from_lines(cls: Any, lines: List[Union[Line, Polyline]], phreatic: bool=...) -> PiezoLine: ...
...
class SoilLayer:
    ...
    @classmethod
    def from_dict(cls: Any, soil_layer_dict: Union[dict, Munch]) -> SoilLayer: ...
    @property
...
class SoilLayer2D:
    ...
    def serialize(self) -> dict: ...
    @classmethod
    def from_dict(cls: Any, soil_layer_dict: Union[dict, Munch]) -> SoilLayer2D: ...
    @property
    ...
    def threejs_visualisation(self, visualize_border: bool=..., opacity: float=..., material: Material=...) -> Tuple[Group, List[Label]]: ...
...
class SoilLayout:
    ...
    @classmethod
    def from_dict(cls: Any, soil_layout_dict: Union[Dict[str, List], Munch]) -> SoilLayout: ...
...
class PositionalSoilLayout(SoilLayout):
    ...
    @classmethod
    def from_dict(cls: Any, positional_soil_layout_dict: Union[dict, Munch]) -> PositionalSoilLayout: ...
    def serialize(self) -> dict: ...
...
class SoilLayout2D:
    ...
    @classmethod
    def from_positional_soil_layouts(cls: Any, positional_soil_layouts: List[PositionalSoilLayout], top_profile: Polyline, piezo_lines: List[PiezoLine]=...) -> SoilLayout2D: ...
    @classmethod
    def from_single_soil_layout(cls: Any, soil_layout: SoilLayout, left_boundary: float, right_boundary: float, top_profile: Polyline, piezo_lines: List[PiezoLine]=...) -> SoilLayout2D: ...
    @classmethod
    def combine_soil_layouts_2d(cls: Any, *soil_layouts_2d: SoilLayout2D) -> SoilLayout2D: ...
    @classmethod
    def from_dict(cls: Any, soil_layout_2d_dict: Union[dict, Munch]) -> SoilLayout2D: ...
    def serialize(self) -> dict: ...
    @property
    ...
    def threejs_visualisation(self, visualize_border: bool=..., opacity: float=...) -> Tuple[Group, List[Label]]: ...
