...
class CodeSettings(_OpenObject):
    ...
    def __init__(self, *, evaluation_interaction_diagram: EvaluationInteractionDiagram=..., no_resistance_concrete_tension_1d: NoResistanceConcreteTension1d=..., type_sls_calculation: TypeSLSCalculation=...) -> None: ...

class CheckMember(_OpenElementId, ABC, metaclass=abc.ABCMeta):
    @abstractmethod
    def __init__(self, id_: int) -> Any: ...
...
class _Material(_OpenElementId, ABC, metaclass=abc.ABCMeta):
    @abstractmethod
    def __init__(self, id_: int, name: str, e_modulus: float, g_modulus: float, poisson: float, unit_mass: float, specific_heat: float, thermal_expansion: float, thermal_conductivity: float, is_default: bool, order_in_code: int, thermal_state: ThermalState) -> Any: ...
...
class MatReinforcement(_Material, ABC, metaclass=abc.ABCMeta):
    @abstractmethod
    def __init__(self, id_: int, name: str, e_modulus: float, g_modulus: float, poisson: float, unit_mass: float, specific_heat: float, thermal_expansion: float, thermal_conductivity: float, is_default: bool, order_in_code: int, thermal_state: ThermalState, bar_surface: BarSurface) -> Any: ...
...
class CrossSection(_OpenElementId, ABC, metaclass=abc.ABCMeta):
    @abstractmethod
    def __init__(self, id_: int, name: str) -> Any: ...
...
class _FatigueLoading(_OpenObject):
...
class CheckSectionExtreme(_OpenObject, metaclass=abc.ABCMeta):
    @abstractmethod
    def __init__(self, accidental: Optional[LoadingULS]=..., fatigue: Optional[_FatigueLoading]=..., frequent: Optional[LoadingSLS]=..., fundamental: Optional[LoadingULS]=..., characteristic: Optional[LoadingSLS]=..., quasi_permanent: Optional[LoadingSLS]=...) -> Any: ...

class StandardCheckSectionExtreme(CheckSectionExtreme):
    def __init__(self, *, accidental: Optional[LoadingULS]=..., frequent: Optional[LoadingSLS]=..., fundamental: Optional[LoadingULS]=..., characteristic: Optional[LoadingSLS]=..., quasi_permanent: Optional[LoadingSLS]=...) -> None: ...

class CheckSection(_OpenElementId, ABC, metaclass=abc.ABCMeta):
    @abstractmethod
    def __init__(self, id_: int, description: str, check_member: _ReferenceElement, reinf_section: _ReferenceElement, extremes: List[CheckSectionExtreme]=...) -> Any: ...
    @property
    def extremes(self) -> List[CheckSectionExtreme]: ...
    def create_extreme(self, *, accidental: Optional[LoadingULS]=..., frequent: Optional[LoadingSLS]=..., fundamental: Optional[LoadingULS]=..., characteristic: Optional[LoadingSLS]=..., quasi_permanent: Optional[LoadingSLS]=...) -> None: ...
...
class ConcreteMemberData(_OpenObject, ABC, metaclass=abc.ABCMeta):
    @abstractmethod
    def __init__(self, element: _ReferenceElement, member_type: MemberType, two_way_slab_type: TwoWaySlabType, calculation_setup: CalculationSetup=...) -> Any: ...
...
class ExposureClassesDataEc2(_OpenObject):
    def __init__(self, *, carbonation: Optional[ExposureClassEc2Carbonation]=..., chlorides: Optional[ExposureClassEc2Chlorides]=..., chlorides_from_sea: Optional[ExposureClassEc2ChloridesFromSea]=..., freeze_attack: Optional[ExposureClassEc2FreezeAttack]=..., chemical_attack: Optional[ExposureClassEc2ChemicalAttack]=...) -> None: ...

class ConcreteMemberDataEc2(ConcreteMemberData):
    def __init__(self, element: _ReferenceElement, member_type: MemberType, two_way_slab_type: TwoWaySlabType, calculation_setup: CalculationSetup=..., coeff_kx_for_wmax: float=..., exposure_class_data: ExposureClassesDataEc2=..., creep_coefficient: float=...) -> None: ...
