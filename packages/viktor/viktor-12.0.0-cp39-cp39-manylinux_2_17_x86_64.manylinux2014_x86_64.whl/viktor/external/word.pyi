...
class WordFileComponent(ABC, metaclass=abc.ABCMeta):
    identifier: Any = ...
    @abstractmethod
    def __init__(self, identifier: str) -> Any: ...
...
class WordFileImage(WordFileComponent):
    ...
    @classmethod
    def from_path(cls: Any, file_path: Union[str, bytes, os.PathLike], identifier: str, width: int=..., height: int=...) -> WordFileImage: ...
...
class WordFileTemplate:
    ...
    @classmethod
    def from_path(cls: Any, file_path: Union[str, bytes, os.PathLike], components: List[WordFileComponent]) -> WordFileTemplate: ...
