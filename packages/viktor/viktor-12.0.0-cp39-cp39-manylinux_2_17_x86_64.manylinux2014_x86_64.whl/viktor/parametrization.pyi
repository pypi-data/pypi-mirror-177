...
class AnalyseButton(_ActionButton):
    def __init__(self, ui_name: str, method: str, longpoll: bool=..., require_all_fields: bool=..., visible: VisibleType=..., always_available: bool=..., flex: int=...) -> None: ...

class OptimiseButton(_ActionButton):
    def __init__(self, ui_name: str, method: str, longpoll: bool=..., require_all_fields: bool=..., visible: VisibleType=..., always_available: bool=..., flex: int=...) -> None: ...
...
class MultipleSelectField(_SelectField):
...
class TableInput(Field, _AttrGroup):
