...
from typing import Any, AnyStr, BinaryIO, Callable, IO, Iterable, List, Optional, Sequence, TextIO, Tuple, Type, Union
from viktor.parametrization import Parametrization as Parametrization
from viktor.views import Summary as Summary
...
class _OrderedClass(type):
    ...
    def __new__(cls, name: Any, bases: Any, classdict: Any): ...
...
class _ResponseStream:
    def __init__(self, writable_stream: IO, url: str, binary_mode: bool, encoding: str=...) -> None: ...
    def close(self) -> None: ...
...
class File:
    ...
    def __init__(self, *, data: Union[str, bytes]=..., path: Union[str, bytes, os.PathLike]=..., url: str=...) -> None: ...
    @classmethod
    def from_data(cls: Any, data: Union[str, bytes]) -> File: ...
    @classmethod
    def from_path(cls: Any, path: Union[str, bytes, os.PathLike]) -> File: ...
    @classmethod
    def from_url(cls: Any, url: str) -> File: ...
    @property
    def source(self) -> Optional[str]: ...
    @property
...
class Color:
    def __new__(cls: Any, r: int, g: int, b: int) -> Color: ...
    ...
    @classmethod
    def from_hex(cls: Any, hex_value: str) -> Color: ...
    @classmethod
    def from_deltares(cls: Any, value: int) -> Color: ...
    @staticmethod
    def random() -> Color: ...
    @property
