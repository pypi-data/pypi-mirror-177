...
class AxisVMAnalysis(ExternalProgram):
    def __init__(self, model: Model, *, return_results: bool=..., return_model: bool=..., report_template: BytesIO=...) -> None: ...
    def get_results(self) -> dict: ...
    def get_model_file(self) -> Optional[BytesIO]: ...
    def get_result_file(self) -> Optional[BytesIO]: ...
...
class _Point3D:
    ...
    @classmethod
    def from_tuple(cls: Any, xyz: Tuple[float, float, float]) -> _Point3D: ...
