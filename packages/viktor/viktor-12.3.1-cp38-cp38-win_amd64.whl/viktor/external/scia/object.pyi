...
class CrossSection(_SciaObject, ABC, metaclass=abc.ABCMeta):
    material: Any = ...
    @abstractmethod
    def __init__(self, object_id: int, name: str, material: Material) -> Any: ...
...
class ComposedCrossSection(CrossSection, ABC, metaclass=abc.ABCMeta):
    material_2: Any = ...
    @abstractmethod
    def __init__(self, object_id: int, name: str, material: Material, material_2: Material) -> Any: ...
...
class LoadCase(ABC, _SciaObject, metaclass=abc.ABCMeta):
    ...
    action_type: Any = ...
    @abstractmethod
    def __init__(self, object_id: int, name: str, description: str, action_type: ActionType, load_group: LoadGroup) -> Any: ...
    @property
...
class ResultClass(_SciaObject):
    def __init__(self, object_id: int, name: str, combinations: List[LoadCombination]) -> None: ...
    @property
...
class FreeLoad(_SciaObject, ABC, metaclass=abc.ABCMeta):
    ...
    direction: Any = ...
    @abstractmethod
    def __init__(self, object_id: int, name: str, load_case: LoadCase, direction: Direction, select: Select, validity: Validity=..., load_type: Type=..., c_sys: CSys=...) -> Any: ...
    @property
...
class PointLoad(_SciaObject):
    ...
    ey: Any = ...
    ez: Any = ...
    def __init__(self, object_id: int, name: str, load_case: LoadCase, beam: Beam, direction: Direction, load_type: Type, load_value: float, c_sys: CSys, c_def: CDef, position_x: float, origin: Origin, repeat: int, ey: float, ez: float) -> None: ...
    @property
    def beam(self) -> Beam: ...
    @property
    def load_case(self) -> LoadCase: ...
