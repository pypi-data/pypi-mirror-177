...
class Field(ABC, metaclass=abc.ABCMeta):
    def __init__(self, ui_name: str, *, name: str=..., prefix: str=..., suffix: str=..., default: Any=..., flex: int=..., visible: VisibleType=...) -> None: ...
    @property
...
class _SelectField(Field, ABC, metaclass=abc.ABCMeta):
    def __init__(self, ui_name: str, name: Optional[str], prefix: Optional[str], suffix: Optional[str], options: Union[List[Union[float, str, OptionListElement]], Callable], default: Optional[Union[List[Union[float, str]], float, str]], flex: Optional[int], visible: VisibleType, *, multiple: bool=...) -> None: ...

class OptionField(_SelectField):
    def __init__(self, ui_name: str, options: Union[List[Union[float, str, OptionListElement]], Callable], name: str=..., prefix: str=..., suffix: str=..., default: Union[float, str]=..., visible: VisibleType=..., flex: int=...) -> None: ...

class MultiSelectField(_SelectField):
    def __init__(self, ui_name: str, options: Union[List[Union[float, str, OptionListElement]], Callable], name: str=..., prefix: str=..., suffix: str=..., default: List[Union[float, str]]=..., visible: VisibleType=..., flex: int=...) -> None: ...
