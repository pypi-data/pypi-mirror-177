...
class SpreadsheetCalculation:
    def __init__(self, file: BytesIO, inputs: List[SpreadsheetCalculationInput]) -> None: ...
    @classmethod
    def from_path(cls: Any, file_path: Union[str, bytes, os.PathLike], inputs: List[SpreadsheetCalculationInput]) -> SpreadsheetCalculation: ...
...
class SpreadsheetTemplate:
    ...
    @classmethod
    def from_path(cls: Any, file_path: Union[str, bytes, os.PathLike], input_cells: List[Union[DirectInputCell, NamedInputCell, InputCellRange]]) -> SpreadsheetTemplate: ...
