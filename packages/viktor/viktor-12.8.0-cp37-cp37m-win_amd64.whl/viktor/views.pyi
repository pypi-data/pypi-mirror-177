...
from .geometry import GeoPoint as GeoPoint, GeoPolygon as GeoPolygon, GeoPolyline as GeoPolyline, Group as Group, Point as Point
...
class _GeometrySubResult(_SubResult):
    def __init__(self, visualization_group: Group, labels: List[Label] = ...) -> None: ...
...
class GeometryAndDataResult(_ViewResult):
    def __init__(self, visualization_group: Group, data: DataGroup, labels: List[Label] = ...) -> None: ...
