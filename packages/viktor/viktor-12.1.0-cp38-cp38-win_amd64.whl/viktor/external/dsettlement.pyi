...
from viktor import Color as Color
...
class DSettlementAnalysis(ExternalProgram):
    ...
    def get_sld_file(self) -> StringIO: ...
...
class _Model(metaclass=ABCMeta):
    ...
    def generate_input_file(self, metadata: Metadata=..., *, dissipation_calculation: _Vertical=...) -> BytesIO: ...
