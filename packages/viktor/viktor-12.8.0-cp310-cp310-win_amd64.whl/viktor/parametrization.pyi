import abc
import datetime
from .api_v1 import API as API, Entity as Entity
...
class NumberField(Field):
    ...
    def __init__(self, ui_name: str, name: str = ..., prefix: str = ..., *, suffix: str = ..., default: float = ..., step: float = ..., min: MinMaxType = ..., max: MinMaxType = ..., min_message: str = ..., max_message: str = ..., num_decimals: int = ..., visible: VisibleType = ..., flex: int = ..., variant: Union[str, Variant] = ..., description: str = ...) -> None: ...
...
class OptionField(_SelectField):
    def __init__(self, ui_name: str, options: Union[List[Union[float, str, OptionListElement]], Callable], name: str = ..., prefix: str = ..., suffix: str = ..., default: Union[float, str] = ..., visible: VisibleType = ..., flex: int = ..., *, description: str = ..., variant: str = ...) -> None: ...
