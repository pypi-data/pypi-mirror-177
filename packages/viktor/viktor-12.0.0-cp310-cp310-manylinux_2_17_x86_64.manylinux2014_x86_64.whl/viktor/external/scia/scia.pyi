...
from ...errors import ExecutionError as ExecutionError, InternalError as InternalError, LicenseError as LicenseError
from ...geometry import Vector as Vector
from ..external_program import ExternalProgram as ExternalProgram
from .object import ArbitraryProfile as ArbitraryProfile, ArbitraryProfileSpan as ArbitraryProfileSpan, Beam as Beam, CircularComposedCrossSection as CircularComposedCrossSection, CircularCrossSection as CircularCrossSection, CircularHollowCrossSection as CircularHollowCrossSection, Concrete as Concrete, CrossSection as CrossSection, FreeLineLoad as FreeLineLoad, FreePointLoad as FreePointLoad, FreeSurfaceLoad as FreeSurfaceLoad, HingeOnBeam as HingeOnBeam, HingeOnPlane as HingeOnPlane, IntegrationStrip as IntegrationStrip, InternalEdge as InternalEdge, Layer as Layer, LineForceSurface as LineForceSurface, LineLoad as LineLoad, LineMomentOnBeam as LineMomentOnBeam, LineMomentOnPlane as LineMomentOnPlane, LineSupportLine as LineSupportLine, LineSupportSurface as LineSupportSurface, LoadCase as LoadCase, LoadCombination as LoadCombination, LoadGroup as LoadGroup, Material as Material, MeshSetup as MeshSetup, Node as Node, NonLinearFunction as NonLinearFunction, NonLinearLoadCombination as NonLinearLoadCombination, OpenSlab as OpenSlab, Orthotropy as Orthotropy, PermanentLoadCase as PermanentLoadCase, Plane as Plane, PointLoad as PointLoad, PointMomentNode as PointMomentNode, PointSupport as PointSupport, PointSupportLine as PointSupportLine, RectangularCrossSection as RectangularCrossSection, ResultClass as ResultClass, RigidArm as RigidArm, SectionOnBeam as SectionOnBeam, SectionOnPlane as SectionOnPlane, Subsoil as Subsoil, SurfaceLoad as SurfaceLoad, SurfaceSupportSurface as SurfaceSupportSurface, ThermalLoad as ThermalLoad, ThermalSurfaceLoad as ThermalSurfaceLoad, VariableLoadCase as VariableLoadCase
...
class Model:
    def __init__(self, *, mesh_setup: MeshSetup=...) -> None: ...
    @property
    ...
    def create_result_class(self, name: str, combinations: List[LoadCombination]) -> ResultClass: ...
    def create_point_load(self, name: str, load_case: LoadCase, beam: Beam, direction: PointLoad.Direction, load_type: PointLoad.Type, load_value: float, c_sys: PointLoad.CSys, c_def: PointLoad.CDef, position_x: float, origin: PointLoad.Origin, repeat: int, ey: float, ez: float) -> PointLoad: ...
...
class OutputFileParser:
    @classmethod
    def get_result(cls: Any, file: BinaryIO, table_name: str, *, parent: str=...) -> Dict[str, dict]: ...
