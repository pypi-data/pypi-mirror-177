...
class DataGroup(OrderedDict):
    ...
    @classmethod
    def from_data_groups(cls: Any, groups: List[DataGroup]) -> DataGroup: ...
...
class MapPoint(MapFeature):
    ...
    @classmethod
    def from_geo_point(cls: Any, point: GeoPoint, **kwargs: Any) -> MapPoint: ...
    @property
    def lat(self) -> float: ...
    @property
    def lon(self) -> float: ...
...
class MapPolyline(MapFeature):
    ...
    @classmethod
    def from_geo_polyline(cls: Any, polyline: GeoPolyline, **kwargs: Any) -> MapPolyline: ...
    @property
...
class MapPolygon(MapFeature):
    ...
    @classmethod
    def from_geo_polygon(cls: Any, polygon: GeoPolygon, **kwargs: Any) -> MapPolygon: ...
...
class PNGResult(_ImageResult):
    ...
    @classmethod
    def from_path(cls: Any, file_path: Union[str, bytes, os.PathLike]) -> PNGResult: ...
...
class JPGResult(_ImageResult):
    def __init__(self, image: BytesIO) -> None: ...
    @classmethod
    def from_path(cls: Any, file_path: Union[str, bytes, os.PathLike]) -> JPGResult: ...
...
class SVGResult(_ImageResult):
    ...
    @classmethod
    def from_path(cls: Any, file_path: Union[str, bytes, os.PathLike]) -> SVGResult: ...
...
class WebResult(_ViewResult):
    def __init__(self, *, html: StringIO=..., url: str=...) -> None: ...
    @classmethod
    def from_path(cls: Any, file_path: Union[str, bytes, os.PathLike]) -> WebResult: ...
...
class PDFResult(_ViewResult):
    def __init__(self, *, file: File=..., url: str=...) -> None: ...
    @classmethod
    def from_path(cls: Any, file_path: Union[str, bytes, os.PathLike]) -> PDFResult: ...
...
class View(ABC, metaclass=abc.ABCMeta):
    def __init__(self, label: str, duration_guess: int, *, description: str=..., **kwargs: Any) -> None: ...
...
class GeometryView(View):
    result_type: Any = ...
    def __init__(self, label: str, duration_guess: int, *, description: str=..., view_mode: str=..., default_shadow: bool=...) -> None: ...
