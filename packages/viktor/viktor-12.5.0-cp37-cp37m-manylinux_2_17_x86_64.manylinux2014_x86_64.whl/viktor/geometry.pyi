...
class TransformableObject(ABC, metaclass=abc.ABCMeta):
    ...
    def translate(self, translation_vector: Union[Vector, Tuple[float, float, float]]) -> Any: ...
    def rotate(self, angle: float, direction: Union[Vector, Tuple[float, float, float]], point: Union[Point, Tuple[float, float, float]]=...) -> Any: ...
    def mirror(self, point: Union[Point, Tuple[float, float, float]], normal: Union[Vector, Tuple[float, float, float]]) -> Any: ...
    def scale(self, scaling_vector: Union[Vector, Tuple[float, float, float]]) -> Any: ...
...
class _Threejs:
    ...
    @staticmethod
    def geometry_object(name: Any, matrix: Any, geometry_uuid: Any, material_uuid: Any): ...
    @staticmethod
