...
export class EnergyConsumptionConfigView {
    ...
    constructor(structuralElement, dashboardConfig, definedEnergySources, availableEnergySources, energyUses, tsSelector, isEditable) {
    ...
    #initEventListeners() {
            ...
            if (configIdElmt.value == "") {
                ...
                this.#postReqID = this.#internalAPIRequester.post(
                    ...
                    (data) => {
                        ...
                        let btnDeleteConfigElmt = document.getElementById(`btnDelConfig-${this.#editedEnergySourceInputElmt.value}-${this.#editedEnergyUseInputElmt.value}`);
                ...
                this.#putReqID = this.#internalAPIRequester.put(
                    flaskES6.urlFor(`api.dashboards.energy_consumption.update`, {id: configIdElmt.value}),
                    payload,
                    etagElmt.value,
                    (data) => {
                        let configIdElmt = document.getElementById(`configId-${this.#editedEnergySourceInputElmt.value}-${this.#editedEnergyUseInputElmt.value}`);
        ...
        this.#selectTimeseriesModalElmt.addEventListener("show.bs.modal", (event) => {
            ...
            //     this.#tsSelector.select(tsIdInputElmt.value);
            // }
