...
class TransactionHelper:
    ...
    abi = json.loads(pkg_resources.read_text(__package__, 'abi/erc20.json'))['result']
...
class OneInchOracle:
    ...
    oracle_abi = json.loads(pkg_resources.read_text(__package__, 'abi/oracle.json'))['result']
