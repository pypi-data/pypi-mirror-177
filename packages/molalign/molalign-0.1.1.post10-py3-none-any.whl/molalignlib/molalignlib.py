...
try:
    ...
    with Popen(['./link_library_python.sh'], cwd=moduledir, stdout=PIPE, stderr=STDOUT, bufsize=0) as p:
        for line in p.stdout:
            print(line.decode('utf-8').rstrip())
