...
def play(
    ...
    **kwargs,
    ...
    :param timestamp_label: (Supported from QOP 2.1) Adding a `timestamp` argument will save the time at which
...
def measure(
    ...
    *outputs,
    ...
    :param timestamp_label:
        (Supported from QOP 2.1) Adding a `timestamp` argument will save the time at which
        the operation occurred to the result handle under this name. You can receive the
