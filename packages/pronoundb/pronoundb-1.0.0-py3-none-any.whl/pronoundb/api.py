...
async def lookup(platform: Platform, identifiers: str | int | list[str] | list[int]) -> dict[str, list[str]] | dict[int, list[str]]:
    """
...
async def _lookup_single(platform: Platform, identifier: str | int) -> dict[str, list[str]] | dict[int, list[str]]:
    """
...
async def _lookup_bulk(platform: Platform, identifiers: list[str] | list[int]) -> dict[str, list[str]] | dict[int, list[str]]:
    """
