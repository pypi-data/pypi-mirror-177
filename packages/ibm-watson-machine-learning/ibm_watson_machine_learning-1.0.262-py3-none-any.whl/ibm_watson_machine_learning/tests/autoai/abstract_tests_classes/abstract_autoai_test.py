...
class AbstractTestAutoAIAsync(abc.ABC):
    ...
    def test_01_initialize_AutoAI_experiment__pass_credentials__object_initialized(self):
        ...
        AbstractTestAutoAIAsync.batched = 'include_batched_ensemble_estimators' not in self.experiment_info or \
                                          self.experiment_info['include_batched_ensemble_estimators']
