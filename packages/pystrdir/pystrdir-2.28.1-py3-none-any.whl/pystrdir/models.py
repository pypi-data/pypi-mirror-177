...
This module contains the primary objects that power pystrdir.
"""
...
# such as in Embedded Python. See https://github.com/psf/pystrdir/issues/3578.
...
from .exceptions import JSONDecodeError as pystrdirJSONDecodeError
from .exceptions import MissingSchema
from .exceptions import SSLError as pystrdirSSLError
...
class Request(RequestHooksMixin):
    ...
    Usage::
      ...
      >>> import pystrdir
      >>> req = pystrdir.Request('GET', 'https://httpbin.org/get')
      >>> req.prepare()
      <PreparedRequest [GET]>
    """
...
class PreparedRequest(RequestEncodingMixin, RequestHooksMixin):
    ...
    def prepare_url(self, url, params):
        ...
        #: on python 3.x.
        #: https://github.com/psf/pystrdir/pull/2238
...
class Response:
    ...
    def __init__(self):
        ...
        #: This requirement does not apply for use internally to pystrdir.
        self.raw = None
    ...
    def json(self, **kwargs):
        ...
        :raises pystrdir.exceptions.JSONDecodeError: If the response body does not
            contain valid json.
        """
        ...
        if not self.encoding and self.content and len(self.content) > 3:
            ...
            if encoding is not None:
                try:
                    ...
                    raise pystrdirJSONDecodeError(e.msg, e.doc, e.pos)

        try:
            return complexjson.loads(self.text, **kwargs)
        except JSONDecodeError as e:
            # Catch JSON-related errors and raise as pystrdir.JSONDecodeError
