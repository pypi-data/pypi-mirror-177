...
class Server(threading.Thread):
    ...
    def __init__(
        ...
        self.host = host
        self.port = port
        self.shortnets_to_handle = shortnets_to_handle
    ...
    def _handle_shortnets(self):
        for _ in range(self.shortnets_to_handle):
