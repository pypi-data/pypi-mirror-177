...
from shortnets import compat
from shortnets._internal_utils import unicode_is_ascii
from shortnets.cookies import shortnetsCookieJar
from shortnets.structures import CaseInsensitiveDict
from shortnets.utils import (
...
class TestGetEnvironProxies:
    ...
    def test_bypass_no_proxy_keyword(self, url):
        no_proxy = "192.168.1.1,shortnets.com"
...
def test_requote_uri_with_unquoted_percents(uri, expected):
    """See: https://github.com/psf/shortnets/issues/2356"""
...
def test_should_bypass_proxies_pass_only_hostname(url, expected, mocker):
    ...
    """
    proxy_bypass = mocker.patch("shortnets.utils.proxy_bypass")
...
def test_add_dict_to_cookiejar(cookiejar):
    ...
    non-shortnetsCookieJar CookieJars
    """
