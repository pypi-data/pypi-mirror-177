...
CN_DEFAULT_PARAMS = {
    "SHARD_DB_COUNT_EACH_STORAGE_INST": "4",
    "TRANSACTION_POLICY": "XA",
    "CONN_POOL_MAX_POOL_SIZE": "500",
    "simply_tables": "bmsql_item",
    "max_prepared_stmt_count": "500000",
    "ENABLE_DEADLOCK_DETECTION": "false",
    "CDC_STARTUP_MODE": "0",
    "ENABLE_RANDOM_PHY_TABLE_NAME": "false"
}
    ...
    def _start_cn_container(self, cn):
        try:
            ...
            if self.dn_engine == 'xcluster':
                entrypoint = 'bash -c "echo \'\' > /home/admin/drds-worker/bin/globalSchedule.sh ' \
                             '&& /home/admin/basic_init/init.sh /home/admin/app.sh"'
...
class PolarDBXCN:
    ...
    def generate_envs(self, password_key, engine_type="galaxy"):
        ...
        envs = ['POD_ID=' + str(self.container_id),
                ...
                'metaDbXprotoPort=' + ('-1' if Config.instance().host_arm_arch() else '0'),
                'storageDbXprotoPort=' + ('-1' if Config.instance().host_arm_arch() else '0'),
