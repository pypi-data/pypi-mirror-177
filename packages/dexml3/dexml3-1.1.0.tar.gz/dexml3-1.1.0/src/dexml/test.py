...
class TestDexml(unittest.TestCase):
    ...
    def test_unicode_model_tagname(self):
        ...
        self.assertRaises(dexml.ParseError,hello.parse,"<Hello />")
        self.assertRaises(dexml.ParseError,hello.parse,"<hllo />")
        self.assertRaises(dexml.ParseError,hello.parse,"<Hel\N{GREEK SMALL LETTER LAMDA}o />")

        h = hello.parse("<hel\N{GREEK SMALL LETTER LAMDA}o>world</hel\N{GREEK SMALL LETTER LAMDA}o>")
        self.assertTrue(h)

        h = hello.parse("<?xml version='1.0' encoding='utf-8' ?><hel\N{GREEK SMALL LETTER LAMDA}o>world</hel\N{GREEK SMALL LETTER LAMDA}o>")
        h = hello.parse("<?xml version='1.0' encoding='utf-16' ?><hel\N{GREEK SMALL LETTER LAMDA}o>world</hel\N{GREEK SMALL LETTER LAMDA}o>")
        self.assertTrue(h)

        h = hello()
        self.assertEqual(h.render(),'<?xml version="1.0" ?><hel\N{GREEK SMALL LETTER LAMDA}o />')
        self.assertEqual(h.render(fragment=True),"<hel\N{GREEK SMALL LETTER LAMDA}o />")
        self.assertEqual(h.render(encoding="utf8"),'<?xml version="1.0" encoding="utf8" ?><hel\N{GREEK SMALL LETTER LAMDA}o />'.encode("utf8"))
        self.assertEqual(h.render(encoding="utf8",fragment=True),"<hel\N{GREEK SMALL LETTER LAMDA}o />".encode("utf8"))
    ...
    def test_unicode_string_field(self):
        ...
        self.assertEqual(p.render(encoding="utf8"), '<?xml version="1.0" encoding="utf8" ?><Person name="hel\N{GREEK SMALL LETTER LAMDA}o" />'.encode("utf8"))
