# Generated by Haxe 4.3.0-rc.1+779b005
# coding: utf-8
import sys
            ...
            def _hx_local_4():
                def _hx_local_3():
                    ...
                    try:
                        ...
                        _g1 = haxe_Exception.caught(_g)
                        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.sessionLogger
                        line1 = _g1.get_message()
                        if logger.isErrorEnabled():
                            logger.error(((("null" if line1 is None else line1) + "\n") + HxOverrides.stringOrNull(_g1.details())))
        ...
        while (fieldStart < len(message)):
            ...
            if (value == ""):
                ...
                if ((("" if ((1 >= len(value))) else value[1])) == "P"):
                    unquoted = python_lib_urllib_Parse.unquote(HxString.substring(value,2,None))
                    try:
                        ...
                        _g1 = haxe_Exception.caught(_g)
                        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.sessionLogger
                        line = ((("Invalid JSON patch " + ("null" if unquoted is None else unquoted)) + ": ") + HxOverrides.stringOrNull(_g1.get_message()))
                        if logger.isErrorEnabled():
                    ...
                    unquoted1 = python_lib_urllib_Parse.unquote(HxString.substring(value,2,None))
                    values.set(nextFieldIndex,com_lightstreamer_internal_FieldValue.diffPatch(unquoted1))
                    nextFieldIndex = (nextFieldIndex + 1)
                else:
                ...
                if (tmp == 0):
                    ...
                    if (_g2 is None):
                        ...
                        if (tmp1 == 0):
                            ...
                            try:
                                newValues.set(key,com_lightstreamer_client_internal_update_CurrFieldVal.JsonVal(com_lightstreamer_internal_patch__Json_Json_Impl_.apply(json,_g1)))
                            except BaseException as _g6:
                                _g7 = haxe_Exception.caught(_g6)
                                logger1 = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.sessionLogger
                                line1 = _g7.get_message()
                                if logger1.isErrorEnabled():
                                    logger1.error(((("null" if line1 is None else line1) + "\n") + HxOverrides.stringOrNull(_g7.details())))
                            ...
                            try:
                                ...
                                logger2 = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.sessionLogger
                                line2 = _g10.get_message()
                                if logger2.isErrorEnabled():
                                    logger2.error(((("null" if line2 is None else line2) + "\n") + HxOverrides.stringOrNull(_g10.details())))
                                raise com_lightstreamer_internal_IllegalStateException(("Cannot apply the JSON Patch to the field " + Std.string(key)))
                        else:
                            pass
                elif (tmp == 3):
...
com_lightstreamer_internal__Constants_Constants_Fields_.LS_LIB_VERSION = (("1.0.0" + " build ") + "20221122")
com_lightstreamer_internal__Constants_Constants_Fields_.LS_CID = "v Wntytg4pkpW36AK3M4hwLri8M4O973h8p"
