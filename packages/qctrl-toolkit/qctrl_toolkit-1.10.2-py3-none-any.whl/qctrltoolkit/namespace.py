...
For a quick introduction, see the topic `Libraries of pulses for Boulder Opal
<https://docs.q-ctrl.com/boulder-opal/topics/libraries-of-pulses-for-boulder-opal>`_.
"""
...
class Namespace(Enum):
    ...
    The `PULSE` namespace holds system-agnostic signals.
    """
