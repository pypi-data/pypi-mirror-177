                            ...
                            if (character == ',' || two_characters.front() == '\n'){
                                if (two_characters.front() == '\n' && character == ','){
                                  if (result_accumulation.size() == 0){
                                    ...
                                    std::string possible_str_1 = "NULL";
                                    std::string possible_str_2 = "NaN";
                                    std::string possible_str_3 = "nan";
                                    std::string possible_str_4 = "NAN";
                                    std::string possible_str_5 = "Nan";
                                    if ((possible_str_1 == result_accumulation)||(possible_str_2 == result_accumulation)||(possible_str_3 == result_accumulation)||(possible_str_4 == result_accumulation)||(possible_str_5 == result_accumulation)){
                                        result_accumulation = "";
                                    }else{
                              ...
                              if (result_accumulation.size() == 0){
                                ...
                                std::string possible_str_4 = "NAN";
                                std::string possible_str_5 = "Nan";
                                if ((length <= 4 && possible_str_1.substr(0,length) == result_accumulation)||(length <= 3 && possible_str_2.substr(0,length) == result_accumulation)||(length <= 3 && possible_str_3.substr(0,length) == result_accumulation)||(length <= 3 && possible_str_4.substr(0,length) == result_accumulation)||(length <= 3 && possible_str_5.substr(0,length) == result_accumulation)){
