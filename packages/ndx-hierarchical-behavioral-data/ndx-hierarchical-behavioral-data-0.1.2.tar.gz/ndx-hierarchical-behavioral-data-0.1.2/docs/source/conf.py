...
# -*- coding: utf-8 -*-
#
# ndx-hierarchical-behavioral-data documentation build configuration file, created by
# sphinx-quickstart on Thu Jun 11 12:49:38 2020.
#
...
project = 'ndx-hierarchical-behavioral-data'
...
htmlhelp_basename = 'ndx-hierarchical-behavioral-datadoc'
...
latex_documents = [
    (master_doc, 'ndx-hierarchical-behavioral-data.tex', 'ndx-hierarchical-behavioral-data Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-hierarchical-behavioral-data', 'ndx-hierarchical-behavioral-data Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-hierarchical-behavioral-data', 'ndx-hierarchical-behavioral-data Documentation',
     author, 'ndx-hierarchical-behavioral-data', 'One line description of project.',
     'Miscellaneous'),
]
