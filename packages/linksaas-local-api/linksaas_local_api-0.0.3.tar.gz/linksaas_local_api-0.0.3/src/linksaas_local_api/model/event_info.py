...
class EventInfo(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            event_id (str): 事件ID. [optional]  # noqa: E501
            user_id (str): 事件相关用户ID. [optional]  # noqa: E501
            user_display_name (str): 用户名称. [optional]  # noqa: E501
            event_type (str): 事件类型. [optional]  # noqa: E501
            ref_type (str): 事件关联类型. [optional]  # noqa: E501
            ref_id (str): 事件关联ID. [optional]  # noqa: E501
            event_data ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): 事件内容. [optional]  # noqa: E501
        """
