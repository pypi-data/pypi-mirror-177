...
from linksaas_local_api import rest
from linksaas_local_api.configuration import Configuration
from linksaas_local_api.exceptions import ApiTypeError, ApiValueError, ApiException
from linksaas_local_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.hello_get  # this is an instance of the class Endpoint
        api_instance.hello_get()  # this invokes api_instance.hello_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.hello_get.callable or self.callable in this class
