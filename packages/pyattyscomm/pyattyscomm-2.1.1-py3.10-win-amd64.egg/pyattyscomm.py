...
class SwigPyIterator(object):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _pyattyscomm.delete_SwigPyIterator

    def value(self):
        r"""value(SwigPyIterator self) -> PyObject *"""
        return _pyattyscomm.SwigPyIterator_value(self)
    ...
    def incr(self, n=1):
        ...
        """
        return _pyattyscomm.SwigPyIterator_incr(self, n)
    ...
    def decr(self, n=1):
        ...
        """
        return _pyattyscomm.SwigPyIterator_decr(self, n)
    ...
    def distance(self, x):
        ...
        """
        return _pyattyscomm.SwigPyIterator_distance(self, x)
    ...
    def equal(self, x):
        ...
        """
        return _pyattyscomm.SwigPyIterator_equal(self, x)

    def copy(self):
        r"""copy(SwigPyIterator self) -> SwigPyIterator"""
        return _pyattyscomm.SwigPyIterator_copy(self)

    def next(self):
        r"""next(SwigPyIterator self) -> PyObject *"""
        return _pyattyscomm.SwigPyIterator_next(self)

    def __next__(self):
        r"""__next__(SwigPyIterator self) -> PyObject *"""
        return _pyattyscomm.SwigPyIterator___next__(self)

    def previous(self):
        r"""previous(SwigPyIterator self) -> PyObject *"""
        return _pyattyscomm.SwigPyIterator_previous(self)
    ...
    def advance(self, n):
        ...
        """
        return _pyattyscomm.SwigPyIterator_advance(self, n)
    ...
    def __eq__(self, x):
        ...
        """
        return _pyattyscomm.SwigPyIterator___eq__(self, x)
    ...
    def __ne__(self, x):
        ...
        """
        return _pyattyscomm.SwigPyIterator___ne__(self, x)
    ...
    def __iadd__(self, n):
        ...
        """
        return _pyattyscomm.SwigPyIterator___iadd__(self, n)
    ...
    def __isub__(self, n):
        ...
        """
        return _pyattyscomm.SwigPyIterator___isub__(self, n)
    ...
    def __add__(self, n):
        ...
        """
        return _pyattyscomm.SwigPyIterator___add__(self, n)
    ...
    def __sub__(self, *args):
        ...
        """
        return _pyattyscomm.SwigPyIterator___sub__(self, *args)
    def __iter__(self):
        return self

# Register SwigPyIterator in _pyattyscomm:
_pyattyscomm.SwigPyIterator_swigregister(SwigPyIterator)
class FloatArray(object):
    r"""Proxy of C++ std::array< float,N_CHANS > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        r"""iterator(FloatArray self) -> SwigPyIterator"""
        return _pyattyscomm.FloatArray_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        r"""__nonzero__(FloatArray self) -> bool"""
        return _pyattyscomm.FloatArray___nonzero__(self)

    def __bool__(self):
        r"""__bool__(FloatArray self) -> bool"""
        return _pyattyscomm.FloatArray___bool__(self)

    def __len__(self):
        r"""__len__(FloatArray self) -> std::array< float,N_CHANS >::size_type"""
        return _pyattyscomm.FloatArray___len__(self)

    def __getslice__(self, i, j):
        r"""
        __getslice__(FloatArray self, std::array< float,N_CHANS >::difference_type i, std::array< float,N_CHANS >::difference_type j) -> FloatArray

        Parameters
        ----------
        i: std::array< float,N_CHANS >::difference_type
        j: std::array< float,N_CHANS >::difference_type

        """
        return _pyattyscomm.FloatArray___getslice__(self, i, j)

    def __setslice__(self, *args):
        r"""
        __setslice__(FloatArray self, std::array< float,N_CHANS >::difference_type i, std::array< float,N_CHANS >::difference_type j)
        ...
        __setslice__(FloatArray self, std::array< float,N_CHANS >::difference_type i, std::array< float,N_CHANS >::difference_type j, FloatArray v)

        Parameters
        ----------
        i: std::array< float,N_CHANS >::difference_type
        j: std::array< float,N_CHANS >::difference_type
        v: std::array< float,N_CHANS > const &

        """
        return _pyattyscomm.FloatArray___setslice__(self, *args)

    def __delslice__(self, i, j):
        r"""
        __delslice__(FloatArray self, std::array< float,N_CHANS >::difference_type i, std::array< float,N_CHANS >::difference_type j)
        ...
        """
        return _pyattyscomm.FloatArray___delslice__(self, i, j)

    def __delitem__(self, *args):
        r"""
        __delitem__(FloatArray self, std::array< float,N_CHANS >::difference_type i)

        Parameters
        ----------
        i: std::array< float,N_CHANS >::difference_type

        __delitem__(FloatArray self, SWIGPY_SLICEOBJECT * slice)
        ...
        """
        return _pyattyscomm.FloatArray___delitem__(self, *args)

    def __getitem__(self, *args):
        r"""
        __getitem__(FloatArray self, SWIGPY_SLICEOBJECT * slice) -> FloatArray

        Parameters
        ----------
        slice: SWIGPY_SLICEOBJECT *

        __getitem__(FloatArray self, std::array< float,N_CHANS >::difference_type i) -> std::array< float,N_CHANS >::value_type const &
        ...
        """
        return _pyattyscomm.FloatArray___getitem__(self, *args)

    def __setitem__(self, *args):
        r"""
        __setitem__(FloatArray self, SWIGPY_SLICEOBJECT * slice, FloatArray v)
        ...
        __setitem__(FloatArray self, SWIGPY_SLICEOBJECT * slice)

        Parameters
        ----------
        slice: SWIGPY_SLICEOBJECT *

        __setitem__(FloatArray self, std::array< float,N_CHANS >::difference_type i, std::array< float,N_CHANS >::value_type const & x)

        Parameters
        ----------
        i: std::array< float,N_CHANS >::difference_type
        x: std::array< float,N_CHANS >::value_type const &

        """
        return _pyattyscomm.FloatArray___setitem__(self, *args)

    def __init__(self, *args):
        r"""
        __init__(FloatArray self) -> FloatArray
        __init__(FloatArray self, FloatArray other) -> FloatArray

        Parameters
        ----------
        other: std::array< float,N_CHANS > const &

        """
        _pyattyscomm.FloatArray_swiginit(self, _pyattyscomm.new_FloatArray(*args))

    def empty(self):
        r"""empty(FloatArray self) -> bool"""
        return _pyattyscomm.FloatArray_empty(self)

    def size(self):
        r"""size(FloatArray self) -> std::array< float,N_CHANS >::size_type"""
        return _pyattyscomm.FloatArray_size(self)

    def swap(self, v):
        r"""
        swap(FloatArray self, FloatArray v)

        Parameters
        ----------
        v: std::array< float,N_CHANS > &

        """
        return _pyattyscomm.FloatArray_swap(self, v)

    def begin(self):
        r"""begin(FloatArray self) -> std::array< float,N_CHANS >::iterator"""
        return _pyattyscomm.FloatArray_begin(self)

    def end(self):
        r"""end(FloatArray self) -> std::array< float,N_CHANS >::iterator"""
        return _pyattyscomm.FloatArray_end(self)

    def rbegin(self):
        r"""rbegin(FloatArray self) -> std::array< float,N_CHANS >::reverse_iterator"""
        return _pyattyscomm.FloatArray_rbegin(self)

    def rend(self):
        r"""rend(FloatArray self) -> std::array< float,N_CHANS >::reverse_iterator"""
        return _pyattyscomm.FloatArray_rend(self)

    def front(self):
        r"""front(FloatArray self) -> std::array< float,N_CHANS >::value_type const &"""
        return _pyattyscomm.FloatArray_front(self)

    def back(self):
        r"""back(FloatArray self) -> std::array< float,N_CHANS >::value_type const &"""
        return _pyattyscomm.FloatArray_back(self)

    def fill(self, u):
        r"""
        fill(FloatArray self, std::array< float,N_CHANS >::value_type const & u)

        Parameters
        ----------
        u: std::array< float,N_CHANS >::value_type const &

        """
        return _pyattyscomm.FloatArray_fill(self, u)
    __swig_destroy__ = _pyattyscomm.delete_FloatArray

# Register FloatArray in _pyattyscomm:
_pyattyscomm.FloatArray_swigregister(FloatArray)
class SampleCallback(object):
    r"""Proxy of C++ SampleCallback class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def hasSample(self, t, data):
        r"""
        hasSample(SampleCallback self, double t, FloatArray data)

        Parameters
        ----------
        t: double
        data: std::array< float,N_CHANS > const &

        """
        return _pyattyscomm.SampleCallback_hasSample(self, t, data)
    __swig_destroy__ = _pyattyscomm.delete_SampleCallback

    def __init__(self):
        r"""
        __init__(SampleCallback self) -> SampleCallback
        ...
        """
        if self.__class__ == SampleCallback:
            _self = None
        else:
            _self = self
        _pyattyscomm.SampleCallback_swiginit(self, _pyattyscomm.new_SampleCallback(_self, ))
    def __disown__(self):
        self.this.disown()
        _pyattyscomm.disown_SampleCallback(self)
        return weakref.proxy(self)

# Register SampleCallback in _pyattyscomm:
_pyattyscomm.SampleCallback_swigregister(SampleCallback)
...
class AttysCommListener(object):
    ...
    def hasSample(self, arg2, arg3):
        r"""
        hasSample(AttysCommListener self, double arg2, sample_p arg3)
...
class AttysCommMessage(object):
    ...
    def hasMessage(self, arg2, arg3):
        r"""
        hasMessage(AttysCommMessage self, int arg2, char const * arg3)
...
class AttysCommBase(object):
    ...
    * `attysCommMessage` : `AttysCommMessage *`  
    ...
    def registerMessageCallback(self, f):
        r"""
    ...
    def unregisterMessageCallback(self):
        r"""
    ...
    def getBluetoothBinaryAdress(self):
        r"""
    ...
    def getBluetoothAdressString(self, s):
        r"""
    ...
    def processRawAttysData(self, data):
        r"""
...
class AttysComm(AttysCommBase):
    ...
    * `AttysComm(void *_btAddr=NULL, int _btAddrLen=0)`  
    ...
    def __init__(self, _btAddr=None, _btAddrLen=0):
        r"""
    ...
    def sendSyncCommand(self, message, waitForOK):
        r"""
...
class AttysScanListener(object):
    ...
    def message(self, arg2, arg3):
        r"""
        message(AttysScanListener self, int const arg2, char const * arg3)
        ...
        """
        return _pyattyscomm.AttysScanListener_message(self, arg2, arg3)
...
class MyAttysCommListener(AttysCommListener):
    r"""Proxy of C++ MyAttysCommListener class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    callback = property(_pyattyscomm.MyAttysCommListener_callback_get, _pyattyscomm.MyAttysCommListener_callback_set, doc=r"""callback : p.SampleCallback""")

    def hasSample(self, t, sample):
        r"""
        hasSample(MyAttysCommListener self, double t, sample_p sample)
        ...
        """
        return _pyattyscomm.MyAttysCommListener_hasSample(self, t, sample)

    def __init__(self):
        r"""__init__(MyAttysCommListener self) -> MyAttysCommListener"""
        _pyattyscomm.MyAttysCommListener_swiginit(self, _pyattyscomm.new_MyAttysCommListener())
    __swig_destroy__ = _pyattyscomm.delete_MyAttysCommListener

# Register MyAttysCommListener in _pyattyscomm:
_pyattyscomm.MyAttysCommListener_swigregister(MyAttysCommListener)

def connectCallback(attysCommBase, cb):
    r"""
    connectCallback(AttysCommBase attysCommBase, SampleCallback cb)
    ...
    """
    return _pyattyscomm.connectCallback(attysCommBase, cb)

def disConnectCallback(attysCommBase):
    r"""
    disConnectCallback(AttysCommBase attysCommBase)
    ...
    """
    return _pyattyscomm.disConnectCallback(attysCommBase)
