...
class TLSRepository:
    ...
    @staticmethod
    def create_csr(hostname: str, opensslcnf: Path, private_key_file: Path, csr_file: Path):
        csr = __openssl_create_csr__(hostname, opensslcnf, private_key_file, csr_file)
        return csr

    @staticmethod
    def verify_csr(csr_file_path: str, private_key_file: str):
        return __openssl_verify_csr__(csr_file_path, private_key_file)

    @staticmethod
    def verify_ca_cert(private_key_file: str, ca_cert_file: str):
