...
arg_field_variance = Argument.create(
    "field_variance", default_help=common_field_variance, default=0, type=int
)
...
arg_ref_epi = Argument.create("ref_epi", default_help="Reference EPI image (Single frame and [0,1] normalized).")
