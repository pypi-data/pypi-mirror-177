...
Inputs:
    ...
    VMIXDB  A validation data split (0 - 1) or a SonusAI mixture database directory to use for validation data.
    VLOC    Optional validation data directory containing genft data; only used when VMIXDB is a mixdb directory.

Validation is created from MIXDB data using a split of VMIXDB if VMIXDB is a number between 0 and 1, or from VMIXDB
if VMIXDB is a SonusAI mixture database directory.
