...
def balance_active_truth(mixdb: MixtureDatabase,
    ...
    mp_atcb.mixdb = mixdb
    mp_atcb.raw_target_audios = raw_target_audios
...
def _process_target(mrecord: MRecord) -> MRecord:
    ...
    return process_target(mrecord=mrecord, mixdb=mp_atcb.mixdb,
                          raw_target_audios=mp_atcb.raw_target_audios)
