...
class optimization_stats_t(object):
    __slots__ = ["iterations", "best_index", "early_exited", "jacobian_sparsity", "linear_solver_ordering", "cholesky_factor_sparsity"]  # type: T.List[str]
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            (self.early_exited==other.early_exited) and
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x60902ece815935a3+ optimization_iteration_t._get_hash_recursive(newparents)+ sparse_matrix_structure_t._get_hash_recursive(newparents)+ VectorXi._get_hash_recursive(newparents)+ sparse_matrix_structure_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
