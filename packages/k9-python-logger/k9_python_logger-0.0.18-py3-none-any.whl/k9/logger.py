...
class K9Logger:
    ...
    def log(self, message, log_level, correlation_id=None, span_id=None):
        ...
        return self.k9_client.send_request(message=json.dumps(msg.__dict__))
        
    def info(self, message, **kwargs):
        return self.log(message, logging.INFO, **kwargs)
    
    def error(self, message, **kwargs):
        return self.log(message, logging.ERROR, **kwargs)
    
    def debug(self, message, **kwargs):
        return self.log(message, logging.DEBUG, **kwargs)
        
    def fatal(self, message, **kwargs):
        return self.log(message, logging.FATAL, **kwargs)

    def warning(self, message, **kwargs):
        return self.log(message, logging.WARNING, **kwargs)
