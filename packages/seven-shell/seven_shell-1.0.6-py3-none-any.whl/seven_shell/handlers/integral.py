...
:LastEditTime: 2022-11-18 14:16:50
...
class GoodsListHandle(SevenBaseHandler):
    ...
    def get_async(self, *args, **kwargs):
        ...
        # TODO 执行业务
        goods_list = GoodsModel().get_dict_page_list(field="id,goods_icon,goods_inventory,goods_name,goods_integral,goods_code",page_index=page_index-1,page_size=page_size,where="status = 1",order_by="release_time desc")
