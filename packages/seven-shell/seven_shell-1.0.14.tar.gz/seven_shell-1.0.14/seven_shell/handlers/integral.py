...
:LastEditTime: 2022-11-22 17:32:21
...
class ExchangeListHandler(SevenBaseHandler):
    ...
    def get_async(self, *args, **kwargs):
        ...
        # TODO 执行业务
        exchange_list,exchange_count = ExchangeModel().get_dict_page_list(field="nick_name,user_avatar,add_time",page_index=page_index-1,page_size=page_size,where="goods_id = %s",order_by="add_time desc",params=goods_id)
