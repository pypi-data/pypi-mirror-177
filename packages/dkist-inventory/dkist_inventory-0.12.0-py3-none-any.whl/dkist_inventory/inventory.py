...
def _inventory_from_wcs(wcs):
    ...
    inventory = {'boundingBox': ((min_dict["custom:pos.helioprojective.lon"].to_value(u.arcsec),
                                  min_dict["custom:pos.helioprojective.lat"].to_value(u.arcsec)),
                                 (max_dict["custom:pos.helioprojective.lon"].to_value(u.arcsec),
                                  max_dict["custom:pos.helioprojective.lat"].to_value(u.arcsec))),
