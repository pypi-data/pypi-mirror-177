...
from ibm_wos_utils.fairness.batch.utils.constants import CLASS_PROBABILITY_MODELING_ROLE, FEATURE_MODELING_ROLE, META_FIELD_MODELING_ROLE, PREDICTION_MODELING_ROLE, PROBABILITY_MODELING_ROLE, RECORD_ID_MODELING_ROLE, REGRESSION_MODEL_TYPE, SUPPORTED_STORAGE_TYPES, TIMESTAMP_MODELING_ROLE
...
class GroupBiasComputationJob(AIOSBaseJob):
    ...
    def _read_data(self, subscription: dict, monitor_instance: dict, db_name: str, table_name: str, schema_name: str=None): # (DataFrame, bool)
        """
