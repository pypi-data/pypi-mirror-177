...
def pull_artifact(
    artifact: str, allow_version_discovery=False, version_regex=SEM_VER_CORE_REGEX
) -> Dict:
    """
...
def _pull_artifact(
    ...
    if not artifact.endswith(container.tag):
        ...
        version_tag = _discover_highest_version_tag(
            artifact, version_regex=version_regex
        )
