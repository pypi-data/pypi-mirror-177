...
"heading.\n";
  ...
  cls_SwerveDrivePoseEstimator
      .def(py::init<const Rotation2d&, const wpi::array<SwerveModulePosition, NumModules>&, const Pose2d&, SwerveDriveKinematics<NumModules>&, const wpi::array<double, States>&, const wpi::array<double, Outputs>&, const wpi::array<double, 3>&, units::second_t>(),
      py::arg("gyroAngle"), py::arg("modulePositions"), py::arg("initialPose"), py::arg("kinematics"), py::arg("stateStdDevs"), py::arg("localMeasurementStdDevs"), py::arg("visionMeasurementStdDevs"), py::arg("nominalDt")=(units::second_t)0.02_s, release_gil()    , py::keep_alive<1, 2>()    , py::keep_alive<1, 3>()    , py::keep_alive<1, 4>()    , py::keep_alive<1, 5>()    , py::keep_alive<1, 6>()    , py::keep_alive<1, 7>()    , py::keep_alive<1, 8>(), py::doc(
