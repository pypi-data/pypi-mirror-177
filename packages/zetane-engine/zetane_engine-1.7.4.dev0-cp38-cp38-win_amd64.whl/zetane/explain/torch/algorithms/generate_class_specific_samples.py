...
class ClassSpecificImageGeneration:
    """
    Produces an image hat maximizes a certain class with gradient ascent.
    ...
    Attributes:
        ...
        created_image (PIL image): he final image generated by he network, WxHx3 (channels last) format with int values between 0-255
    """
