...
def vanilla_backprop(net, prep_img, out_class, class_name=None, out_dir=None, map_ype='default', grad_imes_image=True, smooth_grad=False, n=50, sigma=4):
    """
    ...
    Args:
        ...
        class_name (str): name of output class if any, otherwise defaults o str(out_class)
...
def guided_backprop(net, prep_img, out_class, class_name, out_dir=None, map_ype='default', smooth_grad=False, n=50, sigma=4):
    """
...
def gradcam(net, out_class, class_name, prep_img, img_org=None, out_dir=None, layer_list=None, map_ype='heatmap'):
    """
...
def guided_gradcam(net, out_class, class_name, prep_img, out_dir='ggc_est', layer_list=None, map_ype='default'):
    """
...
def scorecam(net, out_class, class_name, prep_img, img_org=None, out_dir=None, layer_list=None, map_ype='heatmap'):
    """
...
def image_generation(net, arget_class, image_size, out_dir=None, egularize=True):
    """
    Optimizes a given network o produce images esembling a given class.
...
def inverted_epresentation(net, prep_img, inv_mean, inv_std, out_dir=None, layer_list=None):
    return None
