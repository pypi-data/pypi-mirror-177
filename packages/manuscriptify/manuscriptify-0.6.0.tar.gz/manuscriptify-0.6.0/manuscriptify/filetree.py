...
class FileTree(tuple):
    ...
    def __new__(cls, project_folder, filter_=''):
        source_folder = cls.source(project_folder)
        folder_tree = cls._expand(source_folder)
    ...
    def source(cls, project_folder):
        ...
        if len(source_folders) == 1:
            ...
            raise InconvenientResults(source_folders)
    ...
    def _expand(cls, source_folder):
        ...
        while True:
            ...
            parents = next_gen
        return [source_folder] + descendants
