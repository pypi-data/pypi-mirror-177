from abstract.abc_http_client import BaseApiCollector
...
class SyncApiCollector(BaseApiCollector):
    def __init__(self, main_api_link: str, main_params: str = None, cookie: dict = None):
        super(SyncApiCollector, self).__init__(main_api_link, main_params, cookie)
