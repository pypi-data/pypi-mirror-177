...
class InformalResultPackage(BizErrorBase):
    pass
set_error_info("en", "InformalResultPackage", 1211060001, "Informal result package")
set_error_info("zh-hans", "InformalResultPackage", 1211060001, "错误的数据封装包。")
