...
class MHA(nn.Module):
    ...
    def __init__(self, embed_dim, num_heads, cross_attn=False, bias=True, dropout=0.0,
                 ...
                 layer_idx=None, fused_bias_fc=False, use_flash_attn=False, return_residual=False,
    ...
    def _update_kv_cache(self, kv, inference_params):
        ...
        assert batch_end <= inference_kv_cache[0]
    ...
    def forward(self, x, x_kv=None, inference_params=None):
        """
        Arguments:
