...
void set_params(Masked_multihead_attention_params<T> &params,
    ...
    params.neox_rotary_style = false;
    params.timestep = timestep;
    params.inv_sqrt_dh = 1.0f;  // TODO
...
torch::Tensor attention_single_query(const torch::Tensor q,
    ...
    DISPATCH_FLOAT_AND_HALF_AND_BF16(q.scalar_type(), out.scalar_type(), "attention_single_query", [&] {
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("attention_single_query", &attention_single_query, "Attention with single query");
}