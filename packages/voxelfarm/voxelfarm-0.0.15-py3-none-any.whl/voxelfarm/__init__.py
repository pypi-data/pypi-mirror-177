...
def set_field(v, value):
    pass

def get_voxel_origin(v):
    return (0,0,0)

def get_field_origin(v):
    return (0,0,0)

def set_entity_bounds_x(min, max):
    pass

def set_entity_bounds_y(min, max):
    pass

def set_entity_bounds_z(min, max):
    pass
