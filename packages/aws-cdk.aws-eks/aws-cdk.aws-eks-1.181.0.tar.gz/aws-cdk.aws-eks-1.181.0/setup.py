    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-s3-assets==1.181.0",
        "aws-cdk.aws-ssm==1.181.0",
        "aws-cdk.core==1.181.0",
        "aws-cdk.custom-resources==1.181.0",
        "aws-cdk.lambda-layer-awscli==1.181.0",
        "aws-cdk.lambda-layer-kubectl==1.181.0",
        "aws-cdk.lambda-layer-node-proxy-agent==1.181.0",
