...
_ASSEMBLYSEQUENCEREPORTSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='page_size', full_name='ncbi.datasets.v2.AssemblySequenceReportsRequest.page_size', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='page_token', full_name='ncbi.datasets.v2.AssemblySequenceReportsRequest.page_token', index=5,
