...
def main(
    ...
    solr_timeout: int = typer.Option(60, envvar="SOLR_TIMEOUT", show_default=True),
    solr_url: str = typer.Option("http://localhost:8983/solr/dbnomics", envvar="SOLR_URL", show_default=True),
):
