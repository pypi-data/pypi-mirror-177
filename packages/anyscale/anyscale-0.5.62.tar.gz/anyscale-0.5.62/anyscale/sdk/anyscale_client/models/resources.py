...
class Resources(object):
    ...
    def cpu(self):
        ...
        Number of CPUs in this node type. If left blank, Ray may automatically detect it for you; see https://docs.ray.io/en/master/cluster/config.html#cluster-configuration-resources-type for more.  # noqa: E501
    ...
    def gpu(self):
        ...
        Number of GPUs in this node type. If left blank, Ray may automatically detect it for you; see https://docs.ray.io/en/master/cluster/config.html#cluster-configuration-resources-type for more.  # noqa: E501
    ...
    def memory(self):
        ...
        Amount of memory to allocate to the Python worker. If left blank, Ray will choose an appropriate amount based on available resources; see https://docs.ray.io/en/master/cluster/config.html#cluster-configuration-resources-type for more.  # noqa: E501
    ...
    def object_store_memory(self):
        ...
        The amount of memory in bytes allocated for the Ray object store on this node. If left blank, Ray will choose an appropriate amount; see https://docs.ray.io/en/master/cluster/config.html#cluster-configuration-resources-type for more.  # noqa: E501
