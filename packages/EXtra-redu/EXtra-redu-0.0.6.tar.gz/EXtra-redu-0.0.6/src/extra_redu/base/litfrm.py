...
EVENT_PULSE = {
    16: lambda pulses: 0,
    181: lambda pulses: np.argmax(pulses),
}
...
class Agipd2g:
    def __init__(self, det_node, litfrm):
        self.det = det_node
        self.litfrm = litfrm
        if litfrm.alignMethod.value == 'by reference delay':
            raise ValueError(
                "Alignment method 'by reference delay' "
                "is not implemented for AGIPD 2nd gen.")
