...
list(APPEND _IMPORT_CHECK_FILES_FOR_gs_util "${_IMPORT_PREFIX}/lib/libgs_util.so" )

# Import target "graphx_runner" for configuration "Release"
set_property(TARGET graphx_runner APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(graphx_runner PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/graphx_runner"
  )

list(APPEND _IMPORT_CHECK_TARGETS graphx_runner )
list(APPEND _IMPORT_CHECK_FILES_FOR_graphx_runner "${_IMPORT_PREFIX}/bin/graphx_runner" )
