...
###########
# secrets
SPACES_ACCESS_KEY = environ.get('SPACES_ACCESS_KEY')
SPACES_SECRET_KEY = environ.get('SPACES_SECRET_KEY')

ES_HOST = environ.get('ES_HOST')
ES_PORT = environ.get('ES_PORT', 9200)
ES_USER = environ.get('ES_USER', environ.get('KIBANA_USER', 'kibadmin'))
ES_PASS = environ.get('ES_PASS', environ.get('KIBANA_PASS', 'YoUrPaSsWoRd'))
ES_INDEX = environ.get('ES_INDEX', 'wikipedia')
