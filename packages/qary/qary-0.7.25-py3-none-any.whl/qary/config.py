...
from qary.constants import HOME_DIR  # noqa
...
DEFAULT_CONFIG.update(dict(env))
...
LOGLEVEL = env.get('loglevel', DEFAULT_CONFIG.get('loglevel', logging.WARNING))
USE_CUDA = env.get('use_cuda', DEFAULT_CONFIG.get('use_cuda', USE_CUDA))
