...
import cdk8s
import cdktf
import cdktf_cdktf_provider_kubernetes.provider
import constructs


class CDK8sProvider(
    cdktf_cdktf_provider_kubernetes.provider.KubernetesProvider,
    ...
    def __init__(
        ...
        *,
        ...
        exec: typing.Optional[typing.Union[cdktf_cdktf_provider_kubernetes.provider.KubernetesProviderExec, typing.Dict[str, typing.Any]]] = None,
        experiments: typing.Optional[typing.Union[cdktf_cdktf_provider_kubernetes.provider.KubernetesProviderExperiments, typing.Dict[str, typing.Any]]] = None,
...
@jsii.data_type(
    ...
    jsii_struct_bases=[
        cdktf_cdktf_provider_kubernetes.provider.KubernetesProviderConfig
    ],
    name_mapping={
        "alias": "alias",
...
class CDK8sProviderConfig(
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(exec, dict):
            exec = cdktf_cdktf_provider_kubernetes.provider.KubernetesProviderExec(**exec)
        if isinstance(experiments, dict):
            experiments = cdktf_cdktf_provider_kubernetes.provider.KubernetesProviderExperiments(**experiments)
        if __debug__:
            def stub(
                *,
                alias: typing.Optional[builtins.str] = None,
    ...
    def exec(
        self,
    ) -> typing.Optional[cdktf_cdktf_provider_kubernetes.provider.KubernetesProviderExec]:
        '''exec block.

        Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes#exec KubernetesProvider#exec}
        '''
        result = self._values.get("exec")
        return typing.cast(typing.Optional[cdktf_cdktf_provider_kubernetes.provider.KubernetesProviderExec], result)

    @builtins.property
    def experiments(
        self,
    ) -> typing.Optional[cdktf_cdktf_provider_kubernetes.provider.KubernetesProviderExperiments]:
        '''experiments block.
        ...
        return typing.cast(typing.Optional[cdktf_cdktf_provider_kubernetes.provider.KubernetesProviderExperiments], result)
