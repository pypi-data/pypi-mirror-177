...
from bot.object import Object, Wd, items, keys, register, update, values
from bot.object import edit, kind, load, save
from bot.object import ObjectDecoder, ObjectEncoder
from bot.object import printable
...
class TestObject(unittest.TestCase):
    ...
    def test_kind(self):
        self.assertEqual(kind(Object()), "bot.object.Object")
