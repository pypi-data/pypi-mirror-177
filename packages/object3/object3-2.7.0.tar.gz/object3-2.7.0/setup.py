...
setup(
    ...
    version=VERSION_STR,
    url='https://github.com/hartwork/object3',
    download_url='https://github.com/hartwork/object3/archive/%s.tar.gz' % VERSION_STR,
    ...
    entry_points={
        'console_scripts': [
            'object3 = grub2_theme_preview.__main__:main',
        ],
    },
    classifiers=[
