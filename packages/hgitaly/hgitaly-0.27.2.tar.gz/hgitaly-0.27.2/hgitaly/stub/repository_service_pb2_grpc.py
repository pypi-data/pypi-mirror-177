...
class RepositoryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PruneUnreachableObjects = channel.unary_unary(
                ...
                request_serializer=repository__service__pb2.PruneUnreachableObjectsRequest.SerializeToString,
                response_deserializer=repository__service__pb2.PruneUnreachableObjectsResponse.FromString,
                )
...
def add_RepositoryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PruneUnreachableObjects': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=repository__service__pb2.PruneUnreachableObjectsRequest.FromString,
                    response_serializer=repository__service__pb2.PruneUnreachableObjectsResponse.SerializeToString,
            ),
...
class RepositoryService(object):
    ...
    def PruneUnreachableObjects(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gitaly.RepositoryService/PruneUnreachableObjects',
            repository__service__pb2.PruneUnreachableObjectsRequest.SerializeToString,
            repository__service__pb2.PruneUnreachableObjectsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
