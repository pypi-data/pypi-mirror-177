...
class IColaboFlowHostData():
	...
	***record key*** is the `id` of the `taskInstance`
	...
	def __init__(self, hostName, appNameText, appNameTextWithContext, amqpUrl, queueHost, queueHostHeartbeat, queueServiceOrchestrator, sendHeartbeat = True, listenForOrchestratorRequests = True, processOrchestratorTaskExecuteRequests = True):
