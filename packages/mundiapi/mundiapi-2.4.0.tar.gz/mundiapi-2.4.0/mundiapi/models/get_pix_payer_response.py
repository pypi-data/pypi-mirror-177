...
import mundiapi.models.get_pix_bank_account_response
...
class GetPixPayerResponse(object):
    ...
    def from_dictionary(cls,
        ...
        bank_account = mundiapi.models.get_pix_bank_account_response.GetPixBankAccountResponse.from_dictionary(dictionary.get('bank_account')) if dictionary.get('bank_account') else None
