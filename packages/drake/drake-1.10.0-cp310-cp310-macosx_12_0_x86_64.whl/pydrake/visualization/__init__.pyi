...
def ApplyVisualizationConfig(config: VisualizationConfig, builder: pydrake.systems.framework.DiagramBuilder_[float], lcm_buses: pydrake.systems.lcm.LcmBuses = ..., plant: pydrake.multibody.plant.MultibodyPlant_[float] = ..., scene_graph: pydrake.geometry.SceneGraph_[float] = ..., lcm: pydrake.lcm.DrakeLcmInterface = ...) -> None: ...
