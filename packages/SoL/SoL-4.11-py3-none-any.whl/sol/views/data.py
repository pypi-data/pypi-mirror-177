...
# :Copyright: © 2008, 2009, 2010, 2013, 2014, 2015, 2016, 2018, 2019, 2020, 2021, 2022 Lele Gaifax
#

import logging

from metapensiero.sqlalchemy.proxy.filters import Operator, extract_filters
    ...
    if 'metadata' in args:
        ...
        if played_for_club_id is not None:
            ...
            if 'filter' in args:
                ...
                if ((len(filters) == 1
                     and
                     filters[0].property in {'firstname', 'lastname'}
                     and
