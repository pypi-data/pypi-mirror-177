    ...
    def remove_other_lang(text : str) -> str:
        '''
            ...
            output : 
                ---> "أهلا وسهلا"
        '''
        chars = [char for char in text if (char in ARABIC_CHARS) or (char in ARABIC_NUM) (char in ARABIC_PUNCTUATION)]
        output = ''.join(chars)
        return output
...
class Tokenizer():
    ...
    '''
    split all text...
    next step i well do Tokenizer with out nltk.
    '''
...
print(Tokenizer('sfdfdf fdfd fsdfd'))
