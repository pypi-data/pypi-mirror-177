...
class TiaRobotListener:
    ...
    def __init__(self, url="http://localhost:7001/", log_file="./teamscale-robot-plugin.log", log_level="INFO") -> None:
    ...
    def close(self):
        ...
        self._agent_connector.tia_end_testrun()

    def _get_impacted_tests(self):
        """Retrieves the uniform paths of impacted tests for this test run"""
        available_tests = [{"clusterId": 0, "uniformPath": test} for test in self._available_tests]
        ...
        return [impacted_test["uniformPath"] for impacted_test in impacted_clusters[0]["tests"]]

    def _init_logging(self, log_file, log_level):
