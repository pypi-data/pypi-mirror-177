...
class CasADiControlProblem():
    ...
    def U(self, arg0: Box) -> None:
        pass
    @property
    def cost_structure(self) -> _alpaqa.CostStructure:
        """
        :type: _alpaqa.CostStructure
        """
    @cost_structure.setter
    def cost_structure(self, arg0: _alpaqa.CostStructure) -> None:
        pass
    @property
    def nu(self) -> int:
        """
...
def load_casadi_quadratic_control_problem(so_name: str, N: int, nx: int = 0, nu: int = 0, p: int = 0) -> CasADiQuadraticControlProblem:
    ...
    """
@typing.overload
def problem_with_counters(problem: CasADiProblem) -> typing.Tuple[TEProblem, _alpaqa.EvalCounter]:
    """
    ...
    """
@typing.overload
def problem_with_counters(problem: object) -> typing.Tuple[TEProblem, _alpaqa.EvalCounter]:
    pass
