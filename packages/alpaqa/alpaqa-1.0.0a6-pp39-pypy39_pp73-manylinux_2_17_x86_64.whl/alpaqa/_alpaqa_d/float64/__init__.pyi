...
__all__ = [
    ...
    "load_casadi_problem",
    "load_casadi_quadratic_control_problem",
...
class CasADiControlProblem():
    ...
    def U(self, arg0: Box) -> None:
        pass
    @property
    def cost_structure(self) -> _alpaqa_d.CostStructure:
        """
        :type: _alpaqa_d.CostStructure
        """
    @cost_structure.setter
    def cost_structure(self, arg0: _alpaqa_d.CostStructure) -> None:
        pass
    @property
    def nu(self) -> int:
        """
...
class CasADiQuadraticControlProblem():
    ...
    See :py:class:`alpaqa._alpaqa.float64.TEControlProblem` for the full documentation.
    """
    def __copy__(self) -> CasADiQuadraticControlProblem: ...
    def __deepcopy__(self, memo: dict) -> CasADiQuadraticControlProblem: ...
    @property
    def D(self) -> Box:
        """
        :type: Box
    ...
    def Q_N(self) -> numpy.ndarray:
        ...
        """
    @Q_N.setter
    def Q_N(self, arg1: numpy.ndarray) -> None:
        """
        Cost matrix :math:`Q_N` of the problem
        """
    @property
    ...
    def u_ref(self) -> numpy.ndarray:
        ...
        """
    @u_ref.setter
    def u_ref(self, arg1: numpy.ndarray) -> None:
        """
        Reference input :math:`u_\mathrm{ref}`
        """
    @property
    ...
    def x_ref(self) -> numpy.ndarray:
        ...
        """
    @x_ref.setter
    def x_ref(self, arg1: numpy.ndarray) -> None:
        """
        Reference state :math:`x_\mathrm{ref}`
        """
    @property
    def μ(self) -> numpy.ndarray:
        """
        ...
        """
    @μ.setter
    def μ(self, arg1: numpy.ndarray) -> None:
        """
        Penalty factor :math:`\mu`
        """
    pass
...
class TEControlProblem():
    ...
    @typing.overload
    def __init__(self, arg0: CasADiQuadraticControlProblem) -> None: ...
    @typing.overload
...
class TEProblem():
    ...
    pass
def load_casadi_control_problem(so_name: str, N: int, nx: int = 0, nu: int = 0, p: int = 0) -> CasADiControlProblem:
    """
...
def load_casadi_problem(so_name: str, n: int = 0, m: int = 0, p: int = 0, second_order: bool = False) -> CasADiProblem:
    ...
    """
def load_casadi_quadratic_control_problem(so_name: str, N: int, nx: int = 0, nu: int = 0, p: int = 0) -> CasADiQuadraticControlProblem:
    """
    Load a compiled CasADi optimal control problem.
    """
@typing.overload
def problem_with_counters(problem: CasADiProblem) -> typing.Tuple[TEProblem, _alpaqa_d.EvalCounter]:
    """
    ...
    """
@typing.overload
def problem_with_counters(problem: object) -> typing.Tuple[TEProblem, _alpaqa_d.EvalCounter]:
    pass
