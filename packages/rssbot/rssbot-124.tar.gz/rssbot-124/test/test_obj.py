...
from rssbot.object import Object, Wd, items, keys, register, update, values
from rssbot.object import edit, kind, load, save
from rssbot.object import ObjectDecoder, ObjectEncoder
from rssbot.object import printable
...
class TestObject(unittest.TestCase):
    ...
    def test_kind(self):
        self.assertEqual(kind(Object()), "rssbot.object.Object")
