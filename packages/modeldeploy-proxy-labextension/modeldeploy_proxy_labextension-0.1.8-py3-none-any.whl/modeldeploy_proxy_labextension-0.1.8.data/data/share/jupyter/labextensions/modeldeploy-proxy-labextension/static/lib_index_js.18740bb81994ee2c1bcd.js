...
const getTransformerNotebookDir = (settings) => {
    try {
        let transformerSettings = settings.get(TRFANFORMER_CONFIG).composite;
...
const getTransformerProxyUrl = (settings) => {
    try {
        let transformerSettings = settings.get(TRFANFORMER_CONFIG).composite;
    ...
    activate: (app, settingRegistry) => {
        Promise.all([settingRegistry.load(SETTINGS_ID)]).then(async ([settings]) => {
            ...
            try {
                ...
                let output = await _lib_NotebookUtils__WEBPACK_IMPORTED_MODULE_1__["default"].sendKernelRequest(kernel, kernelCmd, { dir: 'dir', proxy: 'proxy' }, true);
...
class TransformerLeftPanel extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor(props) {
        ...
        this.applyTransformerToProxy = async () => {
            ...
            let proxyUrl = (0,_settings__WEBPACK_IMPORTED_MODULE_2__.getTransformerProxyUrl)(this.props.transformerSettings);
            if (!proxyUrl) {
                this.setState({
                    isDialogVisible: true,
            ...
            try {
                ...
                console.log(args);
                const result = await (0,_lib_RPCUtils__WEBPACK_IMPORTED_MODULE_5__.executeRpc)(kernel, 'proxy.apply', args);
                console.log(result);
                this.setState({
                    isDialogVisible: true,
                    isDialogButtonVisible: true,
...
//# sourceMappingURL=lib_index_js.18740bb81994ee2c1bcd.js.map