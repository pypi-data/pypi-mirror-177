...
class Inline(OnInlineQuery):
    ...
    def inline(
        ...
        Examples:
            ...
            @HDev.inline('hello', owner_only=True)
            ...
            # Others will be ignored.
            @HDev.inline('hello', sudo_only=True)
            ...
            @HDev.inline(filters=filters.user(['sshdiiofficial', 'Designatory']))

            # Filter only queries done in 'StarkBotsChat'
            @HDev.inline(filters=filters.chat('FunFriendsReborn'))

            # Filter only queries ending with the word 'baby'.
            @HDev.inline(filters=filters.regex(r'baby$'))

            # Filter all queries with the word 'hello' AND which are done in 'StarkBotsChat'.
            @HDev.inline(filters=filters.chat('FunFriendsReborn') & filters.regex('hello'))
            # or
            @HDev.inline('hello', filters=filters.chat('FunFriendsReborn'))
            ...
            @HDev.inline(filters=~filters.chat('FunFriendsReborn') & filters.regex('hello'))
            # or
            @HDev.inline(filters=filters.regex('hello') & ~filters.chat('FunFriendsReborn'))
            ```
        """
        # ToDo:
