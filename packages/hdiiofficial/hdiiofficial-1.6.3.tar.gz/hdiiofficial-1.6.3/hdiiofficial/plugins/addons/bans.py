...
from hdiiofficial.config import ENV
from hdiiofficial.plugins.helpers import db
from pyrogram.errors import PeerIdInvalid


@HDev.cmd("botban", owner_only=True)
async def ban_users(bot: HDev, msg):
...
@HDev.cmd("botunban", owner_only=True)
...
@HDev.cmd("botbanlist", owner_only=True)
