...
from hdiiofficial.plugins.hdev import HOME_BUTTON, MAIN_BUTTONS
from pyrogram.types import InlineKeyboardMarkup, CallbackQuery
from hdiiofficial.plugins.helpers import replace, module, replace_commands


@HDev.callback(query=['home', 'about', 'help'])
async def basic_cb(bot: HDev, cb: CallbackQuery):
