...
import sys
import argparse
from hdiiofficial.constants import __description__, __version__
...
def main():
    ...
    cwd = os.getcwd()
    parser.add_argument('-v', '--version', help='check the current HDevpy version installed', action='store_true')
    ...
    if args.boilerplate_heroku or args.boilerplate or args.special:
        if args.special:
            print('Generating Boilerplate (for HDev Bots)...')
...
def boilerplate(special=False):
    ...
    if special:
        os.system('ghclone https://github.com/hdiiofficial/HDevpy/tree/master/boilerplate_hdevbots')
    else:
        os.system('ghclone https://github.com/hdiiofficial/HDevpy/tree/master/boilerplate')
