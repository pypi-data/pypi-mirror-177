...
class Ms2Spectra:
    ...
    @property
    def parent_id(self) -> Union[str, None]: return self.info.get(ILineKeywords.PARENT_ID_KEYWORD)

    @parent_id.setter
    def parent_id(self, parent_id: Union[str, int]): self.info[ILineKeywords.PARENT_ID_KEYWORD] = str(parent_id)

    @property
    def precursor_id(self) -> Union[str, None]: return self.info.get(ILineKeywords.PRECURSOR_ID_KEYWORD)

    @precursor_id.setter
    def precursor_id(self, precursor_id: Union[str, int]): self.info[ILineKeywords.PRECURSOR_ID_KEYWORD] = str(precursor_id)

    @property
    def ook0(self) -> Union[str, None]: return self.info.get(ILineKeywords.OOK0_KEYWORD)

    @ook0.setter
    def ook0(self, ook0: Union[str, float]): self.info[ILineKeywords.OOK0_KEYWORD] = str(ook0)

    @property
    def ccs(self) -> Union[str, None]: return self.info.get(ILineKeywords.CCS_KEYWORD)

    @ccs.setter
    def ccs(self, ccs: Union[str, float]): self.info[ILineKeywords.CCS_KEYWORD] = str(ccs)

    @property
    def rt(self) -> Union[str, None]: return self.info.get(ILineKeywords.RETENTION_TIME_KEYWORD)

    @rt.setter
    def rt(self, rt: Union[str, float]): self.info[ILineKeywords.RETENTION_TIME_KEYWORD] = str(rt)

    @property
    def ce(self) -> Union[str, None]: return self.info.get(ILineKeywords.COLLISION_ENERGY_KEYWORD)

    @ce.setter
    def ce(self, ce: Union[str, float]): self.info[ILineKeywords.COLLISION_ENERGY_KEYWORD] = str(ce)

    @property
    def iso_mz(self) -> Union[str, None]: return self.info.get(ILineKeywords.ISOLATION_MZ_KEYWORD)

    @iso_mz.setter
    def iso_mz(self, iso_mz: Union[str, float]): self.info[ILineKeywords.ISOLATION_MZ_KEYWORD] = str(iso_mz)

    @property
    def iso_width(self) -> Union[str, None]: return self.info.get(ILineKeywords.ISOLATION_WIDTH_KEYWORD)

    @iso_width.setter
    def iso_width(self, iso_width: Union[str, float]): self.info[ILineKeywords.ISOLATION_WIDTH_KEYWORD] = str(iso_width)

    @property
    def scan_begin(self) -> Union[str, None]: return self.info.get(ILineKeywords.SCAN_NUMBER_BEGIN_KEYWORD)

    @scan_begin.setter
    def scan_begin(self, scan_begin: Union[str, int]): self.info[ILineKeywords.SCAN_NUMBER_BEGIN_KEYWORD] = str(scan_begin)

    @property
    def scan_end(self) -> Union[int, None]: return self.info.get(ILineKeywords.SCAN_NUMBER_END_KEYWORD)

    @scan_end.setter
    def scan_end(self, scan_end: Union[str, int]): self.info[ILineKeywords.SCAN_NUMBER_END_KEYWORD] = str(scan_end)

    @property
    def prec_intensity(self) -> Union[str, None]: return self.info.get(ILineKeywords.PRECURSOR_INTENSITY_KEYWORD)

    @prec_intensity.setter
    def prec_intensity(self, prec_intensity: Union[str, float]): self.info[ILineKeywords.PRECURSOR_INTENSITY_KEYWORD] = str(prec_intensity)
