...
#define PACKAGE_BUGREPORT "http://bugzilla.gnome.org/enter_bug.cgi?product=GStreamer&component=orc"

/* Define to the full name of this package. */
#define PACKAGE_NAME "orc"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "orc 0.4.27"
