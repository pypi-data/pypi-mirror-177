...
class ModuleSpec(object):
    def __init__(
        self, circuit: Circuit, arg_specs: Sequence[ModuleArgSpec], check_unique_arg_names: bool = True
    ) -> None: ...
    @staticmethod
    def new_no_check_args(circuit: Circuit, arg_specs: Sequence[ModuleArgSpec]) -> ModuleSpec: ...
    @property
    def circuit(self) -> Circuit: ...
    @property
    def arg_specs(self) -> List[ModuleArgSpec]: ...
...
class ModuleArgSpec(object):
    ...
    @staticmethod
    def just_name_shape(circuit: Circuit, batchable: bool = True, expandable: bool = True) -> ModuleArgSpec: ...
    @property
...
class PrintOptions(object):
    ...
    def __init__(
        ...
        traversal: Optional[IterativeMatcher] = None,
    ...
    def evolve(
        ...
        traversal: Union[Optional[IterativeMatcher], NotSet] = NOT_SET,
...
class PrintHtmlOptions(object):
    ...
    shape_only_when_necessary: bool
    traversal: IterativeMatcher  # Which nodes to display from the start
    ...
    overall_traversal: IterativeMatcher  # Which nodes to load. Choose smaller depth if the circuit is too big.
    def __init__(
        self,
        shape_only_when_necessary: bool = True,
        traversal: IterativeMatcher = traverse_until_depth(3),
        ...
        overall_traversal: IterativeMatcher = IterativeMatcher(False),
    ) -> None: ...
    ...
    def evolve(
        self,
        shape_only_when_necessary: Union[bool, NotSet] = NOT_SET,
        traversal: Union[IterativeMatcher, NotSet] = NOT_SET,
        ...
        overall_traversal: Union[IterativeMatcher, NotSet] = NOT_SET,
    ) -> PrintHtmlOptions: ...
...
class Parser:
    ...
    @property
    def reference_circuits(self) -> Dict[str, Circuit]: ...
    def __init__(
        self,
...
class ParseRegexDidntMatchError(ParseError): ...
class ParseRegexDidntMatchGroupError(ParseError): ...
...
class ParseInvalidTerseBoolError(ParseError): ...
class ParseReferenceCircuitHasChildrenInParseStrError(ParseError): ...
class ParseReferenceCircuitNameFollowedByAdditionalInfoError(ParseError): ...
class ParseOnCircuitRepeatInfoIsNotSameError(ParseError): ...
class ParseExpected2CharsPerForModuleExtraError(ParseError): ...
class ParseModuleInconsistentNumChildrenError(ParseError): ...
...
class IterativeMatcher:
    ...
    def new_chain_many(*matchers: Sequence[IterativeMatcherIn]) -> IterativeMatcher:
        ...
        """
    @staticmethod
    def new_children_matcher(first_match: IterativeMatcherIn, child_numbers: Set[int]) -> IterativeMatcher:
...
def extract_rewrite(
    ...
    # defaults to making symbol with same name with batchable=True and expandable=True
