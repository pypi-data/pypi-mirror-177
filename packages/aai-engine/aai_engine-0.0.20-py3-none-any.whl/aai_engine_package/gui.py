...
class Toolbar(tk.Frame):
    ...
    def on_new(self):
        """_summary_
        """
        engine.main(self.parent.data.directory, update_function_after_edit=self.parent.load_files,)

    def on_new_ocr(self):
        """_summary_
        """
        engine.main(self.parent.data.directory, update_function_after_edit=self.parent.load_files, screenshot_type=OCR_SCREENSHOT)
    ...
    def _edit_img(self):
        ...
        try:
            ...
            if 'ocr_box_relative' in img.text:
                ...
                engine.main(self.data.directory, update_function_after_edit=self._load_files, needle=filename, editing=True)
...
class MainApplication(tk.Frame):
    ...
    def __init__(self, parent, command_line_options, *args, **kwargs):
        ...
        parent.tk.call('source', engine._get_theme_path())
