...
class ExampleModel extends base_1.DOMWidgetModel {
    ...
    run_model(values, shape) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let arr = ndarray(data_out, shape_out);
            console.log("arr ndarray out", arr);
            //const a={ shape: [2,2], dtype:'float32', buffer: arr.data as ndarray.TypedArray }
            this.set("array_out", arr);
...
//# sourceMappingURL=lib_widget_js-webpack_sharing_consume_default_jupyter-widgets_base-webpack_sharing_consume_de-cffbaf.b8ca8266b3484a9c65ba.js.map