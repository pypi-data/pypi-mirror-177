...
# -*- coding: utf-8 -*-
#
# custom_onnx documentation build configuration file
#
...
_version_py = os.path.join(repo, 'custom_onnx', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'custom_onnxdoc'
...
latex_documents = [
    (master_doc, 'custom_onnx.tex', 'custom_onnx Documentation',
     'nallezard', 'manual'),
]
