...
class OpResult_Meta;
class OpResult_MetaDefaultTypeInternal;
...
class OpResult_Meta PROTOBUF_FINAL :
 ...
 public:
  ...
  inline OpResult_Meta* New() const final {
    return CreateMaybeMessage<OpResult_Meta>(nullptr);
  }
...
class OpResult PROTOBUF_FINAL :
 ...
 public:
  ...
  ::gs::rpc::OpResult_Meta* release_meta();
...
inline void OpResult_Meta::set_metrics(const std::string& value) {
...
inline void OpResult_Meta::set_metrics(std::string&& value) {
  
  metrics_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:gs.rpc.OpResult.Meta.metrics)
}
inline void OpResult_Meta::set_metrics(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  metrics_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:gs.rpc.OpResult.Meta.metrics)
}
inline void OpResult_Meta::set_metrics(const char* value,
    size_t size) {
  ...
  metrics_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:gs.rpc.OpResult.Meta.metrics)
}
