...
class MutableGraphInfoPbDefaultTypeInternal;
...
class MutableGraphInfoPb PROTOBUF_FINAL :
 ...
 public:
  ...
  inline MutableGraphInfoPb* New() const final {
    return CreateMaybeMessage<MutableGraphInfoPb>(nullptr);
  }
...
public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_graphscope_2fproto_2fgraph_5fdef_2eproto);
    return ::descriptor_table_graphscope_2fproto_2fgraph_5fdef_2eproto.file_level_metadata[3];
  }
...
inline void MutableGraphInfoPb::set_property_schema_json(const std::string& value) {
  _internal_set_property_schema_json(value);
...
inline void MutableGraphInfoPb::set_property_schema_json(std::string&& value) {
  
  property_schema_json_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:gs.rpc.graph.MutableGraphInfoPb.property_schema_json)
}
inline void MutableGraphInfoPb::set_property_schema_json(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  property_schema_json_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:gs.rpc.graph.MutableGraphInfoPb.property_schema_json)
}
inline void MutableGraphInfoPb::set_property_schema_json(const char* value,
    size_t size) {
  ...
  property_schema_json_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:gs.rpc.graph.MutableGraphInfoPb.property_schema_json)
}
