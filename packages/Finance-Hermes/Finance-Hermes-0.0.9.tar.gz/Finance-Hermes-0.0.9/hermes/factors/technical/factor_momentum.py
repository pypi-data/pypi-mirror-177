...
class FactorMomentum(FactorBase, LongCallMixin, ShortMixin):
    ...
    def BIAS(self,
        ...
        result = bias(data['close'], length=length, offset=offset, **kwargs)
    ...
    def CCI(self,
        ...
        result = cci(data['high'],
                     ...
                     offset=offset,
                     **kwargs)
        return self._format(result, f"CCI_{length}_{c}")
    ...
    def CG(self,
        ...
        result = cg(data['close'], length=length, offset=offset, **kwargs)
    ...
    def DNCHVOLATILITY(self,
                       ...
                       **kwargs):
        length = int(length) if length and length > 0 else 5
        result = dnclvolatility(data['close'],
                                low=data['low'],
                                length=length,
                                offset=offset,
                                **kwargs)
        return self._format(result, f"DNCLVolatility{length}")
    ...
    def DNLLVOLATILITY(self,
                       ...
                       **kwargs):
        length = int(length) if length and length > 0 else 5
        result = dnllvolatility(low=data['low'],
                                length=length,
                                offset=offset,
                                **kwargs)
        return self._format(result, f"DNLLVolatility{length}")
    ...
    def KDJ(self,
        ...
        j = self._format(j, f"KDJ_D_{length}")
        return k, d, j
    ...
    def KST(self,
        ...
        result, kst_signal = kst(data['close'],
                                 roc1=roc1,
                                 roc2=roc2,
                                 roc3=roc3,
                                 roc4=roc4,
        ...
        result = self._format(
            result,
            f"KST_{roc1}_{roc2}_{roc3}_{roc4}_{sma1}_{sma2}_{sma3}_{sma4}")
        kst_signal = self._format(
            kst_signal,
            f"KST_{roc1}_{roc2}_{roc3}_{roc4}_{sma1}_{sma2}_{sma3}_{sma4}")
    ...
    def MACD(self,
        ...
        result, histogram, signalma = macd(data['close'],
                                           fast=fast,
                                           slow=slow,
                                           signal=signal,
                                           offset=offset,
    ...
    def MOM(self,
            ...
            **kwargs):
        length = int(length) if length and length > 0 else 10
        result = mom(data['close'], length=length, offset=offset, **kwargs)
    ...
    def PPO(self,
        ...
        slow = int(slow) if slow and slow > 0 else 26
        signal = int(signal) if signal and signal > 0 else 9
        result, histogram, signalma = ppo(data['close'],
                                          fast=fast,
                                          slow=slow,
                                          signal=signal,
                                          scalar=scalar,
    ...
    def PVO(self,
        ...
        slow = int(slow) if slow and slow > 0 else 26
        signal = int(signal) if signal and signal > 0 else 9
        result, histogram, signalma = pvo(data['volume'],
                                          fast=fast,
                                          slow=slow,
                                          signal=signal,
                                          scalar=scalar,
    ...
    def RVGI(self,
        ...
        result, signal = rvgi(data['open'],
                              ...
                              offset=offset,
                              **kwargs)
        result = self._format(result, f"RVGI_{length}_{swma_length}")
        signal = self._format(signal, f"RVGI_{length}_{swma_length}")
    ...
    def STOCH(self,
        ...
        stoch_k, stoch_d = stoch(data['high'],
                                 data['low'],
                                 data['close'],
                                 k=k,
                                 d=d,
    ...
    def STOCHRSI(self,
        ...
        d = d if d and d > 0 else 3
        stochrsi_k, stochrsi_d = stochrsi(data['close'],
                                          length=length,
        ...
        stochrsi_k = self._format(stochrsi_k,
                                  f"STOCHRSI_{length}_{rsi_length}_{k}")
        stochrsi_d = self._format(stochrsi_d,
                                  f"STOCHRSI_{length}_{rsi_length}_{d}")
    ...
    def TRIX(self,
        ...
        signal = int(signal) if signal and signal > 0 else 9
        result, trix_signal = trix(data['close'],
                                   length=length,
                                   signal=signal,
                                   scalar=scalar,
                                   drift=drift,
    ...
    def TSI(self,
        ...
        result, tri_signal = trix(data['close'],
                                  fast=fast,
                                  slow=slow,
                                  signal=signal,
                                  scalar=scalar,
    ...
    def UPCHVOLATILITY(self,
                       ...
                       **kwargs):
        length = int(length) if length and length > 0 else 5
        result = upchvolatility(data['close'],
                                data['high'],
                                length=length,
                                offset=offset,
                                **kwargs)
    ...
    def UPHHVOLATILITY(self,
                       ...
                       **kwargs):
        length = int(length) if length and length > 0 else 5
        result = uphhvolatility(data['high'],
                                length=length,
                                offset=offset,
                                **kwargs)
