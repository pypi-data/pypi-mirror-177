...
class FactorVolume(FactorBase, LongCallMixin, ShortMixin):
    ...
    def AOBV(self,
        ...
        obv_, maf, mas, obv_long, obv_short = aobv(data['close'],
                                                   data['volume'],
                                                   fast=fast,
                                                   slow=slow,
    ...
    def EOM(self,
        ...
        result = eom(data['high'],
                     ...
                     offset=offset,
                     **kwargs)
        return self._format(result, f"EOM_{length}_{divisor}")
    ...
    def KVO(self,
        ...
        result, kvo_signal = kvo(data['high'],
                                 data['low'],
                                 data['close'],
                                 data['volume'],
                                 fast=fast,
    ...
    def ELINRATIO(self,
        ...
        result = linratio(data['long'], length=length, offset=offset, **kwargs)
        return self._format(result, f"ELINRATIO_{category}_{length}")
    ...
    def OBV(self,
            ...
            dependencies=['close', 'volume'],
            **kwargs):
        result = obv(data['close'], data['volume'], offset=offset, **kwargs)
    ...
    def SINRATIO(self,
                 ...
                 **kwargs):
        length = int(length) if length and length > 0 else 5
        result = sinratio(data['long'], length=length, offset=offset, **kwargs)
