...
class FactorOverlap(FactorBase, LongCallMixin, ShortMixin):
    ...
    def DEMA(self,
        ...
        result = dema(data['close'], length=length, offset=offset, **kwargs)
    ...
    def HL2(self, data, offset=None, dependencies=['high', 'low'], **kwargs):
        result = hl2(data['high'], data['low'], **kwargs)
    ...
    def HMA(self,
            ...
            **kwargs):
        length = int(length) if length and length > 0 else 10
        result = hma(data['close'], length=length, offset=offset, **kwargs)
    ...
    def ICHIMOKU(self,
                 ...
                 **kwargs):
        span_a, span_b = ichimoku(data['high'],
                                  data['low'],
                                  data['close'],
                                  tenkan=tenkan,
                                  kijun=kijun,
    ...
    def RMA(self,
            ...
            **kwargs):
        length = int(length) if length and length > 0 else 10
        result = rma(data['close'], length=length, offset=offset, **kwargs)
    ...
    def SMA(self,
            ...
            **kwargs):
        length = int(length) if length and length > 0 else 10
        result = sma(data['close'], length=length, offset=offset, **kwargs)
    ...
    def T3(self,
        ...
        result = t3(data['close'], length=length, a=a, offset=offset, **kwargs)
        return self._format(result, f"T3_{length}_{a}")
    ...
    def TEMA(self,
             ...
             **kwargs):
        length = int(length) if length and length > 0 else 10
        result = tema(data['close'], length=length, offset=offset, **kwargs)
    ...
    def TRIMA(self,
              ...
              **kwargs):
        length = int(length) if length and length > 0 else 10
        result = trima(data['close'], length=length, offset=offset, **kwargs)
