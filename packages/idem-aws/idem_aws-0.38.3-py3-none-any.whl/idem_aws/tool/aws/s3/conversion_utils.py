"""Tool module for various conversion of Amazon S3 bucket resources."""
import json
...
def convert_raw_public_access_block_to_present(
    ...
    """Util function to convert the s3 bucket public access block response to a common format."""
    translated_resource = {
