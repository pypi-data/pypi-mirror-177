...
class ClusterBeta(Cluster, Generic[IsAsynchronous]):
    ...
    async def _get_cluster_vm_types_to_use(self):
        ...
        # set backend options for gcp scheduler with guest gpu
    ...
    async def _determine_senv(self):
        ...
        if self.package_sync:
            ...
            self.auto_env_issues: Dict[str, Tuple[magic.ResolvedPackageInfo, int]] = {
            ...
            if self.auto_env_issues and HAS_RICH and self.show_widget:
                from coiled._beta.widgets.rich import print_rich_package_warning_table
