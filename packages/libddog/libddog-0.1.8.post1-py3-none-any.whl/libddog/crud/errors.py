...
class MonitorCreateFailed(AbstractCrudError):
    pass


class MonitorDeleteFailed(AbstractCrudError):
    pass


class MonitorGetFailed(AbstractCrudError):
    pass


class MonitorListFailed(AbstractCrudError):
    pass


class MonitorUpdateFailed(AbstractCrudError):
    pass


class MonitorDefinitionsImportError(AbstractCrudError):
    pass


class MonitorDefinitionsLoadError(AbstractCrudError):
    pass
