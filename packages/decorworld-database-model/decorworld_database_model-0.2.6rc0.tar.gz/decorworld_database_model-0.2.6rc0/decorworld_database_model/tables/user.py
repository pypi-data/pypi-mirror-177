...
class UserSchema(Schema):
    ...
    registration_date = fields.DateTime(dump_to='registrationDate')
    activation_date = fields.DateTime(dump_to='activationDate')
    updated_date = fields.DateTime(dump_to='updatedDate')
