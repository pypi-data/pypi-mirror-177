...
from mastapy.system_model.part_model.couplings import _2554, _2556
...
class SynchroniserHalf(_2556.SynchroniserPart):
    """SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2554.SynchroniserCone]':
