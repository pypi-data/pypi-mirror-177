...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5779, _5778
...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def filtering_method(self) -> '_5779.ModalContributionFilteringMethod':
        ...
        return constructor.new_from_mastapy_type(_5779.ModalContributionFilteringMethod)(value) if value is not None else None

    @filtering_method.setter
    def filtering_method(self, value: '_5779.ModalContributionFilteringMethod'):
    ...
    @property
    def modes_to_display(self) -> '_5778.ModalContributionDisplayMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5778.ModalContributionDisplayMethod)(value) if value is not None else None

    @modes_to_display.setter
    def modes_to_display(self, value: '_5778.ModalContributionDisplayMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
