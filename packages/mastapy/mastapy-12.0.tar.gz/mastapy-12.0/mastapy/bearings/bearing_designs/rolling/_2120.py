...
from mastapy.bearings import (
    _1853, _1831, _1832, _1833,
    _1830, _1856
)
from mastapy.bearings.bearing_designs.rolling import (
    _2102, _2106, _2107, _2113,
    _2123, _2101, _2130, _2110,
    _2098, _2122
)
...
class RollingBearing(_2086.DetailedBearing):
    """RollingBearing
    ...
    @property
    def cage_bridge_shape(self) -> '_2102.CageBridgeShape':
        ...
        return constructor.new_from_mastapy_type(_2102.CageBridgeShape)(value) if value is not None else None

    @cage_bridge_shape.setter
    def cage_bridge_shape(self, value: '_2102.CageBridgeShape'):
    ...
    @property
    def cage_material(self) -> '_1833.BearingCageMaterial':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1833.BearingCageMaterial)(value) if value is not None else None

    @cage_material.setter
    def cage_material(self, value: '_1833.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def catalogue(self) -> '_1830.BearingCatalog':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1830.BearingCatalog)(value) if value is not None else None
    ...
    @property
    def sleeve_type(self) -> '_2123.SleeveType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2123.SleeveType)(value) if value is not None else None
    ...
    @property
    def type_information(self) -> '_2101.BearingTypeExtraInformation':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2101.BearingTypeExtraInformation)(value) if value is not None else None
    ...
    @property
    def geometric_constants(self) -> '_2110.GeometricConstants':
    ...
    @property
    def protection(self) -> '_2098.BearingProtection':
    ...
    @property
    def skf_seal_frictional_moment_constants(self) -> '_2122.SKFSealFrictionalMomentConstants':
