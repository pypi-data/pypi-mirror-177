...
class ISO14179SettingsPerBearingType(_1552.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    ...
    @property
    def rolling_bearing_type(self) -> '_1857.RollingBearingType':
        ...
        return constructor.new_from_mastapy_type(_1857.RollingBearingType)(value) if value is not None else None

    @property
    def iso14179_settings(self) -> '_1934.ISO14179Settings':
