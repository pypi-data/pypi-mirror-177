...
from mastapy.bearings.tolerances import _1880, _1886, _1876
...
class RoundnessSpecification(_1552.IndependentReportablePropertiesBase['RoundnessSpecification']):
    ...
    @property
    def specification_type(self) -> '_1880.RoundnessSpecificationType':
        ...
        return constructor.new_from_mastapy_type(_1880.RoundnessSpecificationType)(value) if value is not None else None

    @specification_type.setter
    def specification_type(self, value: '_1880.RoundnessSpecificationType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def type_of_fit(self) -> '_1886.TypeOfFit':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1886.TypeOfFit)(value) if value is not None else None

    @type_of_fit.setter
    def type_of_fit(self, value: '_1886.TypeOfFit'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def roundness_distribution(self) -> 'List[_1876.RaceRoundnessAtAngle]':
