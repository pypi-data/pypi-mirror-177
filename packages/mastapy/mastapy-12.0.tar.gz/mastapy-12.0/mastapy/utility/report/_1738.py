...
from mastapy.utility.report import _1748, _1749
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.utility.reporting_property_framework import _1753
...
class CustomReportPropertyItem(_0.APIBase):
    ...
    @property
    def font_style(self) -> '_1748.FontStyle':
        ...
        return constructor.new_from_mastapy_type(_1748.FontStyle)(value) if value is not None else None

    @font_style.setter
    def font_style(self, value: '_1748.FontStyle'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontStyle = value

    @property
    def font_weight(self) -> '_1749.FontWeight':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1749.FontWeight)(value) if value is not None else None

    @font_weight.setter
    def font_weight(self, value: '_1749.FontWeight'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontWeight = value

    @property
    def horizontal_position(self) -> '_1753.CellValuePosition':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1753.CellValuePosition)(value) if value is not None else None

    @horizontal_position.setter
    def horizontal_position(self, value: '_1753.CellValuePosition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
