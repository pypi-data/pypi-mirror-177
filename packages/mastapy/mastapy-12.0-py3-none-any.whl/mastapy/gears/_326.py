...
class GearSetOptimiser(_0.APIBase):
    ...
    def perform_strength_optimisation_with_progress(self, number_of_results: 'int', progress: '_7483.TaskProgress', use_current_design_as_starting_point: Optional['bool'] = False) -> '_325.GearSetOptimisationResults':
        """ 'PerformStrengthOptimisation' is the original name of this method.
