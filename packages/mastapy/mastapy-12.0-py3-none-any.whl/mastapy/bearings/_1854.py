...
class RollingBearingDatabase(_1794.SQLDatabase['_1855.RollingBearingKey', '_2120.RollingBearing']):
    """RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_2120.RollingBearing'):
    ...
    def create_bearing(self, type_: '_1857.RollingBearingType', designation: Optional['str'] = 'None') -> '_2120.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_2120.RollingBearing':
        """ 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1857.RollingBearingType', designation: Optional['str'] = 'None') -> '_1855.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1855.RollingBearingKey':
        """ 'CreateKey' is the original name of this method.
    ...
    def remove_from_database(self, bearing: '_2120.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1830.BearingCatalog', type_: '_1857.RollingBearingType', bore_range: '_1453.Range', outer_diameter_range: '_1453.Range', width_range: '_1453.Range', dynamic_capacity_range: '_1453.Range', number_of_rows: 'int', material_type: '_1846.HybridSteelAll') -> 'List[_2120.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1830.BearingCatalog', type_: '_1857.RollingBearingType') -> 'List[_2120.RollingBearing]':
        """ 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1830.BearingCatalog') -> '_2120.RollingBearing':
        """ 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1830.BearingCatalog') -> 'List[_2120.RollingBearing]':
        """ 'SearchForRollingBearing' is the original name of this method.
