...
from mastapy.bearings.bearing_designs.rolling import _2119, _2116
...
class TaperRollerBearing(_2116.NonBarrelRollerBearing):
    """TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1837.BearingMeasurementType':
        ...
        return constructor.new_from_mastapy_type(_1837.BearingMeasurementType)(value) if value is not None else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1837.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_2119.RollerRibDetail':
