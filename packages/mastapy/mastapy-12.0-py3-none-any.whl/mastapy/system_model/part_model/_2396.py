...
from mastapy.system_model.connections_and_sockets import (
    _2222, _2224, _2248, _2243
)
from mastapy.system_model.part_model import _2397, _2420
...
class Component(_2420.Part):
    ...
    @property
    def component_connections(self) -> 'List[_2222.ComponentConnection]':
    ...
    def can_delete_connection(self, connection: '_2224.Connection') -> 'bool':
    ...
    def connect_to_socket(self, socket: '_2248.Socket') -> '_2397.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2397.ComponentsConnectedResult':
        """ 'ConnectTo' is the original name of this method.
    ...
    def diameter_at_middle_of_connection(self, connection: '_2224.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_2224.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_2248.Socket') -> 'List[_2248.Socket]':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_2248.Socket]':
        """ 'PossibleSocketsToConnectWith' is the original name of this method.
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_2243.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1463.CoordinateSystem3D') -> '_2243.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_2243.RealignmentResult':
    ...
    def socket_named(self, socket_name: 'str') -> '_2248.Socket':
    ...
    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2397.ComponentsConnectedResult':
