...
from torchscale.component.embedding import VisionEmbedding, VisionLanguageEmbedding
...
class Encoder(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if output_projection is None and not is_encoder_decoder and not args.no_output_layer:
