...
To install Concrete Strength, run this command in your terminal:

.. code-block:: console

    $ pip install concrete_strength_prediction

This is the preferred method to install Concrete Strength, as it will always install the most recent stable release.
...
The sources for Concrete Strength can be downloaded from the `Github repo`_.
