...
def cloud_org_accounts(prismasession, cloud_type: str, id: str):
    """
...
def account_groups(prismasession, detailed=True):
    """
...
def compliance_summary(prismasession: PrismaSession, standards: list[str]):
    """
...
def compliance_requirements_summary(prismasession: PrismaSession, standard:str, account_name = None):
    """
    ...
    comp = {}
    requirements = df_to_jsons_list(standard_requirements(prismasession, standard))
    for r in requirements:
        reqcomp = prisma.get_standard_requirement_compliance_statistics(prismasession, standard_id, r['id'], account_name)
...
def resource_compliance(prismasession, complianceStandard):
    """
...
def compliance_standards(prismasession):
    """
...
def standard_requirements(prismasession, complianceStandard):
    """
...
def standards_sections(prismasession, complianceStandard, requirement_name):
    """
...
def alerts(prismasession: prisma.PrismaSession, basic: bool = True, timeType: str = 'relative', timeAmount: str = '2',
    ...
    if(not df.empty and policyComplianceStandard is not None):
        ...
        policies = policies[['policyId', 'name', 'description', 'severity']]
