...
class KVStoreRPCTestCase(SQLiteTestMixin, RPCServerTestMixin, OpenModuleCoreTestMixin):
    ...
    def setUp(self):
        ...
        self.rpc_server2 = RPCServer(self.zmq_context())

    def tearDown(self):
        self.rpc_server.shutdown()
        self.rpc_server2.shutdown()
        super().tearDown()
    ...
    def test_start_sync(self):
        ...
        self.rpc_server2.register_handler("rpc-websocket", "server_rpc", ServerRPCRequest, ServerSyncResponse,
                                          start_sync, register_schema=False)

        self.rpc_server2.run_as_thread()
        self.wait_for_rpc_server(self.rpc_server2)
