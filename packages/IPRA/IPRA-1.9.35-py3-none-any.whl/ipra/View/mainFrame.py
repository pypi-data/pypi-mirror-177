...
class MainApplication(tk.Tk):
    ...
    def __createFrameExeRobot(self,frame):
        ...
        self.button_reset = Button(frame, text =self.stringValue.clear.get(),font=font.Font(size=15))
        self.button_start = Button(frame,text =self.stringValue.startRobot.get(),font=font.Font(size=15))
        self.button_report = Button(frame,text =self.stringValue.exportReport.get(),font=font.Font(size=15))
