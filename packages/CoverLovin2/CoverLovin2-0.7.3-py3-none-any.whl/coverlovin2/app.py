...
class ImageSearcher_MusicBrainz(ImageSearcher_Medium_Network):
    ...
    def search_album_image(self) -> bool:
        ...
        self._log.debug("· import %s version %s", mb.__package__, mb.musicbrainz._version)
        self._log.debug('· mb.set_useragent("%s", %s)', name, __version__)
        mb.set_useragent(name, __version__)
