...
def cli():
    ...
    add.add_argument(
        ...
        type=int,
        default=None,
        help="Number of cores to add the files with. Defaults to the number of logical cores",
    )
    ...
    upload.add_argument(
        ...
        type=int,
        default=None,
        help="Number of cores to upload the files with. Defaults to the number of logical cores",
    )
    ...
    get.add_argument(
        ...
        type=int,
        default=None,
        help="Number of cores to get the files with. Defaults to the number of logical cores",
    )
