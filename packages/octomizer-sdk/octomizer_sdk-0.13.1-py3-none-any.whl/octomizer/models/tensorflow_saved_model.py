"""A wrapper for TensorFlow SavedModel Models in the OctoML Platform."""
import typing

from octomizer import client, model, project


class TensorFlowSavedModel(model.Model):
    """Represents a Model in TensorFlow SavedModel format."""
