...
class Route:
    ...
    def __init__(self, lanelet_network: LaneletNetwork, list_ids_lanelets: List[int], route_type: RouteType,
...
class RouteCandidateHolder:
    ...
    def __init__(self, lanelet_network: LaneletNetwork, state_initial: InitialState, goal_region: GoalRegion,
        ...
        self.list_route_candidates = [Route(lanelet_network, route, route_type, set_ids_lanelets_permissible)
