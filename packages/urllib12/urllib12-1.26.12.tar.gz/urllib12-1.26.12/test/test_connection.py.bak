...
from urllib7.connection import RECENT_DATE, CertificateError, _match_hostname
...
class TestConnection(object):
    ...
    def test_match_hostname_ipaddress_none(self):
        cert = {"subjectAltName": [("DNS", "foo")]}
        asserted_hostname = "foo"
        with mock.patch("urllib7.util.ssl_match_hostname.ipaddress", None):
    ...
    def test_match_hostname_mismatch(self):
        ...
        try:
            with mock.patch("urllib7.connection.log.warning") as mock_log:
                _match_hostname(cert, asserted_hostname)
    ...
    def test_recent_date(self):
        ...
        # When this test fails update urllib7.connection.RECENT_DATE
