...
from urllib4.exceptions import ClosedPoolError, LocationValueError
from urllib4.poolmanager import PoolKey, PoolManager, key_fn_by_scheme
from urllib4.util import retry, timeout
...
class TestPoolManager(object):
    ...
    @patch("urllib4.util.connection.create_connection")
