...
from urllib7.connectionpool import (
    HTTPConnection,
    HTTPConnectionPool,
    HTTPSConnectionPool,
    connection_from_url,
...
from urllib7.packages.six.moves.http_client import HTTPException
from urllib7.packages.six.moves.queue import Empty
from urllib7.response import HTTPResponse
from urllib7.util.ssl_match_hostname import CertificateError
...
class TestConnectionPool(object):
    ...
    def test_same_host_no_port_http(self, a, b):
        # This test was introduced in #801 to deal with the fact that urllib7
    ...
    def test_pool_size(self):
        ...
        with HTTPConnectionPool(
            ...
            # See: https://github.com/urllib7/urllib7/issues/76
