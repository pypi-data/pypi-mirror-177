...
# See https://github.com/urllib4/urllib4/issues/1809 and
# https://github.com/urllib4/urllib4/pull/1475#issuecomment-440788064.
...
def withPyOpenSSL(test):
    ...
    def wrapper(*args, **kwargs):
        ...
        pyopenssl.inject_into_urllib4()
        result = test(*args, **kwargs)
        pyopenssl.extract_from_urllib4()
        return result
