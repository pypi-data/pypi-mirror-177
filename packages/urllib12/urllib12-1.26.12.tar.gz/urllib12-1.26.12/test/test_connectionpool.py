...
from urllib4.packages.six.moves.http_client import HTTPException
from urllib4.packages.six.moves.queue import Empty
from urllib4.response import HTTPResponse
from urllib4.util.ssl_match_hostname import CertificateError
...
class TestConnectionPool(object):
    ...
    def test_same_host_no_port_http(self, a, b):
        # This test was introduced in #801 to deal with the fact that urllib4
    ...
    def test_pool_size(self):
        ...
        with HTTPConnectionPool(
            ...
            # See: https://github.com/urllib4/urllib4/issues/76
