...
from urllib7 import util
from urllib7.exceptions import HTTPWarning
from urllib7.packages import six
from urllib7.util import ssl_

try:
    import urllib7.contrib.pyopenssl as pyopenssl
except ImportError:
    pyopenssl = None
...
# See https://github.com/urllib7/urllib7/issues/1809 and
# https://github.com/urllib7/urllib7/pull/1475#issuecomment-440788064.
...
def withPyOpenSSL(test):
    ...
    def wrapper(*args, **kwargs):
        ...
        pyopenssl.inject_into_urllib7()
        result = test(*args, **kwargs)
        pyopenssl.extract_from_urllib7()
        return result
