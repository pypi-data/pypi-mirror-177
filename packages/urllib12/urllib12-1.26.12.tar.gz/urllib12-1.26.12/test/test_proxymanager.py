...
from urllib4.exceptions import MaxRetryError, NewConnectionError, ProxyError
from urllib4.poolmanager import ProxyManager
from urllib4.util.retry import Retry
from urllib4.util.url import parse_url
...
class TestProxyManager(object):
    ...
    def test_proxy_headers(self, proxy_scheme):
        url = "http://pypi.org/project/urllib4/"
        ...
        with ProxyManager(proxy_url) as p:
            ...
            url_with_port = "http://pypi.org:8080/project/urllib4/"
