...
from urllib7.exceptions import MaxRetryError, NewConnectionError, ProxyError
from urllib7.poolmanager import ProxyManager
from urllib7.util.retry import Retry
from urllib7.util.url import parse_url
...
class TestProxyManager(object):
    ...
    def test_proxy_headers(self, proxy_scheme):
        url = "http://pypi.org/project/urllib7/"
        ...
        with ProxyManager(proxy_url) as p:
            ...
            url_with_port = "http://pypi.org:8080/project/urllib7/"
