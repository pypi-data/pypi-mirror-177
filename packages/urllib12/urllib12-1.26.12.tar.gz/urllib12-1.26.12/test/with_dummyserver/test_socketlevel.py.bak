...
from urllib7 import HTTPConnectionPool, HTTPSConnectionPool, ProxyManager, util
from urllib7._collections import HTTPHeaderDict
from urllib7.connection import HTTPConnection, _get_default_user_agent
...
from urllib7.packages.six.moves import http_client as httplib
from urllib7.poolmanager import proxy_from_url
from urllib7.util import ssl_, ssl_wrap_socket
from urllib7.util.retry import Retry
...
class TestSocketClosing(SocketDummyServerTestCase):
    ...
    def test_release_conn_param_is_respected_after_timeout_retry(self):
        ...
        [1] <https://github.com/urllib7/urllib7/issues/651>
        """
...
class TestSSL(SocketDummyServerTestCase):
    ...
    def test_ssl_failed_fingerprint_verification(self):
        ...
        with pytest.raises(MaxRetryError) as cm:
            request()
        assert isinstance(cm.value.reason, SSLError)
        # Should not hang, see https://github.com/urllib7/urllib7/issues/529
        with pytest.raises(MaxRetryError):
            request()
    ...
    def test_ssl_load_default_certs_when_empty(self):
        ...
        with mock.patch("urllib7.util.ssl_.SSLContext", lambda *_, **__: context):
            self._start_server(socket_handler)
            with HTTPSConnectionPool(self.host, self.port) as pool:
                with pytest.raises(MaxRetryError):
    ...
    # https://github.com/urllib7/urllib7/pull/2674
    @notSecureTransport
    @pytest.mark.skipif(
    ...
    def test_requesting_large_resources_via_ssl(self, preload_content, read_amt):
        ...
        socket.
        https://github.com/urllib7/urllib7/issues/2513
        """
...
class TestHeaders(SocketDummyServerTestCase):
    ...
    def test_ua_header_can_be_overridden(self):
        headers = {"uSeR-AgENt": "Definitely not urllib7!"}
...
class TestMultipartResponse(SocketDummyServerTestCase):
    def test_multipart_assert_header_parsing_no_defects(self):
        ...
        self._start_server(socket_handler)
        from urllib7.connectionpool import log
