...
from urllib7.connectionpool import VerifiedHTTPSConnection, connection_from_url
...
from urllib7.poolmanager import ProxyManager, proxy_from_url
from urllib7.util import Timeout
from urllib7.util.ssl_ import create_urllib7_context
...
class TestHTTPProxyManager(HTTPDummyProxyTestCase):
    ...
    def test_https_proxy_with_proxy_ssl_context(self):
        proxy_ssl_context = create_urllib7_context()
