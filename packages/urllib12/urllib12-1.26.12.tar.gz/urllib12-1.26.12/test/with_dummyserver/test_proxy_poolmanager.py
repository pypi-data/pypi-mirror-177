...
from urllib4.connectionpool import VerifiedHTTPSConnection, connection_from_url
...
from urllib4.poolmanager import ProxyManager, proxy_from_url
from urllib4.util import Timeout
from urllib4.util.ssl_ import create_urllib4_context
...
class TestHTTPProxyManager(HTTPDummyProxyTestCase):
    ...
    def test_https_proxy_with_proxy_ssl_context(self):
        proxy_ssl_context = create_urllib4_context()
