...
from urllib7 import connection_from_url
from urllib7.exceptions import ClosedPoolError, LocationValueError
from urllib7.poolmanager import PoolKey, PoolManager, key_fn_by_scheme
from urllib7.util import retry, timeout
...
class TestPoolManager(object):
    ...
    @patch("urllib7.util.connection.create_connection")
