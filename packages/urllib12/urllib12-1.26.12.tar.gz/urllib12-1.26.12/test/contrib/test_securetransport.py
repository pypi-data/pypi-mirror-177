...
try:
    from urllib4.contrib.securetransport import WrappedSocket
except ImportError:
    pass
...
def setup_module():
    try:
        from urllib4.contrib.securetransport import inject_into_urllib4
...
def teardown_module():
    try:
        from urllib4.contrib.securetransport import extract_from_urllib4
...
# https://github.com/urllib4/urllib4/issues/1674
