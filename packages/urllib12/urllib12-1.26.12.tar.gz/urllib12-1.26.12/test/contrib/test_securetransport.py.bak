...
try:
    from urllib7.contrib.securetransport import WrappedSocket
except ImportError:
    pass
...
def setup_module():
    try:
        from urllib7.contrib.securetransport import inject_into_urllib7
...
def teardown_module():
    try:
        from urllib7.contrib.securetransport import extract_from_urllib7
...
# https://github.com/urllib7/urllib7/issues/1674
