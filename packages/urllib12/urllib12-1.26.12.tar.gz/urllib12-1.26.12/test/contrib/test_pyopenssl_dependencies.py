...
try:
    from urllib4.contrib.pyopenssl import extract_from_urllib4, inject_into_urllib4
except ImportError:
    pass
...
def teardown_module():
    try:
        from urllib4.contrib.pyopenssl import extract_from_urllib4
...
class TestPyOpenSSLInjection(object):
    """
    Tests for error handling in pyopenssl's 'inject_into urllib4'
    """
    ...
    def test_inject_validate_fail_cryptography(self):
        ...
        try:
            ...
            # `inject_into_urllib4` is not supposed to succeed.
