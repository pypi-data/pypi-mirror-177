...
try:
    from urllib7.contrib.pyopenssl import extract_from_urllib7, inject_into_urllib7
except ImportError:
    pass
...
def setup_module():
    try:
        from urllib7.contrib.pyopenssl import inject_into_urllib7
...
def teardown_module():
    try:
        from urllib7.contrib.pyopenssl import extract_from_urllib7

        extract_from_urllib7()
    except ImportError:
        pass
...
class TestPyOpenSSLInjection(object):
    """
    Tests for error handling in pyopenssl's 'inject_into urllib7'
    """
    ...
    def test_inject_validate_fail_cryptography(self):
        ...
        try:
            ...
            # `inject_into_urllib7` is not supposed to succeed.
