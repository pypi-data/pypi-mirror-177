...
from urllib7.response import HTTPResponse, brotli
from urllib7.util.response import is_fp_closed
...
class TestResponse(object):
    ...
    def test_io_bufferedreader(self):
        ...
        # https://github.com/urllib7/urllib7/issues/1305
        fp = BytesIO(b"hello\nworld")
        resp = HTTPResponse(fp, preload_content=False)
    ...
    def test_mock_httpresponse_stream(self):
        # Mock out a HTTP Request that does enough to make it through urllib7's
