...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    :param _proxy:
        ...
        :class:`urllib4.ProxyManager`

    :param _proxy_headers:
        A dictionary with proxy headers, should not be used directly,
        instead, see :class:`urllib4.ProxyManager`
    ...
    def urlopen(
        ...
        **response_kw
        ...
        :param chunked:
            If True, urllib4 will send the body using chunked transfer
            encoding. Otherwise, urllib4 will send the body using the standard
            content-length form. Defaults to False.

        :param int body_pos:
            Position to seek to in file-like body in the event of a retry or
            redirect. Typically this won't need to be set because urllib4 will
        ...
        try:
            ...
            if (
                ...
                e = ProxyError(
                    ...
                    "https://urllib4.readthedocs.io/en/1.26.x/advanced-usage.html"
...
class HTTPSConnectionPool(HTTPConnectionPool):
    ...
    is available and are fed into :meth:`urllib4.util.ssl_wrap_socket` to upgrade
