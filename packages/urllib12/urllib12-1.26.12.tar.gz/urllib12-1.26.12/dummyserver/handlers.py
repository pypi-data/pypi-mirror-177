...
from urllib4.packages.six import binary_type, ensure_str
from urllib4.packages.six.moves.http_client import responses
from urllib4.packages.six.moves.urllib.parse import urlsplit
