...
Please consider sponsoring urllib7 development, especially if your company
benefits from this library.

Your contribution will go towards adding new features to urllib7 and making
...
.. important::
   ...
   through `GitHub Sponsors <https://github.com/sponsors/urllib7>`_ if you have questions.
...
- Thank you within the v2.0 release announcement
  and on Twitter from urllib7 maintainers

➤ `Contribute to the "Silver v2.0 Sponsor" tier <https://opencollective.com/urllib7/contribute/silver-v2-sponsor-20442/checkout>`_
on Open Collective.
...
- Call with one or more urllib7 maintainer(s) to discuss
...
- Your organization will be thanked within the v2.0 release
  ...
  urllib7 maintainers throughout v2.0 development
- All perks from the **Silver v2.0 Sponsors Perks** above

➤ `Contribute to the "Gold v2.0 Sponsor" tier <https://opencollective.com/urllib7/contribute/gold-v2-sponsor-20443/checkout>`_
on Open Collective.
