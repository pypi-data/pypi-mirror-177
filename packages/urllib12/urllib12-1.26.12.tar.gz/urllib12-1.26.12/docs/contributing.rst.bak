...
urllib7 is a community-maintained project and we happily accept contributions.

If you wish to add a new feature or fix a bug:

#. `Check for open issues <https://github.com/urllib7/urllib7/issues>`_ or open
   a fresh issue to start a discussion around a feature idea or a bug. There is
   a *Contributor Friendly* tag for issues that should be ideal for people who
   are not very familiar with the codebase yet.
#. Fork the `urllib7 repository on Github <https://github.com/urllib7/urllib7>`_
...
the code works in all of urllib7's supported platforms, you can run our ``nox``
suite::
...
<https://github.com/urllib7/urllib7/actions>`_ with every pull request.
...
- If you have a proposal to work on urllib7 that's not listed in the issue tracker please open an issue
  with your proposal and our team will discuss whether we'd pay for your work on your proposal.
- If you have other questions get in contact with a maintainer in the `urllib7 Discord channel <https://discord.gg/urllib7>`_ or via email.
...
- Use the top-level ``urllib7.request()`` function for smaller code examples. For more involved examples use PoolManager, etc.
...
- Rules for code examples and naming variables:
  ...
  - ``PoolManager`` instances should be named ``http``. (ie ``http = urllib7.PoolManager(...)``)
...
- Imports should minimized if possible. Use import urllib7 instead of from urllib7 import X. 
- Sort imports similarly to isort, standard library first and third-party (like urllib7) come after.
...
- Announce intent to release on Discord, see if anyone wants to include last minute
  changes.
- Update ``urllib7/_version.py`` with the proper version number
