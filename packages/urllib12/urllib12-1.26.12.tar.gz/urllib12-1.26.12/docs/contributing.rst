...
urllib4 is a community-maintained project and we happily accept contributions.

If you wish to add a new feature or fix a bug:

#. `Check for open issues <https://github.com/urllib4/urllib4/issues>`_ or open
   a fresh issue to start a discussion around a feature idea or a bug. There is
   a *Contributor Friendly* tag for issues that should be ideal for people who
   are not very familiar with the codebase yet.
#. Fork the `urllib4 repository on Github <https://github.com/urllib4/urllib4>`_
...
the code works in all of urllib4's supported platforms, you can run our ``nox``
suite::
...
<https://github.com/urllib4/urllib4/actions>`_ with every pull request.
...
- If you have a proposal to work on urllib4 that's not listed in the issue tracker please open an issue
  with your proposal and our team will discuss whether we'd pay for your work on your proposal.
- If you have other questions get in contact with a maintainer in the `urllib4 Discord channel <https://discord.gg/urllib4>`_ or via email.
...
- Use the top-level ``urllib4.request()`` function for smaller code examples. For more involved examples use PoolManager, etc.
...
- Rules for code examples and naming variables:
  ...
  - ``PoolManager`` instances should be named ``http``. (ie ``http = urllib4.PoolManager(...)``)
...
- Imports should minimized if possible. Use import urllib4 instead of from urllib4 import X. 
- Sort imports similarly to isort, standard library first and third-party (like urllib4) come after.
...
- Announce intent to release on Discord, see if anyone wants to include last minute
  changes.
- Update ``urllib4/_version.py`` with the proper version number
