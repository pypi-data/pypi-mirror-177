...
# Version number
with open("imagepile/__init__.py") as f:
    for line in f:
...
setup(
    name="imagepile",
    version=version,
    description="Image tools for large image repositories",
    long_description=README,
    long_description_content_type='text/markdown',
    url="https://github.com/imagioo/imagepile",
    ...
    entry_points={
        "console_scripts": [
            "imagepile = imagepile.__main__:main"
        ]
    }
)