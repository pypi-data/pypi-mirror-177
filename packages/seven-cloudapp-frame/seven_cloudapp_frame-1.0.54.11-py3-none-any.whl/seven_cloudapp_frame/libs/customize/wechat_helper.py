...
@LastEditTime: 2022-11-21 15:57:07
...
class WeChatHelper:
    ...
    def get_jsapi_ticket(self, app_id="", app_secret="", is_del=False):
        ...
        try:
            ...
            if jsapi_ticket:
                ...
                return invoke_result_data
            invoke_result_data = self.set_jsapi_ticket(app_id, app_secret, is_del)
    ...
    def get_share_sign_package(self, request_url, app_id="", app_secret=""):
        ...
        invoke_result_data = self.get_jsapi_ticket(app_id, app_secret, False)
        if invoke_result_data.success == False:
            return invoke_result_data
    ...
    @classmethod
    def msg_sec_check(self, content, scene, open_id, app_id="", app_secret=""):
        """
