...
@LastEditTime: 2022-11-18 15:58:45
...
class StatReportListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        stat_report_list = stat_base_model.get_stat_report_list(app_id, act_id, module_id, start_date, end_date, order_by, is_only_module, orm_condition, orm_params)
        ref_params = {}
