...
# hrun testcases/gateway_api/app_gateway/test --clean-alluredir --alluredir=./allure/results --env=test1 -s -v -n auto --toexcel=/opt/自动化测试.xlsx
# hrun testcases/gateway_api/app_gateway/test --clean-alluredir --alluredir=./allure/results --env=test1 -s --toexcel=/opt/自动化测试.xlsx
def parse_diff():
