...
class GlobalConfigMiddleware(BaseModel):
    datasource: Dict


class GlobalConfigHooks(BaseModel):
    paths: List


class GlobalConfigSettingsTemplate(BaseModel):
    engine: Text = ""
    variable: Dict = {}


class GlobalConfigSettings(BaseModel):
    template: GlobalConfigSettingsTemplate = None


class GlobalConfig(BaseModel):
    middleware: GlobalConfigMiddleware
    hook: GlobalConfigHooks
