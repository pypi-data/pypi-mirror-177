...
parser.add_argument('-t1','--ANI_threshold',default = 'auto', help='The threshold of ANI  [0-0.9999], or set as "auto"  to select the inflection point as the threshold for ANI. (Default "auto")')
parser.add_argument('-t2','--ANC_threshold',default = 'auto', help='The threshold of |1-ANC| [0-0.9999], or set as "auto" to select the inflection point as the threshold for [1-ANC]. (Default "auto")')
