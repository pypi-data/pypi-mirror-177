...
from opl import Object, Wd, items, keys, register, update, values
from opl import edit, kind, load, save
from opl import ObjectDecoder, ObjectEncoder
from opl import printable
...
class TestObject(unittest.TestCase):
    ...
    def test_module(self):
        self.assertTrue(Object().__module__, "opl")

    def test_kind(self):
        self.assertEqual(kind(Object()), "opl.obj.Object")
