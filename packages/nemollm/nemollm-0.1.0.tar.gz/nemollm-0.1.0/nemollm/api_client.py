...
from nemollm import rest
from nemollm.configuration import Configuration
from nemollm.exceptions import ApiException, ApiTypeError, ApiValueError
from nemollm.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_customization  # this is an instance of the class Endpoint
        api_instance.create_customization()  # this invokes api_instance.create_customization.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_customization.callable or self.callable in this class
