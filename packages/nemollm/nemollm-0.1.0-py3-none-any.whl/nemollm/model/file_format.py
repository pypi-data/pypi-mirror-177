...
class FileFormat(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): File format. if omitted defaults to "jsonl", must be one of ["jsonl", ]  # noqa: E501

        Keyword Args:
            value (str): File format. if omitted defaults to "jsonl", must be one of ["jsonl", ]  # noqa: E501
