...
class CreateCustomizationsRequestBodyAdditionalHyperparameters(ModelComposed):
    ...
    validations = {
        ('num_virtual_tokens',): {'inclusive_maximum': 100, 'inclusive_minimum': 1,},
    }
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'num_virtual_tokens': (int, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        'num_virtual_tokens': 'num_virtual_tokens',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CreateCustomizationsRequestBodyAdditionalHyperparameters - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            num_virtual_tokens (int, none_type): Number of virtual tokens to use for customization. Virtual tokens are embeddings inserted into the model prompt that have no concrete mapping to strings or characters within the model's vocabulary.. [optional] if omitted the server will use the default value of 10  # noqa: E501
        """
