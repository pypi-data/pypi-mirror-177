...
class CreateTasksRequest(google.protobuf.message.Message):
    ...
    @property
    def task(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[daisyfl.proto.task_pb2.Task]: ...
    def __init__(self,
        *,
        task: typing.Optional[typing.Iterable[daisyfl.proto.task_pb2.Task]] = ...,
        ) -> None: ...
...
class GetResultsRequest(google.protobuf.message.Message):
    ...
    TASK_IDS_FIELD_NUMBER: builtins.int
    @property
    def task_ids(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[daisyfl.proto.task_pb2.Result]: ...
    def __init__(self,
        *,
        task_ids: typing.Optional[typing.Iterable[daisyfl.proto.task_pb2.Result]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["task_ids",b"task_ids"]) -> None: ...
...
class GetResultsResponse(google.protobuf.message.Message):
    ...
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[daisyfl.proto.task_pb2.Result]: ...
    def __init__(self,
        *,
        results: typing.Optional[typing.Iterable[daisyfl.proto.task_pb2.Result]] = ...,
        ) -> None: ...
