...
import certifi
import urllib3
from sereybase.exceptions import RPCError, RPCErrorRecoverable
...
class HttpClient(object):
    ...
    .. code-block:: python
       ...
       from serey.http_client import HttpClient

       rpc = HttpClient(['https://sereyd-node1.com',
       'https://sereyd-node2.com'])
    ...
    def json_rpc_body(name, *args, **kwargs):
        """Build request body for sereyd RPC requests.
    ...
    def call(self, name, *args, **kwargs):
        """Call a remote procedure in sereyd.
