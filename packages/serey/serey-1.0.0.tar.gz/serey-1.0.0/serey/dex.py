...
from sereybase import transactions, operations
from sereybase.storage import configStorage as config
...
class Dex(object):
    ...
    def _get_asset(self, symbol):
        ...
        :param str symbol: Symbol to get the data for (i.e. HIVE, HBD,
        VESTS)
    ...
    def trade_history(self, time=1 * 60 * 60, limit=100):
        ...
        return self.sereyd.get_trade_history(
    ...
    def market_history_buckets(self):
        return self.sereyd.get_market_history_buckets()
    ...
    def market_history(
        ...
        """
        return self.sereyd.get_market_history(
            bucket_seconds,
    ...
    def buy(
        ...
        :param str quote_symbol: HIVE, or HBD
        ...
        Prices/Rates are denoted in 'base', i.e. the HIVE:HBD market
        is priced in HBD per HIVE.
        """
        if not account:
        ...
        op = operations.LimitOrderCreate(
            **{
                ...
                "amount_to_sell": "{:.{prec}f} {asset}".format(
                    amount * rate, prec=base["precision"], asset=base["symbol"]
                ),
        ...
        return self.sereyd.commit.finalizeOp(op, account, "active")
