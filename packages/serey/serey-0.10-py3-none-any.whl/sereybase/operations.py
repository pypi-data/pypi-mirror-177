...
asset_precision = {"SRY": 3, "STEEM": 3, "HIVE": 3, "VESTS": 6, "HBD": 3, "SBD": 3}
...
class Operation:
    ...
    def get_class(class_name):
        ...
        module = importlib.import_module("sereybase.operations")
...
class Amount:
    ...
    def get_asset_symbol_binary(self):
        if self.asset == "SRY":
            return "STEEM"
        elif self.asset in ["VESTS", "HBD", "SBD", "HIVE"]:
            return self.asset
        else:
    ...
    def __bytes__(self):
        # padding
        asset = self.get_asset_symbol_binary() + "\x00" * (
            7 - len(self.get_asset_symbol_binary())
        )
