    ...
    if args.command == "set":
        ...
        if args.account and isinstance(args.account, list):
            for account in args.account:
                a = Account(account, blockchain_instance=hive)
                ...
                t.add_row(
                    [
                        "Savings",
                        a.balances["savings"]["HIVE"],
                        a.balances["savings"]["HBD"],
                        "N/A",
                    ]
                )
                t.add_row(
        ...
        if not args.foreign_account:
            from sereybase.account import PasswordKey
