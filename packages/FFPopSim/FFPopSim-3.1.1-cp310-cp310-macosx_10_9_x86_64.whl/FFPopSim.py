...
class tree_node(object):
    ...
    _child_edges = property(_FFPopSim.tree_node__child_edges_get, _FFPopSim.tree_node__child_edges_set, doc=r"""_child_edges : std::list<(tree_key_t)>""")
    ...
    _weight_distribution = property(_FFPopSim.tree_node__weight_distribution_get, _FFPopSim.tree_node__weight_distribution_set, doc=r"""_weight_distribution : std::vector<(step_t)>""")
...
class rooted_tree(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    _edges = property(_FFPopSim.rooted_tree__edges_get, _FFPopSim.rooted_tree__edges_set, doc=r"""_edges : std::map<(tree_key_t,edge_t)>""")
    _nodes = property(_FFPopSim.rooted_tree__nodes_get, _FFPopSim.rooted_tree__nodes_set, doc=r"""_nodes : std::map<(tree_key_t,node_t)>""")
    _leafs = property(_FFPopSim.rooted_tree__leafs_get, _FFPopSim.rooted_tree__leafs_set, doc=r"""_leafs : std::vector<(tree_key_t)>""")
    sampled_leafs = property(_FFPopSim.rooted_tree_sampled_leafs_get, _FFPopSim.rooted_tree_sampled_leafs_set, doc=r"""sampled_leafs : std::vector<(tree_key_t)>""")
